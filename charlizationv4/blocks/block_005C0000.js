...
export function FUN_005c0d69(param_1, param_2, param_3, param_4) {
  ...
  if (G.DAT_00637e5c === 0) {
    ...
    if ((param_4 & 0x10) !== 0) {
      iVar2 = gdi_847F(G.DAT_00637e5c);
      iVar2 = iVar2 + (iVar2 >> 0x1f & 7);
      iVar3 = iVar2 >> 3;
      uVar1 = FUN_005c19ad(G.DAT_00638b40);
      FUN_005e3cb4(in_ECX + 0x40, G.DAT_00637e5c, param_1, iVar3 + param_2, iVar3 + param_3, in_ECX + 0x14, param_4);
      FUN_005c19ad(uVar1);
    }
    FUN_005e3cb4(in_ECX + 0x40, G.DAT_00637e5c, param_1, param_2, param_3, in_ECX + 0x14, param_4);
  }
}
...
export function FUN_005c0e57(param_1, param_2, param_3) {
  ...
  if (G.DAT_00637e5c === 0) {
    ...
    if ((param_3 & 0x10) !== 0) {
      ...
      uVar1 = FUN_005c19ad(G.DAT_00638b40);
      handle_colortable_3ECA(in_ECX + 0x40, G.DAT_00637e5c, param_1, local_14, param_3);
      FUN_005c19ad(uVar1);
    }
    handle_colortable_3ECA(in_ECX + 0x40, G.DAT_00637e5c, param_1, param_2, param_3);
  }
}
...
export function FUN_005c10fb(param_1, param_2, param_3) {
  ...
  if (G.DAT_00637e5c === 0) {
    ...
    handle_colortable_3FEB(in_ECX + 0x40, G.DAT_00637e5c, param_1, param_2, param_3);
  }
}
  ...
  if (((((in_ECX + 0x14 <= param_1 || in_ECX + 0x14 <= param_3) &&
    ...
    if (param_4 === param_2) {
      ...
      if (param_3 !== param_1) {
        ...
        uVar5 = FUN_005c5640(G.DAT_00637e78, iVar2 + 1);
        FUN_005e5869(uVar5);
      }
...
export function FUN_005cd6e0() {
  for (var local_8 = 0; local_8 < 0x10; local_8 = local_8 + 1) {
    G.DAT_006d4708[local_8] = 0;
    G.DAT_006d4700[local_8] = 0;
    G.DAT_006d4704[local_8] = 0;
  }
  FUN_005cd775(1, 1);
...
export function FUN_005cd775(param_1, param_2) {
  ...
  while (true) {
    if (0xf < local_14) {
      G.DAT_006d4700[local_18] = G.DAT_00637f98;
      G.DAT_006d4704[local_18] = G.DAT_00637f9c;
      uVar1 = FUN_00421bb0();
      G.DAT_006d4708[local_18] = uVar1;
      local_8 = 0;
      if (G.DAT_00637f98 < G.DAT_00637f9c) {
        ...
        while (local_14 < 0x400) {
          for (; -1 < local_c && local_14 < 0x400; local_14 = local_14 + 1) {
            G.DAT_006d470c[local_14 + local_18 * 0x400] = local_8;
      ...
      G.DAT_006e47c8 = local_18;
      return;
    }
    if (G.DAT_006d4700[local_14] === G.DAT_00637f98 && G.DAT_006d4704[local_14] === G.DAT_00637f9c) {
      uVar1 = FUN_00421bb0();
      G.DAT_006d4708[local_14] = uVar1;
      local_18 = local_14;
      G.DAT_006e47c8 = local_18;
      return;
    }
    if (G.DAT_006d4708[local_14] <= local_10) {
      local_10 = G.DAT_006d4708[local_14];
      local_18 = local_14;
    }
    local_14 = local_14 + 1;
  }
...
export function FUN_005cda06(param_1, param_2) {
  param_1[0] = G.DAT_00637f98;
  param_2[0] = G.DAT_00637f9c;
}
...
export function FUN_005cda2a(param_1, param_2, param_3, param_4) {
  ...
  for (local_14 = 0; local_14 < 0x10; local_14 = local_14 + 1) {
    if (G.DAT_006d4700[local_14] === G.DAT_00637fa0 && G.DAT_006d4704[local_14] === G.DAT_00637fa4) {
      uVar1 = FUN_00421bb0();
      G.DAT_006d4708[local_14] = uVar1;
      local_8 = local_14;
      // goto LAB_005cdbab;
  ...
  while (true) {
    if (0xf < local_14) {
      ...
      local_14 = local_c;
      G.DAT_006e47c4 = local_14;
      return;
    }
    if (G.DAT_006d4700[local_14] === G.DAT_00637fa8 && G.DAT_006d4704[local_14] === G.DAT_00637fac) {
      uVar1 = FUN_00421bb0();
      G.DAT_006d4708[local_14] = uVar1;
      G.DAT_006e47c4 = local_14;
      return;
    }
    if (G.DAT_006d4708[local_14] <= local_10 && local_8 !== local_14) {
      local_10 = G.DAT_006d4708[local_14];
      local_c = local_14;
    }
    local_14 = local_14 + 1;
...
export function FUN_005cdcdb(param_1, param_2, param_3) {
  ...
  G.DAT_006d4700[param_1] = param_2;
  G.DAT_006d4704[param_1] = param_3;
  uVar1 = FUN_00421bb0();
  G.DAT_006d4708[param_1] = uVar1;
  local_8 = 0;
  if (param_2 < param_3) {
    local_c = 0;
    local_10 = 0;
    while (local_10 < 0x400) {
      for (; -1 < local_c && local_10 < 0x400; local_10 = local_10 + 1) {
        G.DAT_006d470c[local_10 + param_1 * 0x400] = local_8;
