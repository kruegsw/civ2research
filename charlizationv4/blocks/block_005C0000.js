    ...
    if (param_2 === 0xf) {
      ...
      if (iVar2 === 1) {
        ...
        if (s32(iVar2, 0x40) === 8) {
          ...
          SetTextColor(local_144,( >>> 0)2(G.DAT_00637f02,CONCAT11(G.DAT_00637f01,G.DAT_00637f00)));
        }
      }
      else {
        iVar2 = FUN_005c5ec0();
        if (iVar2 === 0) {
          ...
          if (s32(iVar2, 0x40) === 8) {
            ...
            SetTextColor(local_144,( >>> 0)2(G.DAT_00637f06,CONCAT11(G.DAT_00637f05,G.DAT_00637f04)))
            ;
          }
        }
      }
