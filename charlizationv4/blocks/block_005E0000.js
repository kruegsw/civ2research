...
export function FUN_005ea677() {
  ...
  // C: Queries G.DAT_006394c0 COM interface for display caps, returns bit depth byte
  return 8;
}
...
export function FUN_005ed920() {
  ...
  // C: Opens smeds.log, writes SMEDS32 version header, sets G.DAT_00639be8 flag
  G.DAT_00639be8 = '\x01';
  return 1;
}
