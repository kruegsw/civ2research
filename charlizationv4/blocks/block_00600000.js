...
import { FlushFileBuffers, GetCPInfo, GetFileType, GetLastError, GetModuleFileNameA, GetProcAddress } from '../extern-stubs.js';
import { GetStdHandle, GetStringTypeA, GetStringTypeW, GetTimeZoneInformation, HELPERS, IsBadCodePtr } from '../extern-stubs.js';
import { IsBadReadPtr, IsBadWritePtr, LoadLibraryA, MultiByteToWideChar, SetConsoleCtrlHandler, SetEndOfFile } from '../extern-stubs.js';
import { SetEnvironmentVariableA, SetStdHandle, SetUnhandledExceptionFilter, WideCharToMultiByte, WriteFile, __ld12tod } from '../extern-stubs.js';
import { exe, int, swi } from '../extern-stubs.js';
...
export function __NMSG_WRITE_00600040(param_1) {
  ...
  if (s32(DAT_0063b1b8, local_c * 8) === param_1) {
    ...
    if ((v(DAT_00639fcc) === 1) || ((v(DAT_00639fcc) == 0 && (v(DAT_00639fd0) === 1)))) {
      ...
      DVar4 = GetModuleFileNameA(0x0,local_114[0],0x104);
      if (DVar4 == 0) {
        FUN_005f22d0(local_114[0],"<program name unknown>");
      }
      local_10 = local_114[0];
      sVar3 = _strlen(local_10);
      if (0x3c < sVar3 + 1) {
        sVar3 = _strlen(local_114[0]);
        local_10 = local_10 + (sVar3 - 0x3b);
        _strncpy(local_10,"...",3);
      }
      FUN_005f22d0(local_1b4[0],"Runtime Error!\n\nProgram: ");
      FUN_005f22e0(local_1b4[0],local_10);
      FUN_005f22e0(local_1b4[0],v(DAT_0061e2fc));
      FUN_005f22e0(local_1b4[0],(PTR_s_R6002___floating_point_not_loade_0063b1bc)[local_c * 2]);
      ___crtMessageBoxA(local_1b4[0],"Microsoft Visual C++ Runtime Library",0x12010);
    }
  }
  return;
}
  ...
  if (v(DAT_0063b260) === 0x0) {
    ...
    if (hModule !== 0x0) {
      ...
      if (v(DAT_0063b260) !== 0x0) {
        ...
        return LAB_006009b5_helper(iVar1, local_8);
      }
    }
    iVar1 = 0;
  }
...
export function ___crtGetStringTypeW_00601300(param_1, param_2, param_3, param_4, param_5, param_6) {
  ...
  if (v(DAT_0063b26c) == 0) {
    BVar1 = GetStringTypeW(1,"",1,local_8[0]);
    if (BVar1 == 0) {
      BVar1 = GetStringTypeA(0,1,"",1,local_8[0]);
      if (BVar1 == 0) {
        return;
      }
      wv(DAT_0063b26c, 2);
...
export function ___crtGetStringTypeA_00601560(in_EAX = globalThis.in_EAX, _Plocinfo, _DWInfoType, _LpSrcStr, _CchSrc, _LpCharType, _Code_page, _BError) {
  ...
  local_c = in_EAX;
  if (v(DAT_0063b270) == 0) {
    local_c = GetStringTypeA(0,1,"",1,local_8[0]);
    if (local_c == 0) {
      local_c = GetStringTypeW(1,"",1,local_8[0]);
      if (local_c == 0) {
        return 0;
      }
      wv(DAT_0063b270, 1);
...
export function __sopen_00601750(_Filename, _OpenFlag, _ShareFlag) {
  ...
  if (uVar1 < 0x101) {
    if (uVar1 === 0x100) {
      local_1c = 4;
      return LAB_006019fc_helper(DVar2, bVar5, iVar4, lVar3, local_10, local_14, local_18, local_1c, local_28, local_2c, local_30, local_34, local_38, local_3c, local_8, local_c, uVar1);
    }
    if (uVar1 != 0) {
      wv(DAT_00639f14, 0x16);
      wv(DAT_00639f18, 0);
      ...
      if (local_10 == 0) {
        ...
        if ((((local_3c & 0x48) == 0) && ((local_3c & 0x80) != 0)) && ((_OpenFlag & 2) != 0)) {
          ...
          if (lVar3 === -1) {
            ...
            local_34[0] = 0;
            iVar4 = __read(local_18,local_34[0],1);
            if (((iVar4 == 0) && (local_34[0] === 0x1a)) && (iVar4 = __chsize(local_18,lVar3), iVar4 === -1)) {
               /*JOINED*/
              __close(local_18);
              return -1;
            }
...
export function _wctomb_00602310(_MbCh, _WCh) {
  ...
  if (_MbCh === 0x0) {
    ...
    local_c[0] = 0;
    iVar1 = WideCharToMultiByte(v(DAT_0063a088),0x220,_WCh,1,_MbCh,v(DAT_0063a29c),0x0,local_c[0]);
...
export function __ld12cvt_00602EA0(param_1, param_2, param_3) {
  ...
  if (local_8 === -0x3fff) {
    ...
    __CopyMan(local_34[0],local_1c[0]);
    ...
    if (local_8 < _MEM[param_3 + 1] - _MEM[param_3 + 2]) {
      ...
      __CopyMan(local_1c[0],local_34[0]);
      ...
      if (lVar3 !== -1) {
        ...
        if ((local_101c) < 1) {
          ...
          do {
            ...
            iVar4 = __write(_FileHandle,local_1008[0],local_1024);
            if (iVar4 === -1) {
              if (v(DAT_00639f18) === 5) {
                wv(DAT_00639f14, 0xd);
              }
    ...
    if (local_50 === 10) {
      ...
      if ((local_58 != 0) && (local_44 == 0)) {
        ...
        if (local_74 == 0) {
          ...
          ___mtold12(local_3c[0],local_74,local_64[0]);
          if (local_78 < 0) {
            local_18 = -local_18;
          }
      ...
      if ((local_8 == 0) || (local_18[0] != 0)) {
        if ((local_18[0] == 0) && (DVar4 = GetLastError(), DVar4 === 0x7a)) {
          while (local_8 < _MaxCount) {
            ...
            local_14 = WideCharToMultiByte(v(DAT_0063a088),0,_Source,1,local_10[0],v(DAT_0063a29c), 0x0,local_18[0]);
                                           /*JOINED*/
    ...
    if (local_38 < 0x3fc0) {
      ...
      for (local_24 = 0; local_24 < 5; local_24 = local_24 + 1) {
        ...
        for (local_3c = 5 - local_24; 0 < local_3c; local_3c = local_3c + -1) {
          ...
          iVar6 = ___addl(s32(local_1c[0], local_30), u16((param_2) + local_c, 0) * u16(local_2c, (param_1)),local_1c[0] + local_30);
                          /*JOINED*/
                          /*JOINED*/
          if (iVar6 != 0) {
...
export function ___wtomb_environ_00606260() {
  ...
  let iVar1;
  // DEVIATION: char s32(s32(_POption, 0), 0);
  let local_8;
...
export function ___crtsetenv_00606B60(_POption, _Primary) {
  ...
  // DEVIATION: char s32(s32(ppcVar1, 0), 0);
  let iVar2;
  let piVar3;
  let sVar4;
  let lpName;
...
export function __strupr_006076C0(unaff_ESI, unaff_EDI, _String) {
  ...
  if (v(DAT_0063a078) === 0x0) {
    for (local_10 = _String; _MEM[local_10] != 0 && local_10 - _String < 65536; local_10 = local_10 + 1) {
