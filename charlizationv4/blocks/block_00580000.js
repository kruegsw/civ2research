    ...
    if ((s32(G.DAT_0064f394, local_18 * 0x58) !== 0) &&
      ...
      if (param_2 === 0) {
        ...
        for (local_10 = 0; local_10 < local_14; local_10 = local_10 + 1) {
          if (s32(G.DAT_0064f394, local_18 * 0x58) === s32((int, 0)local_c + local_10 * 4)) {
            // DEVIATION: C pointer — *(undefined4 *)
...
export function FUN_00589a5b() {
  ...
  // DEVIATION: MFC — COleControlSite::SetDlgCtrlID((COleControlSite *)G.DAT_006553e8,0x402cd4);
  tie(thunk_map_ascii);
  FUN_00419ba0(0x9e);
  FUN_00419b80();
  G.DAT_00634718 = 1;
...
export function FUN_00589dc5(param_1) {
  ...
  _File = (FILE *)FUN_0041508c(param_1,G.DAT_0063481c);
  if (_File !== null) {
    local_8 = 1;
...
export function FUN_00589fc9(param_1, param_2, param_3) {
  ...
  local_5c = 1;
  _File = (FILE *)FUN_0041508c(param_2,G.DAT_00634840);
  if (_File !== null) {
...
export function FUN_0058a0ee(param_1, param_2, param_3, param_4) {
  ...
  while (local_108 = local_108 + -1, -1 < local_108) {
    if (s32(G.DAT_006acbd0, local_108 * 4) !== 0) {
      // DEVIATION: C pointer — (**(code **)(G.DAT_006acbd0 + local_108 * 4))();
    }
  }
  DebugBreak();
...
export function FUN_0058a601() {
  ...
  // DEVIATION: MFC — COleCntrFrameWnd::~COleCntrFrameWnd((COleCntrFrameWnd *)G.DAT_006acd58);
  return;
}
...
export function show_messagebox_A80D_0058A80D(param_1, param_2) {
  ...
  if (iVar1 !== 0) {
    ...
    if ((local_10 === null) ||
       (local_8 = _fopen(param_2,G.DAT_00634950), local_8 === null)) {
...
export function FUN_0058abee() {
  ...
  G.DAT_006acd50 = 0;
  // DEVIATION: MFC — CRichEditDoc::InvalidateObjectCache((CRichEditDoc *)G.DAT_006acda0);
  return;
}
...
export function FUN_0058b47e(param_1, param_2) {
  ...
  // DEVIATION: MFC — CPropertySheet::EnableStackedTabs((CPropertySheet *)G.DAT_006acd58,0x4017d5);
  FUN_005bb574();
  FUN_004085f0();
  FUN_005c61b0();
      ...
      do {
        ...
        if ((((iVar9 !== 0) && (iVar9 = FUN_005b8d62(uVar8,iVar6), iVar9 < 0)) &&
          ...
          if (-1 < uVar7) {
            ...
            // DEVIATION: C pointer — G.DAT_006560f9[uVar7 * 0x20] = *(byte *)(iVar9 + 4) | G.DAT_006560f9[uVar7 * 0x20];
...
export function FUN_0058fedb(param_1, param_2) {
  ...
  if (local_31c !== 1) {
    ...
    w16(G.DAT_0064f35c, param_2 * 0x58, 
         ((s8) << 16 >> 16)(G.DAT_0064b1c8[u8(G.DAT_006560f6[param_1 * 0x20])) * 0x14] *
