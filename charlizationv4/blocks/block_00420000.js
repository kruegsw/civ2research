...
export function FUN_004259a6(param_1) {
  ...
  let _str1 = G.DAT_0063cc48 + 0x104;  // &G.DAT_0063cd4c
  FUN_004aef20(_str1);
  FUN_004af14b(_str1, (G.DAT_00654c74 === 0 ? 1 : 0) + 0x277);

  // String 2: scenario name (C line 2165-2166)
  let _str2 = G.DAT_0063cc48 + 0x208;  // &G.DAT_0063ce50
  FUN_004aef20(_str2);
  FUN_005f22e0(_str2, G.DAT_006ad5dc);

  // String 3: game description + year (C lines 2167-2179)
  let _str3 = G.DAT_0063cc48 + 0x30c;  // &G.DAT_0063cf54
  FUN_004aef20(_str3);
  let sVar1 = _strlen(G.DAT_0064bc62);
  if (sVar1 === 0) {
    FUN_004af14b(_str3, 0x34c);
  } else {
    FUN_005f22d0(_str3, G.DAT_0064bc62);
  }
  FUN_004aef36(_str3);
  FUN_004af01a(_str3);
  let uVar2_year = FUN_00484fec(G.DAT_00655af8 | 0);
  FUN_00485208(_str3, uVar2_year);
  FUN_004af03b(_str3);

  // String 4: difficulty + barbarians (C lines 2180-2185)
  let _str4 = G.DAT_0063cc48 + 0x410;  // &G.DAT_0063d058
  FUN_004aef20(_str4);
  FUN_004af14b(_str4, G.DAT_00655b08 + 0x279);
  FUN_004aef36(_str4);
  FUN_004af01a(_str4);
  FUN_004af14b(_str4, 0x34e - (G.DAT_00654c7c === 0 ? 1 : 0));
  FUN_004af03b(_str4);

  // String 5: restarts + bloodlust (C lines 2190-2193)
  let _str5 = G.DAT_0063cc48 + 0x514;  // &G.DAT_0063d15c
  FUN_004aef20(_str5);
  FUN_004af14b(_str5, 0x350 - (G.DAT_00654fac === 0 ? 1 : 0));
  FUN_005f22e0(_str5, G.DAT_00625d6c);
  FUN_004af14b(_str5, 0x352 - (G.DAT_00654fae === 0 ? 1 : 0));

  // String 6: barbarian level (C lines 2194-2195)
  let _str6 = G.DAT_0063cc48 + 0x618;  // &G.DAT_0063d260
  FUN_004aef20(_str6);
  FUN_004af14b(_str6, G.DAT_00655b09 + 0x27f);

  // String 7: timer (C lines 2196-2212)
  let _str7 = G.DAT_0063cc48 + 0x71c;  // &G.DAT_0063d364
  FUN_004aef20(_str7);
  if (G.DAT_00654b70 === 0) {
    FUN_004af14b(_str7, 0x285);
  } else {
    let iVar3 = ((G.DAT_00654b70 / 1000) | 0) / 0x3c | 0;
    let local_c = ((G.DAT_00654b70 / 1000) | 0) % 0x3c;
    if (iVar3 < 10) {
      FUN_004af1d5(_str7, 0);
    }
    FUN_004af1d5(_str7, iVar3);
    FUN_005f22e0(_str7, G.DAT_00625d70);
    if (local_c < 10) {
      FUN_004af1d5(_str7, 0);
    }
  ...
  let _str8 = G.DAT_0063cc48 + 0x820;  // &G.DAT_0063d468
  FUN_004aef20(_str8);
  let local_14 = 0;
  ...
  let _str9 = G.DAT_0063cc48 + 0x924;  // &G.DAT_0063d56c
  FUN_004aef20(_str9);
  let local_8 = 0;
  if (G.DAT_00655b02 === 0) {
    local_8 = 1;
  ...
  let _str10 = G.DAT_0063cc48 + 0xa28;  // &G.DAT_0063d670
  FUN_004aef20(_str10);
  FUN_004af1d5(_str10, (G.DAT_006d1160 | 0) / 2 | 0);

  // String 11: map height (C lines 2188-2189)
  let _str11 = G.DAT_0063cc48 + 0xb2c;  // &G.DAT_0063d774
  FUN_004aef20(_str11);
  FUN_004af1d5(_str11, G.DAT_006d1162 | 0);

  // DEVIATION: Win32 API — show dialog
  G.DAT_00635a3c = 0; // &LAB_00403c74
  let uVar2 = FUN_0051d564(G.DAT_006359d4, s_GAMEPROFILE_00625d74, param_1 !== 0, G.DAT_0063fc58, 0);
  return uVar2;
}
    ...
    if (pcVar1 !== null) {
      ...
      if (iVar2 === 0) {
        ...
        if (iVar2 === 0) {
          iVar2 = _atoi(pcVar1 + 7);
          let local_2c = [];
          __ltoa(G.DAT_0063cc30[(iVar2) / 4], local_2c, 10);
          ...
          if (iVar2 === 0) {
            ...
            let local_2c = [];
            __ltoa(G.DAT_0063cc30[(iVar2) / 4], local_2c, 0x10);
  ...
  for (let local_10 = 0; local_10 < 0x19; local_10 = local_10 + 1) {
    ...
    if ((iVar16 !== 0) &&
      ...
      if (uVar10 !== 0) {
        ...
        let _visByte = (G.DAT_006365c0[uVar10] !== null) ? G.DAT_006365c0[uVar10][pcVar18] : 0;
        if ((bVar24) && (!bVar5) &&
  ...
  if (G.DAT_00655af8 === 0) {
    ...
    if (((1 << (bVar1 & 0x1f)) & G.DAT_00655b0b) === 0 && (G.DAT_006d1da0 !== uVar10)) {
      for (let local_50 = 1; local_50 < 8; local_50 = local_50 + 1) {
        if (((1 << (u8(local_50) & 0x1f)) & G.DAT_00655b0b) !== 0 &&
          ...
          if (G.DAT_006d1da0 === local_50) {
            ...
            FUN_0046b14d(0x75, G.DAT_006ad30c + s32(G.DAT_006ad558, local_50 * 4) * 0x54,
      ...
      if (G.DAT_006d1da0 === uVar10) {
        ...
        FUN_0046b14d(0x76, G.DAT_006ad30c + s32(G.DAT_006ad558, uVar10 * 4) * 0x54,
...
export function FUN_00428dcf() {
  ...
  //    FUN_00428d00();
  let uVar1 = FUN_00428b0c(s32(G.DAT_00628420, 0x7d8), 1, 0x0040123a);
  // C: first arg = &G.DAT_0063fe50 + offset calc from G.DAT_006a4f88 struct fields
  let _off573 = s32(DAT_006a4f88_buf, 0x2f4) * 0x3c +
                s32(DAT_006a4f88_buf, 0x2ec) * 0x1e0 +
                s32(DAT_006a4f88_buf, 0x2f0) * 0x78;
  FUN_00573e59(G.DAT_0063fe50 + _off573, uVar1);
  FUN_00428d00();
}
...
export function FUN_00428e50() {
  ...
  if (iVar1 !== -1) {
    ...
    if (local_10 !== null) {
      let uVar2 = FUN_00428b0c(s32(G.DAT_00628420, 0x7d8), local_8, 0x0040123a);
...
export function FUN_0042d781(param_1, param_2, param_3, param_4, param_5, param_6, param_7) {
  ...
  let local_8 = 0;
  // C: G.DAT_006a6604 = *(uint *)(&G.DAT_0064f370 + param_1 * 0x58) >> 0x1a;
  // Must read 4 bytes as little-endian uint32, not a single byte
  let _off = param_1 * 0x58;
  G.DAT_006a6604 = (G.DAT_0064f370[_off] | (G.DAT_0064f370[_off+1]<<8) | (G.DAT_0064f370[_off+2]<<16) | (G.DAT_0064f370[_off+3]<<24)) >>> 0x1a;

  for (let local_c = 0; local_c < param_5; local_c = local_c + 1) {
    FUN_00448f92(s8(G.DAT_0064f348[param_1 * 0x58]), local_24, G.DAT_0063eb10, param_2, param_3);
    FUN_005cef31(local_24, G.DAT_0063eb10, param_2, param_3);
  ...
  for (let local_c = 0;
      ...
      local_c = local_c + 1) {
    FUN_00448f92(s8(G.DAT_0064f348[param_1 * 0x58]), local_34, G.DAT_0063eb10, param_2, param_3);
    FUN_005cef31(local_34, G.DAT_0063eb10, param_2, param_3);
    param_2 = param_2 + local_10;
    local_8 = local_8 + 1;
  }
  ...
  for (let local_c = 0; local_c < param_6; local_c = local_c + 1) {
    ...
    FUN_00448f92(s8(G.DAT_0064f348[param_1 * 0x58]), local_44, G.DAT_0063eb10, param_2, param_3);
    FUN_005cef31(local_44, G.DAT_0063eb10, param_2, param_3);
    param_2 = param_2 + local_10;
    local_8 = local_8 + 1;
  }

  for (let local_c = 0; local_c < G.DAT_006a6604; local_c = local_c + 1) {
    FUN_00448f92(s8(G.DAT_0064f348[param_1 * 0x58]), local_54, G.DAT_0063eb10, param_2, param_3);
    FUN_004e75a6(param_1, local_c);
    FUN_005cef31(local_54, G.DAT_0063eb10, param_2, param_3);
    param_2 = param_2 + local_10;
  }
  return local_10;
}
