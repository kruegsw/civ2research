...
export function FUN_004d0160() {
  FUN_0047e94e(1, 0);
  if (G.DAT_006ad698 === '\0' || G.DAT_006ad698 === 0) {
...
export function FUN_004d01ae(param_1) {
  for (let local_8 = 0; local_8 < 6; local_8 = local_8 + 1) {
    G.DAT_006a5b10[local_8] = G.DAT_0064caa8[local_8 + param_1 * 0x2CA];
  }
}
...
export function FUN_004d0b58() {
  ...
  FUN_004d4a7b();
  if (G.DAT_0064caae[in_ECX[0x1cc] * 0x2CA] !== 0 && G.DAT_006ad0ec !== 0) {
    in_ECX[0xae0] = 1;
  }
...
export function FUN_004d4a7b() {
  ...
  for (let local_c = 0; local_c < 6; local_c = local_c + 1) {
    let sVar1 = G.DAT_0064caa8[in_ECX[0x1cc] * 0x2CA + local_c];
  ...
  for (let local_c = 0; local_c < 6; local_c = local_c + 1) {
    ...
    FUN_004af1d5(in_ECX[0x638], G.DAT_0064caa8[in_ECX[0x1cc] * 0x2CA + local_c]);
    if (bVar2 && local_c === 0) {
  ...
  FUN_004aefb7(in_ECX[0x638]);
  FUN_004af1d5(in_ECX[0x638], G.DAT_0064caae[in_ECX[0x1cc] * 0x2CA]);
...
export function FUN_004d4fd1(param_1) {
  ...
  // Check for newlines — line feed
  // Check for null — end of text
  in_ECX[0x8c0] = (in_ECX[0x8c0] || 0) + 1;

  if (in_ECX[0x8f0] !== undefined) {
    in_ECX[0x8f0] = 1;
  }
  FUN_00408490(0);
  return false;
...
export function FUN_004d570b() {
  ...
  FUN_004aefb7(in_ECX[0x838]);
  FUN_004aef36(in_ECX[0x838]);
  FUN_00485208(in_ECX[0x838], G.DAT_0064caa2[in_ECX[0x1cc] * 0x2CA]);
...
export function FUN_004d8bc0() {
  for (let local_8 = 0; local_8 < 0x43; local_8 = local_8 + 1) {
    ...
    G.DAT_006a2d28[local_8 * 0x16] = u8(G.DAT_0064c48c[local_8 * 8]);
    G.DAT_006a2d2c[local_8 * 0x16] = u8(G.DAT_0064c48d[local_8 * 8]);
    G.DAT_006a2d30[local_8 * 0x16] = s8(G.DAT_0064c48e[local_8 * 8]);
    if (0x27 < local_8) {
      G.DAT_006a2d34[local_8 * 0x16] = s8(G.DAT_0064ba01[local_8]);
    }
  }
}
...
export function FUN_004d8caa() {
  for (let local_8 = 0; local_8 < 0x43; local_8 = local_8 + 1) {
    ...
    G.DAT_0064c48c[local_8 * 8] = G.DAT_006a2d28[local_8 * 0x16];
    G.DAT_0064c48d[local_8 * 8] = G.DAT_006a2d2c[local_8 * 0x16];
    G.DAT_0064c48e[local_8 * 8] = G.DAT_006a2d30[local_8 * 0x16];
    if (0x27 < local_8) {
      G.DAT_0064ba01[local_8] = G.DAT_006a2d34[local_8 * 0x16];
    }
  }
}
...
export function FUN_004d8d80() {
  for (let local_14 = 1; local_14 < 5; local_14 = local_14 + 1) {
    if (G.DAT_0062e3c0[local_14] === 9) {
      ...
      let iVar1 = FUN_00418740();
      let local_8 = G.DAT_006a2a00[iVar1 + G.DAT_006a4f88[0x2ec] * 0x16] + 2;
...
export function FUN_004db23f(param_1, param_2) {
  ...
  if (_File === 0) {
    ...
    // Read file lines, build index
    // (File I/O — stubbed for JS)
    G.DAT_0062e60c = 1;
  }
}
...
export function FUN_004db690(param_1) {
  ...
  FUN_0046b14d(0x82, G.DAT_006ad30c[G.DAT_006ad558[G.DAT_0067a8c0] * 0x15], 0, 0, 0, 0, 0, 0, 0, puVar2);
  return puVar2;
}
...
export function FUN_004dbab4(param_1, param_2, param_3, param_4) {
  let in_ECX = {};
  // Switch on negotiation type — fills packet buffer
  // Types: 5/6 (treaty), 8 (cities), 9 (gold), 10 (units), 0xc (maps), 0xd (attitude), 0x11 (units+count)
  // Each fills param_1 array with type, size, count, then items
  // (Complex packet serialization — stubbed)
}
...
export function FUN_004dbee6(param_1, param_2) {
  if (param_1 === 0) return;
  // Builds human-readable text for a parley transaction
  // Reads transaction type from param_1 + 0x10, dispatches to sub-formatters
  // (FUN_004dcafa, FUN_004dcc0c, FUN_004dcc83, FUN_004dcea5, FUN_004dd016, FUN_004dd176, FUN_004def54)
  // Result stored in G.DAT_006a5b58
}
...
export function FUN_004dd285(param_1) {
  ...
  switch (txnType) {
    ...
    case 0xd:
      ...
      break;
    case 0xe:
      // Trade — execute both sides
      // (Complex dispatch omitted — mirrors same switch for both directions)
      break;
    case 0xf:
      // Demand — execute one side
      break;
  }
  ...
  if (G.DAT_006d1da0 === iVar2) {
    ...
    FUN_0046b14d(0x79, G.DAT_006ad30c[G.DAT_006ad558[iVar2] * 0x15], 0, 0, 0, 0, 0, 0, 0, 0);
  }
  if (G.DAT_006d1da0 === iVar1) {
    FUN_0056a65e(1);
  } else {
    FUN_0046b14d(0x79, G.DAT_006ad30c[G.DAT_006ad558[iVar1] * 0x15], 0, 0, 0, 0, 0, 0, 0, 0);
  }
  // Check if civ was eliminated
  if (G.DAT_0064b9e8[iVar2] === 0 && G.DAT_0064c708[iVar2 * 0x2CA] === 0) {
    FUN_kill_civ(iVar2, iVar1);
  }
  if (G.DAT_0064b9e8[iVar1] === 0 && G.DAT_0064c708[iVar1 * 0x2CA] === 0) {
...
export function FUN_004dd8ad(param_1, param_2, param_3) {
  ...
  for (let local_c = 0; local_c < G.DAT_006d1164; local_c = local_c + 1) {
    ...
    // Complex map visibility transfer logic
    local_14 = local_14 + 2;
  ...
  // Transfer units and cities visibility
  FUN_005b9f1c();
  FUN_004b0b53(0xff, 2, 0, 0, 0);
  if (G.DAT_006d1da0 === param_1) {
    FUN_0047cf9e(G.DAT_006d1da0, 1);
  } else {
    FUN_0046b14d(0x74, G.DAT_006ad30c[G.DAT_006ad558[param_1] * 0x15], 0, 0, 0, 0, 0, 0, 0, 0);
  }
}
...
export function FUN_004ddf04(param_1, param_2, param_3) {
  if (G.DAT_0064c6a2[param_2 * 0x165] < param_3) {
    param_3 = G.DAT_0064c6a2[param_2 * 0x165];
  }
  G.DAT_0064c6a2[param_2 * 0x165] = G.DAT_0064c6a2[param_2 * 0x165] - param_3;
  G.DAT_0064c6a2[param_1 * 0x165] = G.DAT_0064c6a2[param_1 * 0x165] + param_3;
...
export function FUN_004de049(param_1, param_2) {
  ...
  for (let local_c = 0; local_c < iVar1; local_c = local_c + 1) {
    ...
    if (-1 < iVar2 && G.DAT_0064f394[iVar2 * 0x16] !== 0) {
...
export function FUN_004de0e2(param_1, param_2) {
  ...
  let iVar2 = cVar1;
  let iVar3 = G.DAT_0064f340[param_1 * 0x2C];
  let iVar4 = G.DAT_0064f342[param_1 * 0x2C];
  FUN_0043d289(param_1, 1, 0);
  FUN_0043d289(param_1, 4, 0);
  FUN_0043d289(param_1, 0xb, 0);
  FUN_0043d289(param_1, 7, 0);
  G.DAT_0064caa2[param_2 * 0x2CA + 3] = G.DAT_00655af8;
  G.DAT_0064c708[param_2 * 0x2CA] = G.DAT_0064c708[param_2 * 0x2CA] + 1;
  if (G.DAT_0064c708[iVar2 * 0x2CA] !== 0) {
    G.DAT_0064c708[iVar2 * 0x2CA] = G.DAT_0064c708[iVar2 * 0x2CA] - 1;
  }
  FUN_005b9ec6();
  ...
  // Transfer units in city — complex loop
  // Update production, check if city should select new production
  FUN_0047cf22(G.DAT_0064f340[param_1 * 0x2C], G.DAT_0064f342[param_1 * 0x2C]);
  FUN_004b0b53(0xff, 2, 0, 0, 0);
  FUN_0046b14d(0x75, 0xff, G.DAT_0064f340[param_1 * 0x2C], G.DAT_0064f342[param_1 * 0x2C], 0, 0, 0, 0, 0, 0);
...
export function FUN_004de990(param_1, param_2) {
  let local_14 = param_2[2] || 0;
  let local_8 = 3;
  for (let local_20 = 0; local_20 < local_14; local_20 = local_20 + 1) {
    let uVar1 = param_2[local_8];
    local_8 = local_8 + 1;
    let local_2c = FUN_0052ec47(uVar1);
    if (-1 < local_2c) {
      let local_10 = s8(G.DAT_006560f7[local_2c * 0x20]);
      if (param_1 !== local_10) {
        // Handle splitting stacked units
        let iVar2 = FUN_004ded07(local_2c, 0, 0, param_1, 0);
        if (iVar2 !== 0) {
          // Transfer ownership and update counts
