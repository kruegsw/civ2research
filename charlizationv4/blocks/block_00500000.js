...
export function FUN_00501819(param_1) {
  ...
  if ((s8(G.DAT_0064f348[iVar1 * 0x58]) === G.DAT_006d1da0) || (G.DAT_00655b07 !== 0)) {
    ...
    if (s8(G.DAT_0064f349[iVar1 * 0x58]) - G.DAT_006a6604 <= param_1) {
      // DEVIATION: MFC — iVar1 = CSplitterWnd::IsTracking(G.DAT_006a91b8);
      param_1 = param_1 - (((s8(G.DAT_0064f349[iVar1 * 0x58])) << 16 >> 16) - ((G.DAT_006a6604) << 16 >> 16));
...
export function FUN_005025d5(in_ECX, param_1) {
  ...
  if ((((s32(in_ECX, 0x15a4) === 0) && (s32(in_ECX, 0x15a0) === 0)) &&
    ...
    for (local_3c = 0; local_3c < 0x15; local_3c = local_3c + 1) {
      // DEVIATION(C-syntax): true)) // DEVIATION: C pointer — local_fc = FUN_005ae052((int)*(short *)(G.DAT_0064f340 + s32(in_ECX, 0x159c) * 0x58
                                                   // DEVIATION(cont): ) + (int)(char)(&G.DAT_00630d38)[local_3c]);
      true // DEVIATION: C pointer — local_4c = s16(G.DAT_0064f342, s32(in_ECX, 0x159c) * 0x58) +
...
export function FUN_00504c05(in_ECX, param_1) {
  ...
  if ((((s32(in_ECX, 0x15a4) === 0) && (s32(in_ECX, 0x15a0) === 0)) &&
    ...
    iVar5 = local_14[0];
    local_1c = 0;
    true // DEVIATION: C pointer — local_24 = s16(G.DAT_0064f35a, s32(in_ECX, 0x159c) * 0x58);
    local_2c = local_10;
    FUN_0047df20(s32(in_ECX, 0x15d4) * 4 + -8);
...
export function FUN_0050503e(in_ECX, param_1) {
  ...
  if ((((s32(in_ECX, 0x15a4) === 0) && (s32(in_ECX, 0x15a0) === 0)) &&
    ...
    if (G.DAT_0064f379[s32(in_ECX, 0x159c) * 0x58] !== -0x26) {
      ...
      local_1c = 0;
      true // DEVIATION: C pointer — local_24 = ((s16(G.DAT_0064f35c, s32(in_ECX, 0x159c) * 0x58)) >>> 0);
      local_28 = local_14[0];
      local_30 = local_10;
      FUN_0047df20(s32(in_ECX, 0x15d4) * 4 + -8);
...
export function FUN_00506a42(param_1) {
  ...
  case 7:
    ...
    w16(G.DAT_0064f35c, iVar2 * 0x58, 
         (short)((int)(s8(G.DAT_0064b1c8[u8(G.DAT_006560f6[iVar1 * 0x20]) * 0x14])
...
export function citywin_70E5_005070E5(in_ECX) {
  ...
  local_3c = local_50 << 2;
  FUN_0046ac89(3);
  true) // DEVIATION: C pointer — local_78 = FUN_005b2e69(s16(G.DAT_0064f340, s32(in_ECX, 0x159c) * 0x58),
  ...
  if (iVar1 !== 0) {
    ...
    for (local_30 = 0; local_30 < 3; local_30 = local_30 + 1) {
      local_60 = ((s8(G.DAT_0064f37b[s32(in_ECX, 0x159c) * 0x58 + local_30]) < 0) >>> 0);
      if (local_60 !== 0) {
        FUN_0040fea0();
      }
    ...
    FUN_0040fe40();
    for (local_30 = 0; local_30 < 3; local_30 = local_30 + 1) {
      local_60 = ((s8(G.DAT_0064f37e[s32(in_ECX, 0x159c) * 0x58 + local_30]) < 0) >>> 0);
      if (local_60 !== 0) {
        FUN_0040fea0();
      }
  ...
  for (local_30 = 0; local_30 < s8(G.DAT_0064f37a[s32(in_ECX, 0x159c) * 0x58]);
    ...
    FUN_0040bbe0(G.DAT_0064f360 +
                       true // DEVIATION: C pointer — s16(G.DAT_0064f384, s32(in_ECX, 0x159c) * 0x58 + local_30 * 2) *
                       // DEVIATION(cont): 0x58);
    FUN_0040fe10();
...
export function citywin_7B69_00507B69(in_ECX) {
  ...
  true // DEVIATION: C pointer — iVar6 = FUN_005ae052(s16(G.DAT_0064f340, s32(in_ECX, 0x159c) * 0x58) - local_8)
  // DEVIATION(cont): ;
  FUN_00408780(iVar6 * iVar5 + iVar3,
                     true // DEVIATION: C pointer — s16(G.DAT_0064f342, s32(in_ECX, 0x159c) * 0x58) * iVar5 + iVar4,
  ...
  if (bVar1 === 4) {
    ...
    for (local_38 = 0; local_38 < G.DAT_00655b16; local_38 = local_38 + 1) {
      if ((((s32(G.DAT_0065610a, local_38 * 0x20) !== 0) &&
           (iVar3 = local_8 >> 1,
           true // DEVIATION: C pointer — s16(G.DAT_0064f340, s32(in_ECX, 0x159c) * 0x58) ===
...
export function citywin_92AF_005092AF(in_ECX) {
  ...
  if (1 < G.DAT_006aa78c) {
    ...
    FUN_0040bc10(0x9a);
    FUN_0040fe40();
    // DEVIATION(C-syntax): true) // DEVIATION: C pointer — FUN_0043c8a0(*(undefined4 *)
...
export function citywin_9429_00509429(in_ECX) {
  ...
  if ((((-1 < s32(in_ECX, 0x159c)) && (s32(in_ECX, 0x159c) < G.DAT_00655b18)) &&
      true // DEVIATION: C pointer — (s32(G.DAT_0064f394, s32(in_ECX, 0x159c) * 0x58) !== 0)) && (G.DAT_00628044 !== 0))
  // DEVIATION(cont): {
...
// DEVIATION(unparsed): {
  ...
  // DEVIATION(unparsed): for (local_20 = 0; local_20 < G.DAT_00655b18; local_20 = local_20 + 1) {
    // DEVIATION(unparsed): if ((*(int *)(&G.DAT_0064f394 + local_20 * 0x58) != 0) &&
       // DEVIATION(unparsed): ((char)(&G.DAT_0064f348)[local_20 * 0x58] == param_3)) {
      // DEVIATION(unparsed): local_8 = (int)(char)(&G.DAT_0064f349)[local_20 * 0x58];
      ...
      // DEVIATION(unparsed): }
      // DEVIATION(unparsed): if ((&G.DAT_0064f379)[local_20 * 0x58] == -1) {
...
export function citywin_C494_0050C494(in_ECX, param_1, param_2, param_3) {
  ...
  if ((((s32(in_ECX, 0x15a4) === 0) && (s32(in_ECX, 0x15a0) === 0)) &&
      (s32(in_ECX, 0x15a8) === 0)) && (-1 < s32(in_ECX, 0x159c))) {
    if (param_1 < 0) {
      true) // DEVIATION: C pointer — if ((s16(G.DAT_0064f340, s32(in_ECX, 0x159c) * 0x58) === param_2) &&
    ...
    true))) // DEVIATION: C pointer — else if (((s16(G.DAT_0064f340, s32(in_ECX, 0x159c) * 0x58) ===
