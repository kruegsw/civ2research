...
import { FUN_0043cc00, FUN_0043cf76 } from './block_00430000.js';
...
export function FUN_0057a7e9(param_1, param_2, param_3) {
  ...
  // G.DAT_0064c708[param_2 * 0x594] -= 1 (short)
  // G.DAT_0064c708[param_3 * 0x594] += 1 (short)
  // G.DAT_0064c70c population adjustments
  // Set city owner
  G.DAT_0064f340[param_1 * 0x58 + 8] = u8(param_3); // G.DAT_0064f348
...
export function FUN_0057a904(param_1) {
  ...
  for (let local_148 = 1; local_148 < 8; local_148 = local_148 + 1) {
    if ((s16(G.DAT_0064c600, local_148 * 0x594 + 0x106) === 0) && // G.DAT_0064c706
       (s16(G.DAT_0064c600, local_148 * 0x594 + 0x108) === 0)) { // G.DAT_0064c708
      local_24 = local_148;
    }
  }
  if (local_24 < 1) {
  ...
  for (let local_140 = 0; local_140 < G.DAT_00655b18; local_140 = local_140 + 1) {
    if ((s16(G.DAT_0064f340, local_140 * 0x58 + 0x54) !== 0) &&
  ...
  G.DAT_0064c6c0[local_24 * 0x594 + param_1 * 4] = 0x01; // 0x2001 as uint32
  G.DAT_0064c6c0[local_24 * 4 + param_1 * 0x594] = 0x01; // 0x82801 as uint32
...
export function FUN_0057b5df(param_1, param_2, param_3) {
    ...
    if (!(((1 << (u8(param_2) & 0x1f)) & u8(G.DAT_00655b0b)) !== 0 &&
      ...
      if (((1 << (u8(param_2) & 0x1f)) & u8(G.DAT_00655b0b)) !== 0 &&
        ...
        if ((1 < local_88) && ((local_88 & 1) === 0)) {
          ...
          // G.DAT_0064c6c0 |= 0x400000 (set bit in uint32)
        }
      }
    } else {
      // Democracy capturing less advanced civ — always reputation hit
      // G.DAT_0064c6c0 |= 0x400000
    }
  }
  ...
  if (iVar6 !== 0) {
    ...
    if (local_3c4 === 1) {
      ...
      // G.DAT_0064c6a2 -= 1000 (simplified)
  ...
  // ── Transfer gold ──
  local_74 = FUN_005adfa0(local_74, 0, s16(G.DAT_0064c600, local_84 * 0x594 + 0xa2));
  // Subtract from old owner, add to new owner
  // G.DAT_0064c6a2[local_84] -= local_74
  // G.DAT_0064c6a2[param_2] += local_74
  ...
  // G.DAT_0064f35c[param_1] = 0 (shields stored)
  // Clear city flags
  // G.DAT_0064f344[param_1] &= 0xffffffc4

  // ── Decrement building count for old owner ──
  if (s8(G.DAT_0064f340[param_1 * 0x58 + 0x39]) >= 0) {
    // G.DAT_0064c7f4[local_84 * 0x594 + building] -= 1
  }
  ...
  if (param_1 >= 0 && param_1 !== 0xffffffff) {
    ...
    // G.DAT_0064c6ae[param_2] = G.DAT_00655af8
...
export function FUN_0057e9f9(param_1, param_2, param_3, param_4) {
  ...
  // G.DAT_0064c7b6[unitOwner * 0x594 + unitType] += 1
