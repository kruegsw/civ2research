...
export function FUN_00575dec() {
  ...
  uVar1 = FUN_00428b0c(G.DAT_00628420 + 0x950, 0xd, 0, 0, 0xf0, 0xf0, 0, 0, 0);
  ...
  // let uVar1_ok = FUN_00428b0c(G.DAT_00628420 + 0x3f8); // DEVIATION: OK string
  ...
  // let uVar1_apply = FUN_00428b0c(G.DAT_00628420 + 0x954); // DEVIATION: Apply string
  ...
  // let uVar1_cancel = FUN_00428b0c(G.DAT_00628420 + 0x3fc); // DEVIATION: Cancel string
...
export function show_messagebox_6267() {
  ...
  do {
    uVar1 = FUN_00428b0c(G.DAT_00628420 + 0x958, 0, local_844, local_844, 0, 0);
    ...
    uVar1 = FUN_00428b0c(G.DAT_00628420 + 0x95c, local_844);
    ...
    if (iVar2 === 0) {
      ...
      if ((G.DAT_006ac924 === 7 || G.DAT_006ac924 === 10) &&
        ...
        if (pcVar3 !== null) {
          ...
          if (iVar2 !== 0) { local_94c = 0; }
            ...
            // let pCVar4 = FUN_00428b0c(G.DAT_00628420 + 0x964); // DEVIATION: error string
          ...
          if (pcVar3 !== null) {
            ...
            if (iVar2 !== 0) { local_94c = 0; }
              ...
              // let pCVar4 = FUN_00428b0c(G.DAT_00628420 + 0x964); // DEVIATION: error
              // MessageBoxA(0, pCVar4, null, 0x10); // DEVIATION: Win32 error
            }
          } else {
            // let pCVar4 = FUN_00428b0c(G.DAT_00628420 + 0x968); // DEVIATION: format error
            // MessageBoxA(0, pCVar4, null, 0x10); // DEVIATION: Win32 error
          }
        }
      }
      ...
      uVar1 = FUN_00428b0c(G.DAT_00628420 + 0x960, local_844);
