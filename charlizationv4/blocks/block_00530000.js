...
import { FUN_004a2379, FUN_004a23fc, FUN_004adafc, kill_civ } from './block_004A0000.js';
...
// (duplicate DAT_ declarations removed: G.DAT_0064f37a, G.DAT_0064f384, G.DAT_0064f346,
//  G.DAT_0064f347, G.DAT_0064f360, G.DAT_00627cd2, G.DAT_00627cd4, G.DAT_00627cd5, G.DAT_00627ccb,
//  G.DAT_0064f346, G.DAT_0064f360, G.DAT_006ced50, G.DAT_00655c31, G.DAT_0064c7a5, G.DAT_0064bcba
...
export function FUN_0053184d(param_1) {
  ...
  if (iVar3 !== 0 && G.DAT_0064c785[param_1 * 0x594] !== 0 &&
    ...
    for (local_344 = 0; local_344 < G.DAT_00655b18; local_344++) {
      if (G.DAT_0064f394[(local_344 * 0x58) / 4] !== 0 &&
        ...
        if (local_60 >= 0 && G.DAT_0063f660 < 9 &&
          ...
          if (iVar13 === iVar15) {
            ...
            if (iVar13 < 3 && (iVar13 = FUN_005b53b6(iVar8, 0), iVar13 === 0) &&
              ...
              G.DAT_006560f9[iVar8 * 0x20] = u8(G.DAT_006560f9[iVar8 * 0x20] | tileRead(iVar9, 4));
    ...
    if (local_40 === 8) {
      ...
      if (G.DAT_006560ff[iVar8 * 0x20] !== 0x0b) {
        ...
        for (local_60 = 0; local_60 < G.DAT_00655b18; local_60++) {
          if (G.DAT_0064f394[(local_60 * 0x58) / 4] !== 0 && G.DAT_0064f348[local_60 * 0x58] !== 0) {
            if (local_1c >= 0) {
      ...
      if (local_40 === 8) {
        ...
        if (iVar9 < 0 || (iVar9 = FUN_005b50ad(iVar8, 2), iVar9 > 1) || local_10 > 0x62) {
          if (local_10 < 99 && (iVar9 = FUN_005b2c3d(iVar8), iVar9 <= G.DAT_0064bcc8) &&
            ...
            if ((tileRead(iVar9, 1) & 0x4c) !== 0 ||
                (uVar20 === 9 && (tileRead(iVar9, 1) & 0x10) !== 0)) {
...
export function FUN_00537331(param_1, param_2, p_d4, p_e8, param_5, p_a4, param_7, param_8, param_9) {
  ...
  for (local_44 = 0; local_44 < G.DAT_00655b18; local_44++) {
    if (G.DAT_0064f394[(local_44 * 0x58) / 4] !== 0 &&
        ...
        if (((G.DAT_00655af0 & 0x80) === 0 || (rs16(G.DAT_0064bc60, 0) & 0x8000) === 0 || uVar8 !== 1) ||
          ...
          if (local_144 === 0 && local_3c === 0 &&
            ...
            if (!flag_LAB_005414d7 && !flag_LAB_005436c1 && !flag_LAB_005435ca) {
              ...
              if (local_e4 === 6) {
                // Line 2808-2929: caravan/freight AI logic
                if (G.DAT_006560ff[local_168 * 0x20] === 0x0b &&
                    (iVar11 = FUN_0043cf76(rs16(G.DAT_00656102, local_168 * 0x20),
                                            rs16(G.DAT_00656104, local_168 * 0x20)),
                     iVar11 >= 0) &&
                    s8(G.DAT_0064f348[iVar11 * 0x58]) !== uVar8 &&
                    (G.DAT_0064c6c0[s8(G.DAT_0064f348[iVar11 * 0x58]) * 4 + uVar8 * 0x594] & 0xe) === 0) {
                  local_a4 = 1;
                } else {
                  ...
                  if (iVar11 === 0) {
                    ...
                    local_38 = -999;
                    local_160 = -1;
                    let caravan_goto_LAB_00539b29 = false;
                    for (local_134 = 0; local_134 < G.DAT_00655b18; local_134++) {
                      caravan_goto_LAB_00539b29 = false;
                      if (G.DAT_0064f394[(local_134 * 0x58) / 4] !== 0) {
                        iVar11 = FUN_005b8a81(rs16(G.DAT_0064f340, local_134 * 0x58),
                                               rs16(G.DAT_0064f342, local_134 * 0x58));
                        iVar12 = FUN_005b89e4(local_d4, local_e8);
                        if (iVar12 === 0) {
                          if (iVar11 === iVar10) {
                            // LAB_00539cb3: (inline — same-continent city scoring)
                            local_78 = s8(G.DAT_0064f348[local_134 * 0x58]) & 0xff;
                            local_70 = FUN_005ae31d(local_d4, local_e8,
                                                     rs16(G.DAT_0064f340, local_134 * 0x58),
                                                     rs16(G.DAT_0064f342, local_134 * 0x58));
                            if ((u8(G.DAT_00656100[local_168 * 0x20]) % 3 !== local_134 % 3) &&
                                (uVar15 = FUN_005b94d5(local_d4, local_e8),
                                 (((uVar15 & 0x10) >> 4) + 3) < local_70)) {
                              local_70 = local_70 + 8;
                            }
                            if (local_78 === uVar8) {
                              ...
                              if ((G.DAT_0064c6c0[local_78 * 4 + uVar8 * 0x594] & 0xe) !== 0) {
                                if (((1 << (u8(local_78) & 0x1f)) & u32(G.DAT_00655b0b)) === 0 ||
                                    (G.DAT_0064f344[local_134 * 0x58] & 8) !== 0 ||
                                    (iVar11 = FUN_00598d45(uVar8), iVar11 === 0 &&
                                     (u8(G.DAT_00655c22[local_78]) < u8(G.DAT_00655c22[uVar8]) ||
                                      ((G.DAT_006560f6[local_168 * 0x20] !== 0x2f &&
                                        ((u8(G.DAT_0064c6b0[local_78 * 0x594]) -
                                          u8(G.DAT_0064c6b0[uVar8 * 0x594]))) < 10) &&
                                       (u8(G.DAT_0064c6b5[uVar8 * 0x594]) > 4 ||
                                        u8(G.DAT_00655c22[local_78]) < 7 ||
                                        ((G.DAT_0064c6c0[local_78 * 4 + uVar8 * 0x594] & 8) !== 0 &&
                                         u8(G.DAT_0064c6b0[local_78 * 0x594]) <
                                         u8(G.DAT_0064c6b0[uVar8 * 0x594]))) ||
                                       ((G.DAT_0064c6c0[local_78 * 4 + uVar8 * 0x594] & 8) === 0 &&
                                        u8(G.DAT_0064c6b5[local_78 * 0x594]) > 4 &&
                                        u16(G.DAT_0064c832, iVar10 * 2 + uVar8 * 0x594) <
                                        u16(G.DAT_0064c8b2, iVar10 * 2 + local_78 * 0x594) &&
                                        G.DAT_0064c932[uVar8 * 0x594 + iVar10] !== 0))))) {
                                  caravan_goto_LAB_00539b29 = true;
                                }
                                if (!caravan_goto_LAB_00539b29) {
                              ...
                              if (!caravan_goto_LAB_00539b29) {
                                ...
                                if ((G.DAT_0064f344[local_134 * 0x58] & 8) !== 0) {
                                  local_18 = (local_18 / 2) | 0;
                                  if (u8(G.DAT_0064c6b0[uVar8 * 0x594]) + 6 <
                                      u8(G.DAT_0064c6b0[local_78 * 0x594])) {
                                    local_18 = (local_18 / 2) | 0;
                                  }
                                  if (local_24 !== 0) {
                          ...
                          // cross-ocean: check adjacent tiles for same continent
                          local_c4 = 0;
                          for (local_60 = 0; local_60 < 8; local_60++) {
                            ...
                            if (iVar12 !== 0 &&
                                ...
                                (iVar12 = FUN_005b8a81(uVar9, local_74), iVar12 === iVar11)) {
                              local_c4 = 1;
                              break;
                            }
                          }
                          if (local_c4 !== 0) {
                            // goto LAB_00539cb3 — same-continent city scoring (inline copy)
                            local_78 = s8(G.DAT_0064f348[local_134 * 0x58]) & 0xff;
                            local_70 = FUN_005ae31d(local_d4, local_e8,
                                                     rs16(G.DAT_0064f340, local_134 * 0x58),
                                                     rs16(G.DAT_0064f342, local_134 * 0x58));
                      ...
                      // LAB_00539b29: continue loop
                    }
                    // Line 2912: check if best city found
                    if (local_160 < 0) {
                      if (G.DAT_006560ff[local_168 * 0x20] !== 0x0b) {
                    ...
                    if (!flag_LAB_005436c1) {
                      local_a4 = 1;
                      if (G.DAT_006560ff[local_168 * 0x20] !== 0x0b ||
                          s8(G.DAT_0064f348[local_160 * 0x58]) !== uVar8) {
                        FUN_00531607(local_168, 0x53,
                                     rs16(G.DAT_0064f340, local_160 * 0x58),
                                     rs16(G.DAT_0064f342, local_160 * 0x58));
                      }
                    }
                  }
                }
                ...
                // Line 2930-3040: explorer AI logic
                if (G.DAT_006560ff[local_168 * 0x20] === 0x0b) {
                  flag_LAB_005436c1 = true;
                } else {
                  iVar11 = FUN_005b89e4(local_d4, local_e8);
                  let explorer_done = false;
                  if (iVar11 !== 0) {
                    local_160 = -1;
                    local_38 = 0;
                    for (local_60 = 0; local_60 < 8; local_60++) {
                      ...
                      if (iVar11 !== 0 &&
                          ...
                          (iVar11 = FUN_005b8a81(uVar9, local_74),
                           G.DAT_0064c9f2[uVar8 * 0x594 + iVar11] !== 0)) {
                        local_18 = 0;
                        for (local_78 = 1; local_78 < 8; local_78++) {
                          if (local_78 === uVar8) {
                            iVar11 = (u8(G.DAT_0064c972[uVar8 * 0x594 + iVar10]) + 1) >> 1;
                          } else {
                            iVar11 = u8(G.DAT_0064c972[uVar8 * 0x594 + iVar10]) * 2;
                          }
                          local_18 = local_18 + iVar11;
                        }
                        if (local_38 < local_18) {
                    ...
                    if (local_160 >= 0) {
                      G.DAT_006560fc[local_168 * 0x20] = 0x74;
                      local_c8 = local_160;
                      uVar15 = local_c8;
                      flag_LAB_005435ca = true;
                      explorer_done = true;
                  ...
                  if (!explorer_done && !flag_LAB_005435ca) {
                    // Line 2966: fallback — find best city to explore toward
                    local_38 = 0;
                    local_160 = -1;
                    if (G.DAT_00656100[local_168 * 0x20] === 0xff) {
                      local_44 = -1;
                    } else {
                    ...
                    for (local_134 = 0; local_134 < G.DAT_00655b18; local_134++) {
                      if (G.DAT_0064f394[(local_134 * 0x58) / 4] !== 0 &&
                          (iVar11 = FUN_005b8a81(rs16(G.DAT_0064f340, local_134 * 0x58),
                           ...
                           iVar11 === iVar10)) {
                        local_c4 = 1;
                        for (local_60 = 0; local_60 < s8(G.DAT_0064f37a[local_44 * 0x58]); local_60++) {
                          if (rs16(G.DAT_0064f384, local_44 * 0x58 + local_60 * 2) === local_134) {
                            local_c4 = 0;
                          }
                        }
                        iVar11 = FUN_005ae31d(rs16(G.DAT_0064f340, local_134 * 0x58),
                                               rs16(G.DAT_0064f342, local_134 * 0x58),
                                               rs16(G.DAT_0064f340, local_44 * 0x58),
                                               rs16(G.DAT_0064f342, local_44 * 0x58));
                        local_70 = ((rs16(G.DAT_0064f35e, local_44 * 0x58) +
                                    rs16(G.DAT_0064f35e, local_134 * 0x58)) * iVar11) / 0x18 | 0;
                        if (s8(G.DAT_0064f348[local_134 * 0x58]) === uVar8) {
                          local_70 = (local_70 / 2) | 0;
                        } else {
                          uVar9 = FUN_00467904(uVar8, s8(G.DAT_0064f348[local_134 * 0x58]), 0, 100);
                          local_cc = FUN_005adfa0(uVar9);
                          local_70 = ((200 - local_cc) * local_70) / 100 | 0;
                        }
                        if (local_c4 === 0) {
                          local_70 = (local_70 / 2) | 0;
                        }
                        local_70 = ((5 - s8(G.DAT_0064f37a[local_134 * 0x58])) * local_70) / 5 | 0;
                        if (local_88 >= 0 && local_40 !== local_88 && iVar10 === local_104 &&
                            G.DAT_0064f348[local_134 * 0x58] !== G.DAT_0064f348[local_88 * 0x58]) {
                          local_70 = (local_70 / 3) | 0;
                          if ((u32(G.DAT_00655b0b) & (1 << (G.DAT_0064f348[local_88 * 0x58] & 0x1f))) !== 0) {
                            local_70 = (local_70 / 2) | 0;
                          }
                        }
                    ...
                    if (local_160 >= 0) {
                      FUN_00531607(local_168, 99, rs16(G.DAT_0064f340, local_160 * 0x58),
                                   rs16(G.DAT_0064f342, local_160 * 0x58));
                      flag_LAB_005436c1 = true;
                    }
                    if (!flag_LAB_005436c1 && G.DAT_00656100[local_168 * 0x20] !== 0xff) {
                      uVar15 = u8(G.DAT_00656100[local_168 * 0x20]);
                      iVar11 = FUN_005b8a81(rs16(G.DAT_0064f340, uVar15 * 0x58),
                                             rs16(G.DAT_0064f342, uVar15 * 0x58));
                      if (iVar11 === iVar10) {
                        FUN_00531607(local_168, 99, rs16(G.DAT_0064f340, uVar15 * 0x58),
                                     rs16(G.DAT_0064f342, uVar15 * 0x58));
                        flag_LAB_005436c1 = true;
                      }
                    }
                  }
                  // Line 3041: fall through to general logic
                            ...
                            for (local_60 = 9; local_60 >= 0; local_60--) {
                              ...
                              if (iVar11 !== 0 &&
                                ...
                                if (local_78 < 0) {
                                  ...
                                  local_18 = local_18 + s8(G.DAT_00627cc9[u8(bVar6) * 0x18]) * 3;
                                  iVar11 = FUN_005ae1b0(local_d4, local_e8, uVar9, local_74);
                                  local_18 = local_18 + iVar11;
                                  if (local_38 < local_18) {
                                    local_160 = local_60;
  ...
  if (flag_LAB_0053be12 && !flag_LAB_005435ca && !flag_LAB_005436c1 && !flag_LAB_005414d7) {
    ...
    while (true) {
      ...
      if (local_144 === 2) {
            ...
            if (local_34 < local_188 || local_a8 !== 0) {
              ...
              for (local_134 = 0; local_134 < G.DAT_00655b18; local_134++) {
                if (ri32(G.DAT_0064f394, local_134 * 0x58) !== 0 &&
                  ...
                  if (iVar13 !== 0) {
                    local_dc = 0;
                    uVar2 = u16(G.DAT_0064c832, iVar12 * 2 + uVar8 * 0x594);
                    iVar13 = FUN_00536bc9(uVar8, iVar12);
                    if (uVar2 < iVar13 && G.DAT_0064ca32[uVar8 * 0x594 + iVar12] !== 0x04) {
                    ...
                    if (G.DAT_0064ca32[uVar8 * 0x594 + iVar12] === 0x04 ||
                      ...
                      local_70 = local_70 - (u16(G.DAT_0064c8b2, uVar8 * 0x594 + iVar12 * 2) >> 2);
                    } else {
                      local_70 = local_70 + 0x10;
                    }
              ...
              // Line 3491
              if (iVar19 === 0 &&
                  (((s8(G.DAT_006560fd[iVar11 * 0x20]) ^ ((G.DAT_00655af8 - 1) & 3)) & 3) !== 0) &&
                  ((local_c & 0x20) === 0 ||
                   (local_c === 0x20 ||
                    local_34 < s8(G.DAT_0064b1c9[u8(G.DAT_006560f6[iVar11 * 0x20]) * 0x14])))) {
                local_38 = 1000;
              ...
              if (local_38 < local_70 * 3) {
                ...
                wi32(G.DAT_0064f344, local_160 * 0x58, ri32(G.DAT_0064f344, local_160 * 0x58) | 0x600);
                if (local_140 === 0) {
                  uVar9 = FUN_005b2e69(rs16(G.DAT_00656102, iVar11 * 0x20), rs16(G.DAT_00656104, iVar11 * 0x20));
              ...
              // Line 3553: else — request units at current city
                ...
                uVar2 = u16(G.DAT_0064c832, iVar10 * 2 + uVar8 * 0x594);
                ...
                if (local_dc !== 0 || local_140 !== 0) {
                  wi32(G.DAT_0064f344, local_40 * 0x58, ri32(G.DAT_0064f344, local_40 * 0x58) | 0x600);
                  if (local_dc !== 0) {
                    uVar9 = FUN_005b2e69(rs16(G.DAT_0064f340, local_40 * 0x58), rs16(G.DAT_0064f342, local_40 * 0x58));
          ...
          if (local_c4 !== 0 || local_94 !== 0 || local_20 !== 0) {
            ...
            for (local_60 = 0; local_60 < 8; local_60++) {
              ...
              if (iVar12 !== 0 &&
                ...
                let bVar5 = false;
                if (local_88 >= 0 &&
                    s8(G.DAT_0064f348[local_88 * 0x58]) !== uVar8 &&
                ...
                if ((local_c & 0x80) === 0) {
                  ...
                  for (local_cc = FUN_005b2d39(iVar11); local_cc >= 0;
                    ...
                    if (G.DAT_0064b1ca[u8(G.DAT_006560f6[local_cc * 0x20]) * 0x14] === 0x07) {
                      if (G.DAT_00656100[local_cc * 0x20] === 0xff) {
                        local_44 = -1;
                      } else {
                ...
                if (G.DAT_0064c932[uVar8 * 0x594 + iVar12] === 0 &&
                    u16(G.DAT_0064c832, iVar12 * 2 + uVar8 * 0x594) < 8) {
                  local_dc = 1;
                }
                ...
                if (G.DAT_006560ff[iVar11 * 0x20] === 0x0b &&
                    (iVar13 = FUN_005b8a81(rs16(G.DAT_00656102, iVar11 * 0x20), rs16(G.DAT_00656104, iVar11 * 0x20)),
                     iVar13 === iVar12) && G.DAT_006560fc[iVar11 * 0x20] !== 0x33) {
                  local_dc = 1;
                  local_16c = 1;
                }
                // Line 3763
                if ((local_c & 0x20) === 0 && G.DAT_0064c9f2[uVar8 * 0x594 + iVar12] === 0) {
                  if (s16(G.DAT_0064c832, iVar12 * 2 + uVar8 * 0x594) === 0 &&
                      s16(G.DAT_00666130, iVar12 * 0x10) > 0x31) {
                ...
                // Line 3801
                if (local_dc !== 0 && s16(G.DAT_00666132, iVar12 * 0x10) > 4 &&
                    local_74 > 1 && local_74 < G.DAT_006d1162 - 2) {
                  iVar10 = FUN_005b2c3d(iVar11);
                  if (iVar10 >= u8(G.DAT_0064bcc8) &&
                      (iVar19 !== 0 || uVar21 !== 1) &&
            ...
            if (iVar12 <= u8(G.DAT_0064bcc8) && G.DAT_006560ff[iVar11 * 0x20] === 0x0b) {
        ...
        if (local_e4 === 4 || local_158 === 0) {
          ...
          if (G.DAT_006560ff[iVar11 * 0x20] !== 0x0b &&
              (local_c & 3) !== 0 &&
              G.DAT_0064b1c9[u8(G.DAT_006560f6[iVar11 * 0x20]) * 0x14] !== 0) {
            local_38 = 0x18;
            for (local_134 = 0; local_134 < G.DAT_00655b18; local_134++) {
              if (ri32(G.DAT_0064f394, local_134 * 0x58) !== 0 &&
                  s8(G.DAT_0064f348[local_134 * 0x58]) === uVar8 &&
          ...
          if (G.DAT_006560ff[iVar11 * 0x20] !== 0x0b && (local_c & 3) !== 0) {
            ...
            for (local_134 = 0; local_134 < G.DAT_00655b18; local_134++) {
              if (ri32(G.DAT_0064f394, local_134 * 0x58) !== 0 &&
                  (local_78 = s8(G.DAT_0064f348[local_134 * 0x58]),
                   local_78 !== uVar8) &&
                ...
                if (iVar12 !== 0) {
                  ...
                  for (local_14c = 1; local_14c < 8; local_14c++) {
                    if ((1 << (local_14c & 0x1f) & u8(G.DAT_00655b0b)) !== 0 &&
          ...
          if (G.DAT_006560ff[local_168 * 0x20] !== 0x0b) {
            ...
            for (local_78 = 0; local_78 < 8; local_78++) {
              if ((G.DAT_0064c6c0[local_78 * 4 + uVar8 * 0x594] & 8) !== 0 &&
                  ((1 << (local_78 & 0x1f) & u8(G.DAT_00655b0b)) !== 0 || local_110 < 0)) {
                local_110 = local_78;
              }
            }
            // Line 3975
            if ((local_c & 1) !== 0 || (local_c & 0x20) === 0) {
              ...
              for (local_134 = s8(G.DAT_006560fd[iVar11 * 0x20]) & 7;
                  local_134 < G.DAT_00655b18; local_134 = local_134 + 8) {
                if (ri32(G.DAT_0064f394, local_134 * 0x58) !== 0 &&
                    (local_78 = s8(G.DAT_0064f348[local_134 * 0x58]),
                     local_78 !== uVar8) &&
                    (G.DAT_0064c6c0[local_78 * 4 + uVar8 * 0x594] & 8) === 0 &&
                    ...
                    ((uVar8_to_u32(G.DAT_00655b0b) & (1 << (G.DAT_00655c31 & 0x1f))) === 0 ||
                     G.DAT_00655c31 === uVar8) &&
                    (iVar12 = FUN_005b8a81(rs16(G.DAT_0064f340, local_134 * 0x58), rs16(G.DAT_0064f342, local_134 * 0x58)),
                     local_1c !== iVar12)) {
                  if (local_3c === 0) {
          ...
          if (G.DAT_006560ff[iVar11 * 0x20] !== 0x0b && (local_c & 0x80) !== 0 &&
            ...
            for (local_168 = FUN_005b2d39(iVar11); iVar11 = local_98, local_168 >= 0;
              ...
              if (G.DAT_0064b1ca[u8(G.DAT_006560f6[local_168 * 0x20]) * 0x14] === 0x07 &&
                  G.DAT_00656100[local_168 * 0x20] !== 0xff) {
                local_44 = u8(G.DAT_00656100[local_168 * 0x20]);
              }
            }
            local_168 = local_98;
              ...
              if (ri32(G.DAT_0064f394, local_134 * 0x58) !== 0 &&
                ...
                if (iVar12 !== 0) {
                  ...
                  if ((uVar8_to_u32(G.DAT_00655b0b) & (1 << (G.DAT_0064f348[local_134 * 0x58] & 0x1f))) !== 0 &&
                      ...
                      s16(G.DAT_0064c708, local_78 * 0x594) > 4) {
                    local_70 = (local_70 / 2) | 0;
                  }
                  local_70 = s16(G.DAT_0064f35e, local_134 * 0x58) * local_70;
          ...
          // Line 4164
          if (G.DAT_006560ff[local_168 * 0x20] !== 0x0b &&
              G.DAT_0064b1c9[u8(G.DAT_006560f6[local_168 * 0x20]) * 0x14] !== 0) {
            ...
            if (iVar11 > 0 && iVar11 < 0x3f &&
                s16(G.DAT_00666132, iVar11 * 0x10) > 0x10 &&
          ...
          if (G.DAT_006560ff[local_168 * 0x20] !== 0x0b) {
            for (local_60 = 2; local_60 < 0x18; local_60++) {
              ...
              if (iVar11 !== 0 && local_74 > 1 &&
                  ...
                  (iVar11 = FUN_005b89e4(uVar9, local_74), iVar11 === 0) &&
                  (iVar11 = FUN_005b8a81(uVar9, local_74),
                   G.DAT_0064c932[uVar8 * 0x594 + iVar11] === 0)) {
                if (local_3c === 0) {
                  iVar11 = FUN_00442885(local_40, iVar11);
                } else {
                  iVar11 = FUN_005b9431(iVar11, iVar10);
      ...
      if (iVar11 <= u8(G.DAT_0064bcc8) && uVar15 >= 0 &&
      ...
      if (uVar20 === 9) {
        ...
        for (local_168 = 0; local_168 < G.DAT_00655b16; local_168++) {
          if (ri32(G.DAT_0065610a, local_168 * 0x20) !== 0 &&
              ...
              (local_78 = s8(G.DAT_006560f7[local_168 * 0x20]),
               local_78 !== uVar8 &&
          ...
          for (local_60 = 0; local_60 < 8; local_60++) {
            ...
            if (iVar11 !== 0) {
              ...
              if (iVar11 !== 0) {
                ...
                if (s8(G.DAT_00628360[local_60]) < 0) {
                  local_b8 = 1;
                }
                if (s8(G.DAT_00628360[local_60]) > 0) {
                  local_114 = 1;
                }
                if (s8(G.DAT_00628350[local_60]) < 0) {
                  local_28 = 1;
                }
                if (s8(G.DAT_00628350[local_60]) > 0) {
                  local_4c = 1;
      ...
      if (bVar23 && !bVar3 &&
        ...
        if ((1 << (bVar7 & 0x1f) & uVar8_to_u32(G.DAT_00655b0b)) === 0 ||
            ...
            (iVar11 = FUN_004087c0(rs16(G.DAT_00656102, local_168 * 0x20), rs16(G.DAT_00656104, local_168 * 0x20)), iVar11 === 0) ||
          ...
          if (local_3c > 2 || (G.DAT_0064f344[local_40 * 0x58] & 0x40) === 0 ||
            ...
            if (local_3c !== 0 && local_3c < 3 &&
                (((s8(G.DAT_00627cd2[local_80 * 0x18]) / 5) | 0) * 3 - 3 <= s8(G.DAT_0064f349[local_40 * 0x58]) ||
            ...
            if (local_170 !== 0) {
              ...
              if ((bVar6 & 0x10) === 0 || (bVar6 & 0x20) !== 0) {
                ...
                if (iVar11 !== 0) {
                  ...
                  if (s8(G.DAT_00627ccb[local_80 * 0x18]) > 1) {
                    local_170 = local_170 | 2;
                  }
                  if (local_170 !== 0) {
                    G.DAT_006560ff[local_168 * 0x20] = 5;
            ...
            if (G.DAT_006560ff[local_168 * 0x20] === 0x0b &&
                ...
                (iVar11 = (s8(G.DAT_006554f9[s16(G.DAT_0064c6a6, uVar8 * 0x594) * 0x30]) + 1) *
                           s16(G.DAT_00666132, iVar10 * 0x10),
                 iVar11 + u8(G.DAT_0064c932[uVar8 * 0x594 + iVar10]) * -0x10 !== 0 &&
            ...
            if (local_3c < 2) {
              for (local_60 = 0; local_60 < 8; local_60++) {
                local_7c = (((G.DAT_00655af8 << 16) >> 16) + local_60) & 7;
                ...
                if (iVar11 !== 0 &&
                  ...
                  bVar6 = FUN_005b89bb(uVar9, local_74);
                  local_cc = u8(bVar6);
                  if ((((s8(G.DAT_00627cd2[local_cc * 0x18]) / 5) | 0) * 3 - 3 <= s8(G.DAT_0064f349[uVar15 * 0x58]) ||
          ...
          for (local_60 = 0; local_60 < 0x14; local_60++) {
            ...
            if (iVar11 !== 0) {
              ...
              if ((mem_u8(iVar11 + 1) & 0xe) === 0) {
                if (G.DAT_00627cd5[uVar17 * 0x18] !== 0 &&
                    s8(G.DAT_00627cd5[uVar17 * 0x18]) < s8(G.DAT_00627cd4[uVar17 * 0x18])) {
                  FUN_00531607(local_168, 0x6d, uVar9, local_74);
                  flag_LAB_005436c1 = true;
                  break dowhile_0053be12;
                }
                if (G.DAT_00627cd4[uVar17 * 0x18] !== 0) {
    ...
    if (flag_LAB_00541001 && !flag_LAB_005436c1 && !flag_LAB_005435ca) {
      ...
      if (!flag_LAB_005435ca && !flag_LAB_005414d7) {
        if (bVar22 &&
            (s16(G.DAT_00666132, iVar10 * 0x10) >> 3) < s8(G.DAT_0064c932[uVar8 * 0x594 + iVar10]) &&
            G.DAT_00656100[local_168 * 0x20] !== 0xff) {
      ...
      if (local_54 < 0 &&
        ...
        if (local_5c > 0 && local_5c !== uVar8 &&
          ...
          if ((G.DAT_0064c6c0[local_5c * 4 + uVar8 * 0x594] & 4) !== 0 &&
              (u8(G.DAT_0064c6be[local_5c * 0x594]) - s8(G.DAT_0064c6e8[uVar8 * 0x594])) < 7 &&
              local_c4 === 0) {
