...
export function FUN_00552112(in_ECX) {
  ...
  if ((G.DAT_00654fa8 === 0) || (s32(in_ECX, 0x1e4) === 0)) {
    ...
    {
      // DEVIATION: C pointer — *(undefined1 *)(in_ECX + 0x1b8) = 0;
    }
      ...
      if (local_150 < 10) {
        // DEVIATION: C pointer — *(undefined1 *)(in_ECX + 0x1b8) = 0x30;
        __itoa(local_150,(char *)(in_ECX + 0x1b9),10);
      }
      else {
        __itoa(local_150,(char *)(in_ECX + 0x1b8),10);
      }
      // DEVIATION: C pointer — *(undefined1 *)(in_ECX + 0x1ba) = 0x3a;
      if (local_14c < 10) {
        if (local_14c < 0) {
          local_14c = 0;
        }
        // DEVIATION: C pointer — *(undefined1 *)(in_ECX + 0x1bb) = 0x30;
    ...
    __itoa(G.DAT_00654faa,(char *)(in_ECX + 0x1b8),10);
  }
  ...
  if (((s32(in_ECX, 0x1e4) === 0) || (G.DAT_00655b02 === 0)) || (G.DAT_006ad684 !== 0)) {
    if (((s32(in_ECX, 0x1e4) !== 0) && (G.DAT_00655b02 !== 0)) && (G.DAT_006ad684 !== 0)) {
      if ((1 << (G.DAT_006ad578 & 0x1f) & ((G.DAT_00655b0b) >>> 0)) === 0) {
        ...
        // DEVIATION: C pointer — if (*(char *)(in_ECX + 0x1b8) !== 0) {
      ...
      // DEVIATION: C pointer — else if (*(char *)(in_ECX + 0x1b8) !== 0) {
...
export function FUN_00552e5b(param_1) {
  ...
  if (s32(local_8, 0x2a8) !== 0) {
    // DEVIATION: C pointer — (**(code **)(local_8 + 0x2a8))(s32(local_8, 0x200 + (param_1 + -1000) * 0x1c));
  }
  return;
}
...
/* Library Function - Single Match
    // DEVIATION: MFC — public: virtual __thiscall COleCntrFrameWnd::~COleCntrFrameWnd(void)
   
   Library: Visual Studio 1998 Debug */

// DEVIATION: MFC — void __thiscall COleCntrFrameWnd::~COleCntrFrameWnd(COleCntrFrameWnd *this)
...
export function FUN_005534bc(in_ECX, param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9) {
  ...
  // DEVIATION: C pointer — *(undefined **)(in_ECX + 0x2d4) = G.DAT_006ab1a0;
  // DEVIATION: C pointer — *(undefined **)(in_ECX + 0x2cc) = G.DAT_006ab190;
  // DEVIATION: C pointer — *(undefined **)(in_ECX + 0x2d0) = G.DAT_006ab178;
  w32(in_ECX, 0x1e0, 0);
  w32(in_ECX, 0x1e4, 0);
...
export function FUN_00553db0(param_1) {
  ...
  __strupr(param_1);
  while ((param_1[0] !== 0 && (G.DAT_006335f8[param_1[0]] !== 0))) {
    param_1 = param_1 + 1;
  }
...
export function FUN_00554145(param_1) {
  ...
  FUN_0059db08(0x4000);
  local_8 = 0;
  // DEVIATION: MFC — CSocket::Create(local_304,0x633710,0x633704,(char *)0x1);
...
export function FUN_0055499f() {
  ...
  pbVar3 = (byte *)FUN_005b8931(G.DAT_0064b1b4,G.DAT_0064b1b0);
  bVar1 = FUN_005b89bb(G.DAT_0064b1b4,G.DAT_0064b1b0);
  uVar6 = ((bVar1) >>> 0);
  local_20 = uVar6;
  iVar2 = FUN_005b89e4(G.DAT_0064b1b4,G.DAT_0064b1b0);
  if (iVar2 === 0) {
    // DEVIATION: MFC — CSocket::Create(local_314,0x633794,0x633788,(char *)0x1);
    uVar7 = 0;
    uVar4 = local_20;
  ...
  FUN_0059db65();
  FUN_0059d5f5();
  // DEVIATION: MFC — CSocket::Create(local_314,0x6337b8,0x6337ac,(char *)0x1);
...
export function FUN_005551b3() {
  ...
  while( true ) {
    // DEVIATION: MFC — CSocket::Create(local_304,0x6337cc,0x6337c0,(char *)0x1);
...
export function FUN_0055560f() {
  ...
  FUN_0059db08(0x4000);
  local_8 = 0;
  // DEVIATION: MFC — CSocket::Create(local_304,0x6337e0,0x6337d4,(char *)0x1);
...
export function FUN_0055583f() {
  ...
  FUN_0059db08(0x4000);
  local_8 = 0;
  // DEVIATION: MFC — CSocket::Create(local_304,0x6337f4,0x6337e8,(char *)0x1);
...
export function FUN_00555a8b() {
  ...
  FUN_0059db08(0x4000);
  local_8 = 0;
  // DEVIATION: MFC — CSocket::Create(local_304,0x633810,0x633808,(char *)0x1);
...
export function FUN_00555d70() {
  ...
  for (local_20 = 0; local_20 < 0x40; local_20 = local_20 + 1) {
    ...
    // DEVIATION: MFC — _Timevec::~_Timevec((_Timevec *)G.DAT_006aa864);
    local_1c = local_1c + extraout_EAX;
    // DEVIATION: MFC — pCVar3 = CRichEditCntrItem::GetActiveView((CRichEditCntrItem *)G.DAT_0066c7a8);
  ...
  while( true ) {
    while( true ) {
      while( true ) {
                      ...
                      while( true ) {
                        while( true ) {
                          ...
                          if (-1 < local_1c) {
                            ...
                            FUN_0051d7bc();
                            // DEVIATION: C pointer — FUN_0051d7d6(0,*(uint *)(G.DAT_0064c6c0 +
                                                          // DEVIATION(cont): iVar1 * 0x594 + local_1c * 4) & 1);
                            // DEVIATION: C pointer — FUN_0051d7d6(1,(*(uint *)(G.DAT_0064c6c0 +
                                                           // DEVIATION(cont): iVar1 * 0x594 + local_1c * 4) & 2) >> 1);
                            // DEVIATION: C pointer — FUN_0051d7d6(2,(*(uint *)(G.DAT_0064c6c0 +
                                                           // DEVIATION(cont): iVar1 * 0x594 + local_1c * 4) & 4) >> 2);
                            // DEVIATION: C pointer — FUN_0051d7d6(3,(*(uint *)(G.DAT_0064c6c0 +
                                                           // DEVIATION(cont): iVar1 * 0x594 + local_1c * 4) & 8) >> 3);
                            // DEVIATION: C pointer — FUN_0051d7d6(4,(*(uint *)(G.DAT_0064c6c0 +
                                                           // DEVIATION(cont): iVar1 * 0x594 + local_1c * 4) & 0x2000)
                                                 // DEVIATION(cont): >> 0xd);
                            // DEVIATION: C pointer — FUN_0051d7d6(5,(*(uint *)(G.DAT_0064c6c0 +
                                                           // DEVIATION(cont): iVar1 * 0x594 + local_1c * 4) & 0x10) >>
                                                 // DEVIATION(cont): 4);
                            // DEVIATION: C pointer — FUN_0051d7d6(6,(*(uint *)(G.DAT_0064c6c0 +
                        ...
                        if (-1 < local_1c) {
                          ...
                          iVar3 = FUN_00518ec0(s_LASTCONTACT_006338ac,
                                                     // DEVIATION: C pointer — (int)*(short *)(G.DAT_0064ca82 +
        ...
        FUN_0040bbe0(uVar2);
        FUN_0040ff60(0,G.DAT_00679640);
        // DEVIATION: C pointer — if (-1 < s16(G.DAT_00655502, s16(G.DAT_0064c6a6, iVar1 * 0x594) * 0x30)) {
          // DEVIATION(cont): uVar2 = thunk_FUN_00428b0c((int)*(short *)(&G.DAT_00655502 +
                                                    // DEVIATION(cont): *(short *)(&G.DAT_0064c6a6 + iVar1 * 0x594) * 0x30
                                                    // DEVIATION(cont): ));
          FUN_005f22d0(G.DAT_0064bcfa + iVar1 * 0xf2,uVar2);
          // DEVIATION: C pointer — s16(G.DAT_00655502, s16(G.DAT_0064c6a6, iVar1 * 0x594) * 0x30) =
               // DEVIATION(cont): -*(short *)(&G.DAT_00655502 + *(short *)(&G.DAT_0064c6a6 + iVar1 * 0x594) * 0x30);
        }
        // DEVIATION: C pointer — if (-1 < s16(G.DAT_00655504, s16(G.DAT_0064c6a6, iVar1 * 0x594) * 0x30)) {
          // DEVIATION(cont): uVar2 = thunk_FUN_00428b0c((int)*(short *)(&G.DAT_00655504 +
                                                    // DEVIATION(cont): *(short *)(&G.DAT_0064c6a6 + iVar1 * 0x594) * 0x30
                                                    // DEVIATION(cont): ));
          FUN_005f22d0(G.DAT_0064bd12 + iVar1 * 0xf2,uVar2);
          // DEVIATION: C pointer — s16(G.DAT_00655504, s16(G.DAT_0064c6a6, iVar1 * 0x594) * 0x30) =
               // DEVIATION(cont): -*(short *)(&G.DAT_00655504 + *(short *)(&G.DAT_0064c6a6 + iVar1 * 0x594) * 0x30);
        }
        // DEVIATION: C pointer — if (-1 < s16(G.DAT_00655506, s16(G.DAT_0064c6a6, iVar1 * 0x594) * 0x30)) {
          // DEVIATION(cont): uVar2 = thunk_FUN_00428b0c((int)*(short *)(&G.DAT_00655506 +
                                                    // DEVIATION(cont): *(short *)(&G.DAT_0064c6a6 + iVar1 * 0x594) * 0x30
                                                    // DEVIATION(cont): ));
          FUN_005f22d0(G.DAT_0064bd2a + iVar1 * 0xf2,uVar2);
          // DEVIATION: C pointer — s16(G.DAT_00655506, s16(G.DAT_0064c6a6, iVar1 * 0x594) * 0x30) =
...
export function FUN_00557e2c() {
  ...
  while( true ) {
    ...
    if (iVar1 === 1) {
      ...
      iVar3 = FUN_00518ec0(s_EDITVICTORYOBJ_00633908,((G.DAT_0064bcb4) << 16 >> 16)[iVar1],
                                 local_1c);
      if (iVar3 === 0) {
  ...
  while( true ) {
    ...
    if (iVar2 === 1) {
      ...
      for (local_8 = 0; local_8 < G.DAT_006d1164; local_8 = local_8 + 1) {
        // DEVIATION: C pointer — if ((*(byte *)(local_10 + 5) & 0xf0) === 0xf0) {
      ...
      local_10 = G.DAT_00636598;
      for (local_8 = 0; local_8 < G.DAT_006d1164; local_8 = local_8 + 1) {
        // DEVIATION: C pointer — if (((*(byte *)(local_10 + 5) & 0xf0) !== 0xf0) && ((*(byte *)(local_10 + 1) & 3) === 0)) {
      ...
      for (local_8 = 0; local_8 < G.DAT_006d1164; local_8 = local_8 + 1) {
        // DEVIATION: C pointer — *(undefined1 *)(local_34 + 4) = 0xff;
        for (local_140 = 1; local_140 < 8; local_140 = local_140 + 1) {
          // DEVIATION: C pointer — *(undefined1 *)aiStack_30[local_140] = *(undefined1 *)(local_34 + 1);
      ...
      for (local_13c = 0; local_13c < G.DAT_00655b18; local_13c = local_13c + 1) {
        if (s32(G.DAT_0064f394, local_13c * 0x58) !== 0) {
          ...
          // DEVIATION: C pointer — *(undefined1 *)(iVar2 + 4) = 0xff;
        }
      }
...
export function FUN_00559c71() {
  ...
  // DEVIATION: MFC — CMiniFrameWnd::~CMiniFrameWnd((CMiniFrameWnd *)G.DAT_006ab1b8);
  return;
}
...
/* Library Function - Single Match
    // DEVIATION: MFC — public: virtual __thiscall CMiniFrameWnd::~CMiniFrameWnd(void)
   
   Library: Visual Studio 1998 Debug */

// DEVIATION: MFC — void __thiscall CMiniFrameWnd::~CMiniFrameWnd(CMiniFrameWnd *this)
...
export function FUN_00559f30(unaff_EBP) {
  ...
  // DEVIATION: MFC — _Timevec::~_Timevec((_Timevec *)(s32(unaff_EBP, -0x10) + 0x2f8));
  return;
}
...
export function FUN_00559f60(in_ECX, param_1) {
  ...
  FUN_005a9afe(G.DAT_006ab4b8,in_ECX,param_1[0] - s32(in_ECX, 0x124),
                     param_1[1] - s32(in_ECX, 0x128),param_1[0],param_1[1],uVar1);
  return;
}
        ...
        if (-1 < local_18) {
          for (local_44 = 0; local_44 < 4; local_44 = local_44 + 1) {
            ...
            if ((((iVar1 !== 0) &&
              ...
              // DEVIATION: C pointer — *(byte *)(G.DAT_006d116a * local_20 + local_34 + local_8) =
              ...
              if (((-1 < local_10) && (-1 < local_14)) &&
                ...
                // DEVIATION: C pointer — *(byte *)(G.DAT_006d116a * local_14 + local_10 + local_8) =
...
export function FUN_0055b47e() {
  ...
  G.DAT_006ab5b4 = SetWindowsHookExA(7,(HOOKPROC)0 /* ADDR:LAB_00402856 */,G.DAT_006e4ff0,0);
  return;
}
...
export function FUN_0055c3d3(param_1, param_2) {
  ...
  if ((2 < G.DAT_00655b02) && (G.DAT_006d1da0 !== param_1)) {
    // DEVIATION: C pointer — FUN_0046b14d(0x9f,*(undefined4 *)
      ...
      if (2 < G.DAT_00655b02) {
        for (local_c = 1; local_c < 8; local_c = local_c + 1) {
          if ((((1 << (u8(local_c) & 0x1f) & ((G.DAT_00655b0b) >>> 0)) !== 0) &&
            ...
            if (((u16(G.DAT_0064c6a0, param_1 * 0x594) & 1) === 0) || (G.DAT_00654fa8 !== 0)) {
              // DEVIATION: C pointer — FUN_00511880(0x2c,*(undefined4 *)
              ...
              // DEVIATION: C pointer — FUN_00511880(0x2b,*(undefined4 *)
                                       // DEVIATION(cont): (&G.DAT_006ad30c + *(int *)(&G.DAT_006ad558 + local_c * 4) * 0x54
...
export function FUN_0055d8d8(param_1, param_2, param_3, param_4) {
  ...
  if (((G.DAT_00655b02 === 0) || ((1 << (u8(param_1) & 0x1f) & ((G.DAT_00655b0b) >>> 0)) === 0)) ||
    ...
    if ((((2 < G.DAT_00655b02) && ((1 << (u8(param_1) & 0x1f) & ((G.DAT_00655b0b) >>> 0)) !== 0)) &&
      ...
      // DEVIATION: C pointer — FUN_0046b14d(0x99,*(undefined4 *)
                ...
                if (((-1 < iVar5) &&
                  ...
                  if (((1 << (u8(local_2c) & 0x1f) & ((G.DAT_00655b0b) >>> 0)) !== 0) &&
                    ...
                    if (G.DAT_006d1da0 === local_2c) {
                      ...
                      // DEVIATION: C pointer — FUN_00511880(0x51,*(undefined4 *)
                  ...
                  if (((1 << (u8(local_10) & 0x1f) & ((G.DAT_00655b0b) >>> 0)) !== 0) &&
                    ...
                    if (G.DAT_006d1da0 === local_10) {
                      ...
                      // DEVIATION: C pointer — FUN_00511880(0x52,*(undefined4 *)
                                               // DEVIATION(cont): (&G.DAT_006ad30c +
