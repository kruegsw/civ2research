...
import { FUN_0043c460, FUN_0043cc00, FUN_0043cf76 } from './block_00430000.js';
import { FUN_00442541, FUN_00444270, FUN_004442a0, FUN_004442e0 } from './block_00440000.js';
import { FUN_00453e51, FUN_00456f20, FUN_0045705e, FUN_00458a3b, FUN_0045ac71 } from './block_00450000.js';
...
import { FUN_005b29d7, FUN_005b2a39, FUN_005b2c3d, FUN_005b2c82, FUN_005b2d39, FUN_005b36df } from './block_005B0000.js';
import { FUN_005b3ae0, FUN_005b4391, FUN_005b48b1, FUN_005b490e, FUN_005b4b66, FUN_005b50ad } from './block_005B0000.js';
import { FUN_005b5bab, FUN_005b6042, FUN_005b6787, FUN_005b8a81, FUN_005b8b1a, FUN_005b8d15 } from './block_005B0000.js';
import { FUN_005b8d62, FUN_005b94fc, FUN_005b9646, FUN_005b976d, FUN_005b99e8, FUN_005b9ec6 } from './block_005B0000.js';
import { FUN_005b9f1c, FUN_005baeb0, FUN_005baec8, FUN_005baee0, FUN_005bb4ae, FUN_005bb574 } from './block_005B0000.js';
import { FUN_005bd270 } from './block_005B0000.js';
      ...
      if (aiStack_334[1] === 0) {
        ...
        for (local_31c = 0; local_31c < 100; local_31c = local_31c + 1) {
          if (((G.DAT_00627689[local_31c * 0x10] !== 0) &&
             ...
             ((param_2 === 0 ||
              ((G.DAT_0064c6aa[param_1 * 0x2CA] !== local_31c &&
        ...
        for (local_30c = 0; local_30c < 0x3e; local_30c = local_30c + 1) {
          ...
          if (((-1 < local_31c) && (iVar2 = FUN_004bd9f0(param_1, local_31c), iVar2 === 0)) &&
             ((param_2 === 0 || (G.DAT_0064c6aa[param_1 * 0x2CA] !== local_31c)))) {
            FUN_0040bbb0();
...
export function FUN_004c195e(param_1, param_2) {
  ...
  local_604 = iVar1;
  G.DAT_0064c6aa[param_1 * 0x2CA] = local_604;
  FUN_004c217c();
  FUN_004c2188();
  FUN_004c219e();
}
...
export function FUN_004c21d5(param_1, param_2) {
  ...
  FUN_0059db08(0x4000);
  sVar1 = G.DAT_0064c6aa[param_1 * 0x2CA];
  if (G.DAT_0064c6aa[param_1 * 0x2CA] < 0) {
  ...
  if (G.DAT_0062db00 !== 2) {
    G.DAT_0064c6a8[param_1 * 0x2CA] = 0;
  }
  G.DAT_0064c6aa[param_1 * 0x2CA] = -1;
  ...
  if ((G.DAT_00655af8 !== 0) && ((1 << (u8(param_1) & 0x1f) & G.DAT_00655b0b) !== 0)) {
    if ((G.DAT_006d1da0 === param_1) && (G.DAT_00654fa8 === 0)) {
      ...
      if ((((local_30c === 0x3c) && ((G.DAT_0064c6a0[param_1 * 0x2CA] & 0x20) !== 0)) &&
...
export function FUN_004c42a0(param_1, param_2) {
  ...
  iVar5 = G.DAT_006560f0[param_1 * 0x10];
  iVar6 = G.DAT_006560f2[param_1 * 0x10];
...
export function FUN_004c4ada(param_1) {
  ...
  if (((G.DAT_00655b0b & (1 << (G.DAT_006560f7[param_1 * 0x20] & 0x1f))) === 0) &&
    ...
    iVar2 = FUN_0043cf76(G.DAT_006560f0[param_1 * 0x10],
                               G.DAT_006560f2[param_1 * 0x10]);
    if (iVar2 < 0) {
      bVar1 = FUN_005b94d5(G.DAT_006560f0[param_1 * 0x10],
                                 G.DAT_006560f2[param_1 * 0x10]);
      if ((((bVar1 & 0x42) === 0x40) &&
          (iVar2 = FUN_0043d07a(G.DAT_006560f0[param_1 * 0x10],
                                      G.DAT_006560f2[param_1 * 0x10],
  ...
  FUN_0047cea6(G.DAT_006560f0[param_1 * 0x10],
                     G.DAT_006560f2[param_1 * 0x10]);
...
export function FUN_004c4d1e(param_1, param_2, param_3) {
  ...
  iVar1 = G.DAT_006560f0[param_1 * 0x10];
  iVar2 = G.DAT_006560f2[param_1 * 0x10];
...
export function FUN_004c4e6d(param_1) {
  ...
  if ((iVar3 < 0) || (iVar3 === 8)) {
    ...
    G.DAT_006560f4[param_1 * 0x10] =
         G.DAT_006560f4[param_1 * 0x10] & 0xff7f;
    if (((G.DAT_006560f0[param_1 * 0x10] === G.DAT_00656102[param_1 * 0x10])
        && (G.DAT_006560f2[param_1 * 0x10] === G.DAT_00656104[param_1 * 0x10]
           )) && ((bVar2 & 0x10) === 0)) {
      G.DAT_006560ff[param_1 * 0x20] = 0xff;
      G.DAT_006560f4[param_1 * 0x10] =
           G.DAT_006560f4[param_1 * 0x10] | 0x80;
      if (((1 << (bVar1 & 0x1f) & G.DAT_00655b0b) === 0) &&
         (((s8(G.DAT_0064b1c1[u8(G.DAT_006560f6[param_1 * 0x20]) * 0x14]) === 2 ||
           ((s8(G.DAT_006560fe[param_1 * 0x20]) > 9 &&
            (iVar3 = FUN_005b4b66(G.DAT_006560f0[param_1 * 0x10],
                                        G.DAT_006560f2[param_1 * 0x10],
                                        s8(bVar1)), iVar3 === 0)))) &&
          (FUN_005b6787(param_1),
          s8(G.DAT_0064b1ca[u8(G.DAT_006560f6[param_1 * 0x20]) * 0x14]) === 4)))) {
...
export function FUN_004c50d0(param_1, param_2) {
  ...
  iVar2 = G.DAT_006560f0[param_1 * 0x10];
  iVar3 = G.DAT_006560f2[param_1 * 0x10];
  bVar1 = G.DAT_006560f7[param_1 * 0x20];
...
export function FUN_004c54da(param_1) {
  ...
  iVar6 = G.DAT_006560f0[param_1 * 0x10];
  iVar7 = G.DAT_006560f2[param_1 * 0x10];
  ...
  for (local_30 = 0; local_30 < G.DAT_00655b18; local_30 = local_30 + 1) {
    if ((((G.DAT_0064f394[local_30 * 0x16] !== 0) &&
         (G.DAT_0064f348[local_30 * 0x58] === bVar2)) &&
        ((local_20 < 0 ||
         (iVar8 = FUN_005b8a81(G.DAT_0064f340[local_30 * 0x2C],
                                     G.DAT_0064f342[local_30 * 0x2C]),
         iVar8 === local_20)))) &&
       (iVar8 = FUN_005ae1b0(iVar6, iVar7, G.DAT_0064f340[local_30 * 0x2C],
                                   G.DAT_0064f342[local_30 * 0x2C]),
    ...
    for (param_1 = 0; param_1 < G.DAT_00655b16; param_1 = param_1 + 1) {
      if (((G.DAT_0065610a[param_1 * 8] !== 0) &&
         ...
         ((((G.DAT_0064b1bc[u8(G.DAT_006560f6[param_1 * 0x20]) * 0x14] & 0x80) !== 0 ||
          ...
          (iVar8 = FUN_005ae1b0(iVar6, iVar7, G.DAT_006560f0[param_1 * 0x10],
                                      G.DAT_006560f2[param_1 * 0x10]),
          iVar8 < local_8)))) {
        local_38 = G.DAT_006560f0[param_1 * 0x10];
        local_40 = G.DAT_006560f2[param_1 * 0x10];
        local_8 = iVar8;
      }
    }
  ...
  if (G.DAT_0063f660 < 999) {
    local_34 = G.DAT_0064f340[local_14 * 0x2C];
    local_3c = G.DAT_0064f342[local_14 * 0x2C];
  ...
  if (local_c < 999) {
    ...
    if ((iVar6 === local_34) && (iVar7 === local_3c)) {
      ...
      G.DAT_00656102[iVar5 * 0x10] = local_34;
      G.DAT_00656104[iVar5 * 0x10] = local_3c;
    }
  }
}
        ...
        if ((G.DAT_00655b02 < 3) || (G.DAT_006d1da0 === param_2)) {
          if ((G.DAT_0064c6c0[param_1 * 4 + param_2 * 0x594] & 8) === 0) {
            ...
            if (iVar2 === 1) {
              ...
              G.DAT_0064ca82[param_1 * 2 + param_2 * 0x2CA] = G.DAT_00655af8;
            }
          }
          else {
...
export function FUN_004c5fae(param_1, param_2, param_3) {
  ...
  if (s8(G.DAT_006560f6[param_1 * 0x20]) === 0x2f) {
    ...
    if ((G.DAT_006560f4[param_1 * 0x10] & 0x2000) !== 0) {
      local_8 = local_8 * 2;
    }
    if (0 < param_2) {
      local_8 = (local_8 / 2) | 0;
    ...
    if (local_1c !== 0) {
      iVar4 = G.DAT_006560f0[param_1 * 0x10];
      iVar5 = G.DAT_006560f2[param_1 * 0x10];
      iVar6 = FUN_0043d07a(iVar4, iVar5, iVar2, 0xffffffff, 0xffffffff);
      if (-1 < iVar6) {
        FUN_005b36df(param_1, G.DAT_0064f340[iVar6 * 0x2C],
                           G.DAT_0064f342[iVar6 * 0x2C], 1);
        FUN_005b6787(param_1);
        FUN_0047cea6(iVar4, iVar5);
        FUN_0047cea6(G.DAT_0064f340[iVar6 * 0x2C],
                           G.DAT_0064f342[iVar6 * 0x2C]);
        if (2 < G.DAT_00655b02) {
          FUN_004b0b53(0xff, 2, 0, 0, 0);
          FUN_0046b14d(0x72, 0xff, iVar4, iVar5, 0, 0, 0, 0, 0, 0);
          FUN_0046b14d(0x72, 0xff, G.DAT_0064f340[iVar6 * 0x2C],
                             G.DAT_0064f342[iVar6 * 0x2C], 0, 0, 0, 0, 0, 0);
        }
      ...
      if (-1 < param_2) {
        ...
        G.DAT_006560f4[param_1 * 0x10] =
             G.DAT_006560f4[param_1 * 0x10] | 0x2000;
      }
      return 0;
    }
...
export function FUN_004c65d2(param_1, param_2, param_3) {
  ...
  for (local_c = 0; local_c < G.DAT_00655b18; local_c = local_c + 1) {
    if ((((G.DAT_0064f394[local_c * 0x16] !== 0) &&
         (s8(G.DAT_0064f348[local_c * 0x58]) === param_1)) &&
        (iVar1 = FUN_0043d20a(local_c, 1), iVar1 !== 0)) &&
       (iVar1 = FUN_005ae31d(G.DAT_0064f340[local_c * 0x2C],
                                   G.DAT_0064f342[local_c * 0x2C], param_2, param_3),
       iVar1 < local_8)) {
      local_8 = iVar1;
    }
  }
...
export function FUN_004c66ba(param_1, param_2, param_3) {
  ...
  let iVar4 = s8(bVar1);
  let sVar2 = G.DAT_0064f340[param_1 * 0x2C];
  let sVar3 = G.DAT_0064f342[param_1 * 0x2C];
  let local_20;
  let local_8;
  let iVar6, iVar7;
  ...
  if (-1 < param_2) {
    ...
    while (local_20 = local_20 + -1, -1 < local_20) {
      if (((G.DAT_0065610a[local_20 * 8] !== 0) &&
         ...
         ((iVar6 = FUN_005ae31d(G.DAT_006560f0[local_20 * 0x10],
                                      G.DAT_006560f2[local_20 * 0x10], sVar2,
                                      sVar3), iVar6 < 2 &&
          ((iVar6 === 0 ||
           (iVar7 = FUN_005b8ca6(G.DAT_006560f0[local_20 * 0x10],
                                       G.DAT_006560f2[local_20 * 0x10]), iVar7 < 0)
           ))))) {
        ...
        FUN_005b99e8(G.DAT_006560f0[local_20 * 0x10],
                           G.DAT_006560f2[local_20 * 0x10], param_2, 1);
        if (iVar6 !== 0) {
          FUN_0047cea6(G.DAT_006560f0[local_20 * 0x10],
                             G.DAT_006560f2[local_20 * 0x10]);
        }
      }
    }
...
export function FUN_004c6bf5(param_1, param_2) {
  // This is a very large function (10,469 bytes) handling spy missions
  // against cities: embassy, investigate, steal tech, sabotage,
  // poison water supply, plant nuclear device, incite revolt,
  // counter-intelligence. Due to its enormous size and heavy UI
  // dependency, it is stubbed here with the essential game state
  // mutations preserved as comments.
  //
  // Key game logic:
  // - Sets G.DAT_0062dcf4 = local_3ac (mission type)
  // - Modifies diplomacy state (G.DAT_0064c6c0 flags)
  // - Calls FUN_004c5fae for spy survival checks
  // - Calls handle_incident_terror for diplomatic incidents
  // - Calls FUN_004c66ba for incite revolt / civil war
  // - Modifies city buildings via FUN_0043d289
  // - Modifies treasury via G.DAT_0064c6a2
  // - Modifies unit state (G.DAT_006560f4/f7/f8/fd/fe/ff)
  //
  // Full transpilation omitted due to extreme length and UI dominance.
  // See source: reverse_engineering/decompiled/block_004C0000.c line 2123
  G.DAT_0062804c = 0;
}
...
export function pick_up_unit_004c9528(param_1, param_2) {
  ...
  if ((G.DAT_00654fa8 === 0) && ((1 << (u8(param_2) & 0x1f) & G.DAT_00655b0b) !== 0)) {
    ...
    if (G.DAT_006d1da0 === param_2) {
      if (local_18 <= G.DAT_0064c6a2[param_2 * 0x165]) {
        FUN_0040bbe0(0);
      }
      ...
      if (G.DAT_00655b02 < 3) {
        ...
        if (G.DAT_0064c6a2[param_2 * 0x165] < local_18) {
  ...
  else if (G.DAT_0064c6a2[param_2 * 0x165] / 2 < local_18) {
    return;
  }

  // LAB_004c99a0
  if ((G.DAT_00655b02 < 3) || (G.DAT_006ad2f7 !== 0)) {
    G.DAT_0064c6a2[param_2 * 0x165] = G.DAT_0064c6a2[param_2 * 0x165] - local_18;
    ...
    G.DAT_0064c6bc[param_2 * 0x2CA] = G.DAT_0064c6bc[param_2 * 0x2CA] + 1;
    G.DAT_006560f7[param_1 * 0x20] = param_2;
    G.DAT_00656100[param_1 * 0x20] = 0xff;
    G.DAT_006560f8[param_1 * 0x20] = 0;
    G.DAT_006560ff[param_1 * 0x20] = 0xff;
    iVar3 = FUN_0043d07a(G.DAT_006560f0[param_1 * 0x10],
                               G.DAT_006560f2[param_1 * 0x10], 0xffffffff, 0xffffffff,
                               0xffffffff);
    ...
    FUN_005b99e8(G.DAT_006560f0[param_1 * 0x10],
                       G.DAT_006560f2[param_1 * 0x10], param_2, 1);
  ...
  if ((G.DAT_00654fa8 === 0) && ((1 << (bVar1 & 0x1f) & G.DAT_00655b0b) !== 0)) {
    ...
    if (G.DAT_006d1da0 === iVar2) {
      FUN_004105f8(G.DAT_006560f0[param_1 * 0x10],
                         G.DAT_006560f2[param_1 * 0x10], iVar2);
      FUN_004442e0(0 /*s_DESERTED*/, param_1);
    }
    else if ((2 < G.DAT_00655b02) && (G.DAT_006d1da0 !== iVar2)) {
      FUN_004b0b53(0xff, 2, 0, 0, 0);
      FUN_0046b14d(0x71, 0, G.DAT_006560f0[param_1 * 0x10],
                         G.DAT_006560f2[param_1 * 0x10], iVar2, 0, 0, 0, 0, 0);
  ...
  if (2 < G.DAT_00655b02) {
    FUN_004b0b53(0xff, 2, 0, 0, 0);
    FUN_0046b14d(0x72, 0xff, G.DAT_006560f0[param_1 * 0x10],
                       G.DAT_006560f2[param_1 * 0x10], 0, 0, 0, 0, 0, 0);
  }
  ...
  if (iVar1 < 2) {
    if ((((1 << (u8(param_3) & 0x1f) & G.DAT_00655b0b) === 0) ||
      ...
      if (iVar1 < 0) { return 0; }
        ...
        let iX = G.DAT_006560f0[param_2 * 0x10];
        let iY = G.DAT_006560f2[param_2 * 0x10];
...
export function FUN_004ca1cd(param_1, param_2, param_3, param_4, param_5) {
  ...
  G.DAT_0064f344[param_2 * 0x58] = G.DAT_0064f344[param_2 * 0x58] | 0x01; // bit in uint
  G.DAT_0064f344[param_3 * 0x58] = G.DAT_0064f344[param_3 * 0x58] | 0x01;
  FUN_005b6787(param_1);
  G.DAT_006560ff[param_1 * 0x20] = 0xff;
  FUN_005b36df(param_1, G.DAT_0064f340[param_3 * 0x2C],
                     G.DAT_0064f342[param_3 * 0x2C], 1);
...
export function FUN_004ca39e(param_1, param_2, param_3) {
  // Large paradrop function — UI heavy.
  // Key game logic: sets paradrop range, checks terrain/ocean,
  // moves unit, triggers combat if enemy present.
  // See source: reverse_engineering/decompiled/block_004C0000.c line 3221
  let bVar1 = G.DAT_006560f7[param_1 * 0x20];
  FUN_004c4210(0, G.DAT_0064bcdb);
  let iVar5 = FUN_005b89e4(param_2, param_3);
  if (iVar5 === 0) {
    // Non-ocean landing logic
    // Full implementation follows C source closely
  }
}
...
export function FUN_004ccb6a(param_1, param_2, param_3, param_4, param_5, param_6) {
  // UI drawing function — border frame rendering
  // Pure Win32 GDI — no-op in JS
}
...
export function FUN_004ccdb6(param_1) {
  // _sprintf + FUN_005f22e0 — string formatting
}
...
export function FUN_004cdd3d(param_1, param_2, param_3, param_4) {
  // UI dialog with checkboxes — no-op in JS
}
...
export function FUN_004ce322() {
  // MFC window initialization — UI, no-op
}
...
export function FUN_004ce98e(param_1, param_2) {
  // Deep copy of dialog template string pointers — UI, stub
}
...
export function FUN_004cff70(param_1) {
  // FUN_005bd270 call with ECX register — MFC, no-op
}
