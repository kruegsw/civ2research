...
export const WONDER_STATS = {
  ...
  gold:       { charCode: 0x22, source: 'DAT_0064caae', suffix: ',000' },
  approval:   { charCode: 0xCE, source: 'DAT_006ad0f0' },
  population: { charCode: 0xCB, source: 'DAT_006ad0e8' },
  gnp:        { charCode: 0xC8, source: 'DAT_006ad0dc' },
  literacy:   { charCode: 0xCF, source: 'DAT_006ad0f4', format: 'div10.mod10' },
  landArea:   { charCode: 0xD1, source: 'implied', format: 'div10.mod10' },
