...
let DAT_00637e5c = null;    // PTR_DAT_00637e5c — current font pointer
...
let DAT_00637eb0 = [];      // modal dialog stack (16 entries)
...
let DAT_006e47c8 = null;    // active scale table pointer
let DAT_006e47c0 = null;    // active blit scale table X
let DAT_006e47c4 = null;    // active blit scale table Y
let DAT_006d4700 = [];      // scale table cache — numerators
let DAT_006d4704 = [];      // scale table cache — denominators
let DAT_006d4708 = [];      // scale table cache — timestamps
...
export function FUN_005cda06(param_1, param_2) {
  if (param_1) param_1[0] = DAT_00637f98;
  if (param_2) param_2[0] = DAT_00637f9c;
}
