...
export function FUN_00501819(param_1) {
  ...
  if ((s8(DAT_0064f348[iVar1 * 0x58]) === DAT_006d1da0) || (DAT_00655b07 !== 0)) {
    ...
    // DEVIATION: MFC — CSplitterWnd::IsTracking(DAT_006a91b8);
    // DEVIATION: MFC — iVar1 = CSplitterWnd::IsTracking(DAT_006a91b8);
...
export function FUN_005025d5(in_ECX, param_1) {
  ...
  if ((((s32(in_ECX, 0x15a4) === 0) && (s32(in_ECX, 0x15a0) === 0)) &&
    ...
    for (local_3c = 0; local_3c < 0x15; local_3c = local_3c + 1) {
      // DEVIATION(C-syntax): true)) // DEVIATION: C pointer — local_fc = FUN_005ae052((int)*(short *)(DAT_0064f340 + s32(in_ECX, 0x159c) * 0x58
                                                   // DEVIATION(cont): ) + (int)(char)(&DAT_00630d38)[local_3c]);
      true // DEVIATION: C pointer — local_4c = s16(DAT_0064f342, s32(in_ECX, 0x159c) * 0x58) +
...
export function FUN_00504c05(in_ECX, param_1) {
  ...
  if ((((s32(in_ECX, 0x15a4) === 0) && (s32(in_ECX, 0x15a0) === 0)) &&
    ...
    iVar5 = local_14[0];
    local_1c = 0;
    true // DEVIATION: C pointer — local_24 = s16(DAT_0064f35a, s32(in_ECX, 0x159c) * 0x58);
    local_2c = local_10;
    FUN_0047df20(s32(in_ECX, 0x15d4) * 4 + -8);
...
export function FUN_0050503e(in_ECX, param_1) {
  ...
  if ((((s32(in_ECX, 0x15a4) === 0) && (s32(in_ECX, 0x15a0) === 0)) &&
    ...
    if (DAT_0064f379[s32(in_ECX, 0x159c) * 0x58] !== -0x26) {
      ...
      local_1c = 0;
      true // DEVIATION: C pointer — local_24 = ((s16(DAT_0064f35c, s32(in_ECX, 0x159c) * 0x58)) >>> 0);
      local_28 = local_14[0];
      local_30 = local_10;
      FUN_0047df20(s32(in_ECX, 0x15d4) * 4 + -8);
...
export function citywin_70E5_005070E5(in_ECX) {
  ...
  local_3c = local_50 << 2;
  FUN_0046ac89(3);
  true) // DEVIATION: C pointer — local_78 = FUN_005b2e69(s16(DAT_0064f340, s32(in_ECX, 0x159c) * 0x58),
  ...
  if (local_5c <= local_50) {
    ...
    iVar1 = FUN_00511690(1);
    FUN_0043c910(DAT_00679640,s32(in_ECX, 0x168c),
  ...
  for (local_30 = 0; local_30 < s8(DAT_0064f37a[s32(in_ECX, 0x159c) * 0x58]);
    ...
    FUN_0040bbe0(DAT_0064f360 +
                       true // DEVIATION: C pointer — s16(DAT_0064f384, s32(in_ECX, 0x159c) * 0x58 + local_30 * 2) *
                       // DEVIATION(cont): 0x58);
    FUN_0040fe10();
...
export function citywin_7B69_00507B69(in_ECX) {
  ...
  for (local_34 = 0; local_34 < DAT_00655b16; local_34 = local_34 + 1) {
    if ((s32(DAT_0065610a, local_34 * 0x20) !== 0) &&
       (u8(DAT_00656100[local_34 * 0x20]) === u32(in_ECX, 0x159c))) {
      iVar6 = FUN_005ae052(s16(DAT_006560f0, local_34 * 0x20) - local_8);
      FUN_00408780(iVar6 * iVar5 + iVar3,
                         s16(DAT_006560f2, local_34 * 0x20) * iVar5 + iVar4,iVar5,iVar5,
                         0x1d);
    }
  }
  true // DEVIATION: C pointer — iVar6 = FUN_005ae052(s16(DAT_0064f340, s32(in_ECX, 0x159c) * 0x58) - local_8)
  // DEVIATION(cont): ;
  FUN_00408780(iVar6 * iVar5 + iVar3,
                     true // DEVIATION: C pointer — s16(DAT_0064f342, s32(in_ECX, 0x159c) * 0x58) * iVar5 + iVar4,
...
export function citywin_7F31_00507F31(in_ECX, param_1, param_2, param_3) {
  ...
  do {
    ...
    case 3:
      ...
      if (DAT_0064c6b5[s8(DAT_0064f348[s32(in_ECX, 0x159c) * 0x58]) * 0x594] !== 0x06
         ) LAB_00507f6b_helper(local_c); return;
    }
  ...
  if (bVar1 === 4) {
    ...
    for (local_38 = 0; local_38 < DAT_00655b16; local_38 = local_38 + 1) {
      if ((((s32(DAT_0065610a, local_38 * 0x20) !== 0) &&
           (iVar3 = local_8 >> 1,
           true // DEVIATION: C pointer — s16(DAT_0064f340, s32(in_ECX, 0x159c) * 0x58) ===
    ...
    if (local_18 !== 0) {
      ...
      if (local_14[0] !== 0) {
        ...
        FUN_005114d0(DAT_00646598,s32(param_1, 0),(param_3 + param_2) - (iVar4 >> 1),local_14[0],
    ...
    case 2:
      ...
      if (((((iVar2 === 0) &&
         ...
         (((iVar2 = FUN_0043d20a(s32(in_ECX, 0x159c),7), iVar2 === 0 &&
          ...
          (DAT_0064c6b5[local_44 * 0x594] !== 0x06)))) LAB_00508678_helper(local_18); return;
      local_14 = 2;
      thunk_citywin_7F31(local_2c[0],local_40,local_10);
      break;
    case 3:
      if (u8(DAT_006a6620[local_14]) - u8(DAT_006a65f0[local_14]) ===
          ((DAT_006a6623) >>> 0) - ((DAT_006a65f3) >>> 0)) LAB_00508678_helper(local_18); return;
...
export function citywin_9429_00509429(in_ECX) {
  ...
  if ((((-1 < s32(in_ECX, 0x159c)) && (s32(in_ECX, 0x159c) < DAT_00655b18)) &&
      true // DEVIATION: C pointer — (s32(DAT_0064f394, s32(in_ECX, 0x159c) * 0x58) !== 0)) && (DAT_00628044 !== 0))
  // DEVIATION(cont): {
...
export function city_button_buy_00509B48(param_1) {
  ...
  if (s8(DAT_0064f379[iVar5 * 0x58]) < 0) {
    ...
    // DEVIATION: MFC — iVar5 = CSplitterWnd::IsTracking(DAT_006a91b8);
    iVar5 = FUN_005adfa0(uVar6 * local_368 - s16(DAT_0064f35c, iVar5 * 0x58),
                               uVar7,uVar8);
    local_35c = iVar5 * 2;
    if (0x22 < -iVar4) {
      local_35c = iVar5 << 2;
  ...
  while( true ) {
      ...
      if (local_95c[0] !== 999) {
        ...
        if (local_95c[0] < 0) {
          ...
          if (local_95c[0] < 0x27) {
            ...
            FUN_0059ec88(DAT_00645a84 + (local_95c[0] * 4 + -0x9c) * 0xf,
                               (DAT_00633584 === 0) - 1 & 8,0);
          }
        }
        else {
    ...
    if (local_578 === 1) {
      if ((1 << (bVar1 & 0x1f) & ((DAT_00655b0b) >>> 0)) !== 0) {
        ...
        if (local_958 === 1) {
          // DEVIATION: MFC — iVar2 = CSplitterWnd::IsTracking(DAT_006a91b8);
          w32(DAT_0064f344, iVar2 * 0x58, 
               u32(DAT_0064f344, iVar2 * 0x58) | 0x1000000);
        }
        if (local_958 === 2) {
          // DEVIATION: MFC — iVar2 = CSplitterWnd::IsTracking(DAT_006a91b8);
          w32(DAT_0064f344, iVar2 * 0x58, 
               u32(DAT_0064f344, iVar2 * 0x58) | 0x2000000);
        }
      }
      uVar6 = 99;
      // DEVIATION: MFC — iVar2 = CSplitterWnd::IsTracking(DAT_006a91b8);
...
export function citywin_C494_0050C494(in_ECX, param_1, param_2, param_3) {
  ...
  if ((((s32(in_ECX, 0x15a4) === 0) && (s32(in_ECX, 0x15a0) === 0)) &&
      (s32(in_ECX, 0x15a8) === 0)) && (-1 < s32(in_ECX, 0x159c))) {
    if (param_1 < 0) {
      true) // DEVIATION: C pointer — if ((s16(DAT_0064f340, s32(in_ECX, 0x159c) * 0x58) === param_2) &&
    ...
    true))) // DEVIATION: C pointer — else if (((s16(DAT_0064f340, s32(in_ECX, 0x159c) * 0x58) ===
