...
import {
  s8, u8, DAT_006d1160, DAT_006d1162, DAT_00655ae8,
  DAT_006560f0, DAT_0064b1bc, DAT_0064c600,
  DAT_00627cc0, DAT_00627cce, DAT_00627cd4,
  DAT_00636058, DAT_00655b16, DAT_0064bcc8, DAT_00654fae,
...
// If out of bounds, returns offset to dummy tile (DAT_006d1188).
//
...
import { DAT_006d1168 } from './mem.js';
    ...
    if ((byte0 & 0x40) === 0) {
      if ((byte0 & 0xF) === 2) {
        ...
        if (((uVar3 & 3) + (uVar4 & 3) * 4) ===
            (((((param_2 + param_1) >> 3) * 0xB + (uVar4 >> 2) * 0xD + DAT_006d1168) & 0xF) >>> 0)) {
          local_8 = 1;
          const uVar5 = 1 << ((DAT_006d1168 >> 4) & 3);
...
//
// Tech bitmask stored in per-civ data at offset 0xF8 (DAT_0064c6f8).
...
export function FUN_004bd9f0(param_1, param_2) {
  ...
  if (param_2 === -2) {
    ...
    if (param_1 < 1) {
      ...
      // DAT_0064c6f8[param_1 * 0x594 + local_c]
      const techByte = DAT_0064c600[param_1 * 0x594 + 0xF8 + local_c];
...
//
// Uses DAT_0062833c/DAT_00628344 as 5-entry direction tables.
// ═══════════════════════════════════════════════════════════════════
...
export function FUN_0058c56c(param_1, param_2) {
  ...
  while (true) {
    ...
    const uVar1 = FUN_005ae052(s8(DAT_0062833c[local_8]) + param_1);
    const iVar2 = s8(DAT_00628344[local_8]) + param_2;
    ...
    if ((uVar2 & 8) === 0) {
      if ((uVar2 & 4) === 0 || (iVar1 = FUN_004bd9f0(param_1, 0x46), iVar1 !== 0)) {
        ...
        for (let local_c = 0; local_c < 2; local_c++) {
          ...
          // DAT_00627cce = terrain table offset 0x0E (transform terrain)
          // DAT_00627cd4 = terrain table offset 0x14 (requirement/bonus)
          // DAT_0064c6b5 = per-civ field at offset 0xB5
          if (DAT_00627cce[uVar3 * 0x18 + local_c] !== 0xFF &&  // -1 as unsigned byte
              DAT_00627cd4[uVar3 * 0x18 + local_c] !== 0 &&
              s8(DAT_00627cd4[uVar3 * 0x18 + local_c]) <=
                u8(DAT_0064c600[param_1 * 0x594 + 0xB5])) {
            return local_c + 1;
          }
        }
      }
