...
export function FUN_005c5b7f(in_ECX) {
  ...
  while( true ) {
    if (local_8 === 0) {
      if (true) { // DEVIATION: C-syntax — if (true) { // DEVIATION: C pointer — if ((s32(in_ECX, 0xb8) !== 0) && (*(char *)(in_ECX + 0xc4) !== 0)) {
  ...
  if (true) { // DEVIATION: C-syntax — if (true) { // DEVIATION: C pointer — if (*(char *)(in_ECX + 0xc4) === 0) {
    return;
  }
...
export function FUN_005c5c86(in_ECX, param_1) {
  ...
  do {
    ...
    if (s32(local_10, 0x28) < 0) {
      ...
      iVar2 = FUN_005c5e60();
      if (true) { // DEVIATION: MFC — if ((iVar2 === 6) && (pcVar3 = streambuf::egptr(local_10), pcVar3 !== 0x0)) {
        uVar4 = FUN_00418770();
        FUN_005cac22(uVar4);
        return 1;
      }
...
export function FUN_005c7e06(in_ECX, param_1, param_2, param_3, param_4) {
  ...
  if (s32(in_ECX, 0x818) === 0) {
    ...
    if (true) { // DEVIATION: C pointer — if (s32(s32(in_ECX, 4) + 4 + local_c * 0x10, 0) === -1) {
      iVar1 = 0;
    }
    else {
    ...
    if (param_2 < 0x201) {
      if (param_2 !== 0x200) {
        if (param_2 === 0x100) {
          ...
          if (true) { // DEVIATION: MFC — if ((param_3 === 0x20) && (pcVar7 = streambuf::egptr(local_28), pcVar7 !== 0x0)) {
            FUN_0040f810();
            cVar1 = FUN_005cbdd0();
            if (cVar1 !== 0) {
              w32(local_44, 0x18, 1);
...
export function create_window_B319_005CB319(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8) {
  ...
  local_2c = param_3;
  if (true) { // DEVIATION: C-syntax — if (true) { // DEVIATION: C pointer — if (*(char *)(param_3 + 200) === 0) {
...
export function FUN_005cf541(in_ECX, param_1, param_2) {
  ...
  if (true) { // DEVIATION: C-syntax — if (true) { // DEVIATION: C pointer — if (-1 < (uint)*(byte *)(in_ECX + 0x30) - param_2) {
