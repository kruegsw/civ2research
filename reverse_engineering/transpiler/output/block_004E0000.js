          ...
          if (((s8(DAT_006560f7[local_34 * 0x20]) === param_1) ||
            ...
            if (s8(DAT_006560f7[local_34 * 0x20]) === param_1) {
              ...
              if (-1 < s16(DAT_00656106, local_34 * 0x20)) {
                true // DEVIATION: C pointer — s16(DAT_00656108, s16(DAT_00656106, local_34 * 0x20) * 0x20)
                     // DEVIATION(cont): = *(undefined2 *)(&DAT_00656108 + local_34 * 0x20);
                bVar3 = true;
              }
              if (-1 < s16(DAT_00656108, local_34 * 0x20)) {
                true // DEVIATION: C pointer — s16(DAT_00656106, s16(DAT_00656108, local_34 * 0x20) * 0x20)
...
export function FUN_004e4ceb() {
  ...
  if (((DAT_006d1da8 === 0) || (DAT_00655b16 === 0)) ||
    ...
    // DEVIATION(C-syntax): true))) // DEVIATION: C pointer — FUN_005792e1(0x441,(*(uint *)(DAT_0064b1bc +
