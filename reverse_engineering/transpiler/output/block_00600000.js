...
export function __set_osfhnd_00601E40(param_1, param_2) {
  ...
  if ((((param_1) >>> 0) < DAT_006e6b2c) && (s32(true /* DEVIATION: C pointer — s32(DAT_006e69f0, (param_1 & 0xffffffe0 >> 3)) */ + (param_1 & 0x1f) * 8, 0) === -1)) {
     /*JOINED*/
              /*JOINED*/
    if (DAT_00639fd0 === 1) {
      if (param_1 === 0) {
...
export function __free_osfhnd_00601F40(param_1) {
  ...
  if (((((param_1) >>> 0) < DAT_006e6b2c) && ((u8((true /* DEVIATION: C pointer — s32(DAT_006e69f0, (param_1 & 0xffffffe0 >> 3)) */ + 4 + (param_1 & 0x1f) * 8)[0]) & 1) !== 0)) && (s32(true /* DEVIATION: C pointer — s32(DAT_006e69f0, (param_1 & 0xffffffe0 >> 3)) */ + (param_1 & 0x1f) * 8, 0) !== -1)) {
      /*JOINED*/
                 /*JOINED*/
     /*JOINED*/
              /*JOINED*/
...
export function __commit_006021E0(_FileHandle) {
  ...
  if (((((_FileHandle) >>> 0) < DAT_006e6b2c) && ((u8((true /* DEVIATION: C pointer — s32(DAT_006e69f0, (_FileHandle & 0xffffffe0 >> 3)) */ + 4 + (_FileHandle & 0x1f) * 8)[0]) & 1) !== 0)) && ((u8((true /* DEVIATION: C pointer — s32(DAT_006e69f0, (_FileHandle & 0xffffffe0 >> 3)) */ + 4 + (_FileHandle & 0x1f) * 8)[0]) & 1) !== 0)) {
      /*JOINED*/
                 /*JOINED*/
     /*JOINED*/
                /*JOINED*/
...
export function cvtdate_00603D20(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9, param_10, param_11) {
  ...
  if (param_1 === 1) {
    ...
    DAT_0063b368 = ((param_8 * 0x3c + param_9) * 0x3c + param_10) * 1000 + param_11 + DAT_0063b2b8 * 1000;
                   /*JOINED*/
    if (DAT_0063b368 < 0) {
