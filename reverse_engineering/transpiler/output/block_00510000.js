...
export function FUN_00511ba2() {
  ...
  if (piVar1 !== null) {
    ...
    case 0x3e:
      ...
      break;
    case 0x3f:
      if (s32(DAT_006ad30c, s32(DAT_006ad558, DAT_006d1da0 * 4) * 0x54) !== piVar1[4])
      {
...
export function FUN_0051438f(in_ECX, param_1, param_2, param_3) {
  ...
  if (s32((int, 0)param_2 + 4) === 0x2b) {
    ...
    if (iVar1 === 0) {
      ...
      *(void **)(in_ECX + 4 + s32(in_ECX, 0x5dc4) * 0xc) = pvVar2;
      ...
      _memcpy(*(void **)(in_ECX + 4 + s32(in_ECX, 0x5dc4) * 0xc),param_2,param_3)
      ;
      s32(in_ECX, s32(in_ECX, 0x5dc4) * 0xc) = param_1;
      u32(in_ECX, 8 + s32(in_ECX, 0x5dc4) * 0xc) = param_3;
      ...
      pvVar2 = operator_new(param_3);
      *(void **)(in_ECX + 4 + s32(in_ECX, 0x5dd0) * 0xc) = pvVar2;
      ...
      _memcpy(*(void **)(in_ECX + 4 + s32(in_ECX, 0x5dd0) * 0xc),param_2,param_3)
      ;
      s32(in_ECX, s32(in_ECX, 0x5dd0) * 0xc) = param_1;
      u32(in_ECX, 8 + s32(in_ECX, 0x5dd0) * 0xc) = param_3;
...
export function FUN_005149d6(in_ECX, param_1, param_2, param_3, param_4) {
  ...
  if (s32(in_ECX, 0x5dd4) === 0) {
    if ((param_4 === 0) && (s32(in_ECX, 0x5dc8) !== 0)) {
      ...
      s32(in_ECX, s32(in_ECX, 24000) * 0xc) = 0;
      param_2[0] = s32(in_ECX, 4 + s32(in_ECX, 24000) * 0xc);
      s32(in_ECX, 4 + s32(in_ECX, 24000) * 0xc) = 0;
      param_3[0] = s32(in_ECX, 8 + s32(in_ECX, 24000) * 0xc);
      s32(in_ECX, 8 + s32(in_ECX, 24000) * 0xc) = 0;
    ...
    s32(in_ECX, s32(in_ECX, 0x5dcc) * 0xc) = 0;
    param_2[0] = s32(in_ECX, 4 + s32(in_ECX, 0x5dcc) * 0xc);
    s32(in_ECX, 4 + s32(in_ECX, 0x5dcc) * 0xc) = 0;
    param_3[0] = s32(in_ECX, 8 + s32(in_ECX, 0x5dcc) * 0xc);
    s32(in_ECX, 8 + s32(in_ECX, 0x5dcc) * 0xc) = 0;
...
export function FUN_00517dd3(in_ECX, unaff_ESI, param_1) {
  ...
  local_20[0].bottom = *(LONG *)(in_ECX + 0x11bc);
  ...
  if (*(char *)(s32(in_ECX, 0x11a8) * 0xff + 0xea8 + in_ECX) !== 0) {
...
export function FUN_0051a678() {
  ...
  FUN_0059d3c9(0);
  if (local_10 !== null) {
    uVar2 = FUN_00428b0c(s32(DAT_00628420, 0x7d8),8,&LAB_00402e87);
...
export function FUN_0051a797() {
  ...
  FUN_0059d3c9(0);
  if (local_10 !== null) {
    uVar2 = FUN_00428b0c(s32(DAT_00628420, 0x7d8),9,&LAB_00402e87);
    FUN_00573e59(local_10,uVar2);
  }
  FUN_005199a9();
  return;
...
export function FUN_0051a8b7() {
  ...
  FUN_0059d3c9(0);
  if (local_10 !== null) {
    uVar2 = FUN_00428b0c(s32(DAT_00628420, 0x7d8),10,&LAB_00402590);
    FUN_00573e59(local_10,uVar2);
  }
  FUN_005199a9();
  return;
...
// LAB_0051ffec: (code below also in LAB_0051ffec_helper, kept for 1:1 audit)
    ...
    uVar2 = FUN_00428b0c((int)*(short *)(&DAT_00655502 +
    ...
    if (iVar3 !== 0) {
      ...
      if (local_240 === 0) {
        ...
        if (((DAT_006ad148 === 0) || (DAT_006ad160 === 0)) || (param_2 === 1)) {
          uVar2 = FUN_00428b0c((int)*(short *)(&DAT_00655504 +
                                                    *(short *)(&DAT_0064c6a6 +
                                                              s8(DAT_00655b03) * 0x594) * 0x30));
          FUN_005f22d0(&DAT_0064bd12 + s8(DAT_00655b03) * 0xf2,uVar2);
          uVar2 = FUN_00428b0c((int)*(short *)(&DAT_00655506 +
                                                    *(short *)(&DAT_0064c6a6 +
                                                              s8(DAT_00655b03) * 0x594) * 0x30));
        ...
        s16(DAT_00655506, s16(DAT_0064c6a6, s8(DAT_00655b03) * 0x594) * 0x30) =
             -*(short *)(&DAT_00655506 +
                        s16(DAT_0064c6a6, s8(DAT_00655b03) * 0x594) * 0x30);
        for (local_1c = 0; local_1c < 7; local_1c = local_1c + 1) {
          uVar2 = FUN_00428b0c((int)*(short *)(&DAT_0065550c +
                                                    iVar1 * 2 +
                                                    *(short *)(&DAT_0064c6a6 +
                                                              s8(DAT_00655b03) * 0x594) * 0x30 +
                                                    local_1c * 4));
...
// LAB_0052144f: (code below also in LAB_0052144f_helper, kept for 1:1 audit)
          ...
          if (((param_3 === 0) && (local_324 === 1)) && (0 < param_1)) {
            if (s16(DAT_00655502, s32(DAT_006ab144, param_1 * 4) * 0x30) < 1) {
              u16(DAT_00655502, s32(DAT_006ab144, param_1 * 4) * 0x30) =
                   ~u16(DAT_00655502, s32(DAT_006ab144, param_1 * 4) * 0x30) + 1;
            }
            if (s16(DAT_00655504, s32(DAT_006ab144, param_1 * 4) * 0x30) < 1) {
              u16(DAT_00655504, s32(DAT_006ab144, param_1 * 4) * 0x30) =
                   ~u16(DAT_00655504, s32(DAT_006ab144, param_1 * 4) * 0x30) + 1;
            }
            if (s16(DAT_00655506, s32(DAT_006ab144, param_1 * 4) * 0x30) < 1) {
              u16(DAT_00655506, s32(DAT_006ab144, param_1 * 4) * 0x30) =
                   ~u16(DAT_00655506, s32(DAT_006ab144, param_1 * 4) * 0x30) + 1;
            }
            for (local_1c = 0; local_1c < 7; local_1c = local_1c + 1) {
