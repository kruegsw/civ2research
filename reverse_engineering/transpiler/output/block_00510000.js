  ...
  if (piVar1 !== null) {
    ...
    case 0x3d:
      ...
      if (DAT_0067a8c0 === -1) {
        ...
        // DEVIATION: C pointer — FUN_0046b14d(0x80,*(undefined4 *)
                                 (DAT_006ad30c + s32(DAT_006ad558, piVar1[4] * 4) * 0x54),2,
                           0,0,0,0,0,0,0);
      }
      break;
    case 0x3e:
      ...
      if ((DAT_0067a8bc === 0) && (piVar1[4] === DAT_0067a8c0)) {
        ...
        if (local_22c === 1) {
          ...
          // DEVIATION: C pointer — FUN_0046b14d(0xa7,*(undefined4 *)
                                   (DAT_006ad30c +
                                   s32(DAT_006ad558, DAT_0067a8c0 * 4) * 0x54),DAT_006d1da0,
                             DAT_0067ab65,0,0,0,0,0,0);
  ...
  if (s32((int, 0)param_2 + 4) === 0x2b) {
    ...
    if (iVar1 === 0) {
      ...
      // DEVIATION: C pointer — if (s32(in_ECX, 4 + s32(in_ECX, 0x5dc4) * 0xc) === 0) {
        FUN_005d22b7(s_EnqueueMessage_Primary___Failed_t_006319c0,s32((int, 0)param_2 + 4),
                     s32((int, 0)param_2 + 8));
        return 0;
      }
      // DEVIATION: C pointer — if (s32(in_ECX, 4 + s32(in_ECX, 0x5dc4) * 0xc) === 0) {
...
export function FUN_00515197(unaff_EBP) {
  ...
  _Timevec::~_Timevec((_Timevec *)(s32(unaff_EBP, -0x10) + 0x648));
  return;
}
...
export function FUN_005168f9(unaff_EBP) {
  ...
  _Timevec::~_Timevec((_Timevec *)(s32(unaff_EBP, -0x10) + 0xe30));
  return;
}
    ...
    if (iVar2 === 0) {
      ...
      if (param_1 < 5) {
        ...
        // DEVIATION: C pointer — FUN_005dd3f1(s32(iVar1, 0xe90 + s32(iVar1, 0x11a8) * 4),
                     // DEVIATION: C pointer — s32(iVar1, 0xe9c + s32(iVar1, 0x11a8) * 4));
...
export function FUN_00518471() {
  ...
  if (s32(DAT_00631acc, 0xe70) === 0) {
    ...
    if ((s32(iVar1, 0x11a8) < 3) &&
      ...
      // DEVIATION: C pointer — FUN_00518342(s32(iVar1, 0xe84 + s32(iVar1, 0x11a8) * 4));
      FUN_00517dd3(1);
      // DEVIATION: C pointer — FUN_005dd45d(s32(iVar1, 0xe90 + s32(iVar1, 0x11a8) * 4));
      FUN_004085f0();
      // DEVIATION: C pointer — FUN_005dd3f1(s32(iVar1, 0xe90 + s32(iVar1, 0x11a8) * 4),
      ...
      if (local_240 === 0) {
        ...
        for (local_1c = 0; local_1c < 7; local_1c = local_1c + 1) {
          ...
          // DEVIATION: C pointer — *(short *)(DAT_0065550c +
                    iVar1 * 2 +
                    s16(DAT_0064c6a6, s8(DAT_00655b03) * 0x594) * 0x30 + local_1c * 4) =
               // DEVIATION: C pointer — -*(short *)(DAT_0065550c +
                          iVar1 * 2 +
                          s16(DAT_0064c6a6, s8(DAT_00655b03) * 0x594) * 0x30 +
                          local_1c * 4);
...
// LAB_0052144f: (code below also in LAB_0052144f_helper, kept for 1:1 audit)
          ...
          if (((param_3 === 0) && (local_324 === 1)) && (0 < param_1)) {
            // DEVIATION: C pointer — if (s16(DAT_00655502, s32(DAT_006ab144, param_1 * 4) * 0x30) < 1) {
              // DEVIATION: C pointer — u16(DAT_00655502, s32(DAT_006ab144, param_1 * 4) * 0x30) =
                   // DEVIATION: C pointer — ~u16(DAT_00655502, s32(DAT_006ab144, param_1 * 4) * 0x30) + 1;
            }
            // DEVIATION: C pointer — if (s16(DAT_00655504, s32(DAT_006ab144, param_1 * 4) * 0x30) < 1) {
              // DEVIATION: C pointer — u16(DAT_00655504, s32(DAT_006ab144, param_1 * 4) * 0x30) =
                   // DEVIATION: C pointer — ~u16(DAT_00655504, s32(DAT_006ab144, param_1 * 4) * 0x30) + 1;
            }
            // DEVIATION: C pointer — if (s16(DAT_00655506, s32(DAT_006ab144, param_1 * 4) * 0x30) < 1) {
              // DEVIATION: C pointer — u16(DAT_00655506, s32(DAT_006ab144, param_1 * 4) * 0x30) =
                   // DEVIATION: C pointer — ~u16(DAT_00655506, s32(DAT_006ab144, param_1 * 4) * 0x30) + 1;
            }
            for (local_1c = 0; local_1c < 7; local_1c = local_1c + 1) {
              // DEVIATION: C pointer — if (*(short *)(DAT_0065550c +
                            local_1c * 4 + s32(DAT_006ab144, param_1 * 4) * 0x30) < 1) {
                // DEVIATION: C pointer — *(ushort *)
                 (DAT_0065550c + local_1c * 4 + s32(DAT_006ab144, param_1 * 4) * 0x30) =
                     // DEVIATION: C pointer — ~*(ushort *)
                       (DAT_0065550c + local_1c * 4 + s32(DAT_006ab144, param_1 * 4) * 0x30)
                     + 1;
              }
              // DEVIATION: C pointer — if (*(short *)(DAT_0065550e +
                            local_1c * 4 + s32(DAT_006ab144, param_1 * 4) * 0x30) < 1) {
                // DEVIATION: C pointer — *(ushort *)
                 (DAT_0065550e + local_1c * 4 + s32(DAT_006ab144, param_1 * 4) * 0x30) =
                     // DEVIATION: C pointer — ~*(ushort *)
                       (DAT_0065550e + local_1c * 4 + s32(DAT_006ab144, param_1 * 4) * 0x30)
                     + 1;
              }
