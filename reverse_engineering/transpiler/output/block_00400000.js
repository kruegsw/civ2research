...
export function FUN_0040c480(in_ECX) {
  ...
  // DEVIATION(C-syntax): true // DEVIATION: C pointer — DAT_0064c6b4[iVar3 * 0x594] = *(undefined1 *)(in_ECX + 0x2e0);
  // DEVIATION(C-syntax): true // DEVIATION: C pointer — DAT_0064c6b3[iVar3 * 0x594] = *(undefined1 *)(in_ECX + 0x2e8);
