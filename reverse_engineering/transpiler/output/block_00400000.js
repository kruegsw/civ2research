...
export function FUN_00406ad1() {
  ...
  // DEVIATION: MFC — COleCntrFrameWnd::~COleCntrFrameWnd(DAT_0063c818);
  return;
}
  ...
  if (iVar1 === 0) {
    ...
    if ((iVar1 === 0) && (DAT_00655b07 === 0)) {
      ...
      if ((iVar1 < 0) ||
        ...
        if ((((DAT_0062804c === 0) || ((DAT_006d1da8 === 0) !== ((DAT_00628054) ? 1 : 0))) ||
...
export function FUN_004074dc(param_1, param_2) {
  ...
  {
    if (DAT_0062edf8 === 0) {
      uVar1 = FUN_005adfa0(DAT_0063c810 + (param_2 - _DAT_0063caf0) / DAT_0063c804,
      ...
      uVar2 = FUN_005adfa0(((param_1 - (DAT_0063caf4 + local_14)) / DAT_0063c800) * 2 +
...
export function FUN_00407658(param_1, param_2) {
  ...
  if ((((-1 < param_1) && (-1 < param_2)) && (param_1 < DAT_0063c944)) && (param_2 < DAT_0063c948))
  {
    if (DAT_0062edf8 === 0) {
      ...
      uVar2 = FUN_005adfa0(((param_1 - (DAT_0063caf4 + local_1c)) / DAT_0063c800) * 2 +
                                 DAT_0063c814,DAT_0063c814,DAT_0063c80c * 2 + -2 + DAT_0063c814);
...
export function FUN_004079a6() {
  ...
  // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063c818,0x402581);
  FUN_00408130(0 /* ADDR:LAB_004022de */);
  FUN_00408170(0 /* ADDR:LAB_00401942 */);
  // DEVIATION: MFC — COleControlSite::SetDlgCtrlID(DAT_0063c870,0x402cd4);
  tie(thunk_map_ascii);
  FUN_00408010(0x1ff);
  FUN_00408050(1);
...
// DEVIATION(unparsed): /* Library Function - Single Match
    // DEVIATION(unparsed): public: virtual int __thiscall COleControlSite::SetDlgCtrlID(int)
   // DEVIATION(unparsed): 
   // DEVIATION(unparsed): Library: Visual Studio 1998 Debug */
// DEVIATION(unparsed): 
// DEVIATION(unparsed): int __thiscall COleControlSite::SetDlgCtrlID(COleControlSite *this,int param_1)
// DEVIATION(unparsed): 
// DEVIATION(unparsed): {
  // DEVIATION(unparsed): int iVar1;
  // DEVIATION(unparsed): 
  // DEVIATION(unparsed): iVar1 = *(int *)(this + 0x28);
  // DEVIATION(unparsed): *(int *)(this + 0x28) = param_1;
...
// DEVIATION(unparsed): /* Library Function - Multiple Matches With Same Base Name
    // DEVIATION(unparsed): public: class basic_ostream<char,struct char_traits<char> > * __thiscall basic_ios<char,struct
   // DEVIATION(unparsed): char_traits<char> >::tie(class basic_ostream<char,struct char_traits<char> > *)
    // DEVIATION(unparsed): public: class basic_ostream<unsigned short,struct char_traits<unsigned short> > * __thiscall
   // DEVIATION(unparsed): basic_ios<unsigned short,struct char_traits<unsigned short> >::tie(class basic_ostream<unsigned
   // DEVIATION(unparsed): short,struct char_traits<unsigned short> > *)
   // DEVIATION(unparsed): 
   // DEVIATION(unparsed): Library: Visual Studio 1998 Debug */
// DEVIATION(unparsed): 
// DEVIATION(unparsed): undefined4 tie(undefined4 param_1)
// DEVIATION(unparsed): 
// DEVIATION(unparsed): {
  // DEVIATION(unparsed): undefined4 uVar1;
  // DEVIATION(unparsed): int in_ECX;
  // DEVIATION(unparsed): 
  // DEVIATION(unparsed): uVar1 = *(undefined4 *)(in_ECX + 0x2c);
  // DEVIATION(unparsed): *(undefined4 *)(in_ECX + 0x2c) = param_1;
...
// DEVIATION(unparsed): 
// DEVIATION(unparsed): {
  // DEVIATION(unparsed): *(int *)(this + 0x110) = param_1;
...
export function FUN_0040beec(param_1) {
  ...
  FUN_0040bdac(local_8[0],local_10[0],local_14[0],DAT_0063cbb4 + 0x2f4,DAT_0063cbb4 + 0x350,
                     DAT_0063cbb4 + 0x354);
...
export function FUN_0040c07f(param_1) {
  ...
  FUN_0040bdac(local_8[0],local_10[0],local_14[0],DAT_0063cbb4 + 0x2f0,DAT_0063cbb4 + 0x354,
                     DAT_0063cbb4 + 0x34c);
...
export function FUN_0040c212(param_1) {
  ...
  FUN_0040bdac(local_8[0],local_10[0],local_14[0],DAT_0063cbb4 + 0x2ec,DAT_0063cbb4 + 0x34c,
                     DAT_0063cbb4 + 0x350);
...
export function FUN_0040c3a5() {
  ...
  DAT_0063cbb0 = 0;
  // DEVIATION: MFC — CRichEditDoc::InvalidateObjectCache((DAT_0063cbb4 + 0x48));
  return;
}
...
export function FUN_0040c3cd(param_1, param_2) {
  ...
  s32(DAT_0063cbb4, 0x34c + (param_1 + -300) * 4) = param_2;
  if (param_2 !== 0) {
...
export function FUN_0040c480(in_ECX) {
  ...
  // DEVIATION: C pointer — DAT_0064c6b4[iVar3 * 0x594] = *(undefined1 *)(in_ECX + 0x2e0);
  // DEVIATION: C pointer — DAT_0064c6b3[iVar3 * 0x594] = *(undefined1 *)(in_ECX + 0x2e8);
  for (local_b0 = 0; local_b0 < DAT_00655b18; local_b0 = local_b0 + 1) {
    if ((s32(DAT_0064f394, local_b0 * 0x58) !== 0) &&
       (s8(DAT_0064f348[local_b0 * 0x58]) === iVar3)) {
...
export function FUN_0040c7d0(in_ECX) {
  ...
  if ((DAT_00624f1c === 0) || (DAT_0063cbb0 === 0)) {
    ...
    FUN_005a9afe(DAT_00624f1c,in_ECX,0,0,s32(in_ECX, 0x124),
  ...
  // DEVIATION: C pointer — FUN_0040ff00(*(undefined4 *)
                      // DEVIATION(cont): (&DAT_0064b9a0 +
                      // DEVIATION(cont): (uint)(byte)(&DAT_0064c6b5)[*(int *)(in_ECX + 0x2d8) * 0x594] * 4));
  FUN_0040fe10();
  FUN_0040fe10();
  FUN_0040fe10();
  FUN_0040bc10(0x100);
  ...
  FUN_0040fe70();
  FUN_005bb024(in_ECX,DAT_00679640,s32(in_ECX, 0x300),
                     s32(in_ECX, 0x33c),s32(in_ECX, 0x31c));
  FUN_005baee0(0x25,0x12,1,1);
  FUN_0040bbb0();
  FUN_0040ff30(0);
  FUN_0040fe70();
  FUN_005baf57(in_ECX,DAT_00679640,s32(in_ECX, 0x300),
                     s32(in_ECX, 0x330));
  FUN_005baf57(in_ECX,DAT_00679640,s32(in_ECX, 0x300),
                     s32(in_ECX, 0x338));
  FUN_005baf57(in_ECX,DAT_00679640,s32(in_ECX, 0x300),
  ...
  FUN_0040ff30(100);
  FUN_0040fe70();
  FUN_005bb0af(in_ECX,DAT_00679640,s32(in_ECX, 0x300),
  ...
  FUN_0040bbb0();
  FUN_0040bc10(0x102);
  FUN_005baf57(in_ECX,DAT_00679640,
  ...
  *(DAT_0064c6b3 + param_1 * 0x594) = in_ECX[0x2e8];
  ...
  if (local_464[0] !== 0) {
    ...
    for (local_47c = 0; local_47c < DAT_00655b18; local_47c = local_47c + 1) {
      if ((s32(DAT_0064f394, local_47c * 0x58) !== 0) &&
         (s8(DAT_0064f348[local_47c * 0x58]) === param_1)) {
  ...
  if ((1 << (u8(param_1) & 0x1f) & ((DAT_00655b0b) >>> 0)) !== 0) {
    if ((DAT_00655b02 < 3) || (DAT_006d1da0 === param_1)) {
      ...
      // DEVIATION: C pointer — FUN_0046b14d(0x9e,*(undefined4 *)
                               // DEVIATION(cont): (&DAT_006ad30c + *(int *)(&DAT_006ad558 + param_1 * 4) * 0x54),0,0,0,
...
export function FUN_0040e017() {
  ...
  for (local_318 = 0; local_318 < DAT_00655b18; local_318 = local_318 + 1) {
    if (s32(DAT_0064f394, local_318 * 0x58) !== 0) {
      ...
      local_31c = u8(uVar2);
      if (((1 << (local_31c & 0x1f) & s8(DAT_0064f34c[local_318 * 0x58])) !== 0) ||
         (s8(DAT_0064f348[local_318 * 0x58]) === (uVar2 & 0xff))) {
        bVar1 = true;
      }
      if (bVar1) {
        FUN_0040bbb0();
  ...
  if (local_310 !== 0) {
    ...
    if (-1 < iVar5) {
      FUN_00410402(s16(DAT_0064f340, iVar5 * 0x58),
                         s16(DAT_0064f342, iVar5 * 0x58));
      if ((local_22c !== 0) &&
         ((s8(DAT_0064f348[iVar5 * 0x58]) === uVar2 || (DAT_00655b07 !== 0)))) {
    ...
    if ((u16(DAT_0064c6a0, DAT_006d1da0 * 0x594) & 8) === 0) {
      if (DAT_0064c6b5[DAT_006d1da0 * 0x594] !== 0) {
        ...
        // DEVIATION: C pointer — FUN_004271e8(1,*(undefined4 *)
                              // DEVIATION(cont): (&DAT_0064b9a0 + (uint)(byte)(&DAT_0064c6b5)[iVar1 * 0x594] * 4));
...
// DEVIATION(unparsed): 
// DEVIATION(unparsed): {
  // DEVIATION(unparsed): gdi_8514(*(undefined4 *)this);
  // DEVIATION(unparsed): return;
// DEVIATION(unparsed): }
// DEVIATION(unparsed): 
// DEVIATION(unparsed): 
...
// DEVIATION(unparsed): 
// DEVIATION(unparsed): {
  // DEVIATION(unparsed): *(int *)(this + 0xa4) = param_1;
  // DEVIATION(unparsed): return;
// DEVIATION(unparsed): }
// DEVIATION(unparsed): 
// DEVIATION(unparsed): 
