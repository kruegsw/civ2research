  ...
  if ((((-1 < param_2 - _DAT_0063ef78) &&
    ...
    for (local_18 = 0; local_18 < 100; local_18 = local_18 + 1) {
      ...
      if ((iVar4 !== 0) && (bVar5 = local_14 === iVar3 + iVar2, local_14 = local_14 + 1, bVar5)) {
        ...
        // DEVIATION: MFC — CRichEditDoc::InvalidateObjectCache(DAT_0063eb58);
        DAT_00625ec4 = 1;
        return;
      }
    }
...
export function FUN_0043060b(param_1, param_2) {
  ...
  // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb10,0x402766);
  FUN_005bb574();
  FUN_004085f0();
  do {
    DAT_00625ec4 = 0;
    if (2 < DAT_00655b02) {
      // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb58,0x402789);
    }
    _DAT_00625ec0 = FUN_00421bb0();
    FUN_005c61b0();
    // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb58,0);
...
export function FUN_00431c73(param_1) {
  ...
  DAT_0063ef6c = param_1;
  FUN_0042acb0();
  // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb10,0x401b45);
  FUN_005bb574();
  FUN_004085f0();
  if (2 < DAT_00655b02) {
    // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb58,0x402789);
...
export function FUN_00433122(param_1) {
  ...
  DAT_0063ef6c = param_1;
  FUN_0042acb0();
  // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb10,0x401bef);
  FUN_005bb574();
  FUN_004085f0();
  if (2 < DAT_00655b02) {
    // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb58,0x402789);
  ...
  for (local_1a4 = 0; local_1a4 < DAT_00655b18; local_1a4 = local_1a4 + 1) {
    if (s32(DAT_0064f394, local_1a4 * 0x58) !== 0) {
      ...
      local_134 = DAT_006a65cc / DAT_006a65f8 + -0x14 +
                  ((int)(s8(DAT_0064f349[local_1a4 * 0x58]) * DAT_006a65c4 +
...
export function FUN_00434d8a(param_1) {
  ...
  DAT_0063ef6c = param_1;
  FUN_0042acb0();
  // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb10,0x401cda);
  FUN_005bb574();
  FUN_004085f0();
  if (2 < DAT_00655b02) {
    // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb58,0x402789);
...
// LAB_004355c2: (code below also in LAB_004355c2_helper, kept for 1:1 audit)
      ...
      for (local_28 = 0; local_28 < 0x1c; local_28 = local_28 + 1) {
        if ((((-1 < s16(DAT_00655be6, local_28 * 2)) &&
            ...
            true // DEVIATION: C pointer — (s32(DAT_0064f394, s16(DAT_00655be6, local_28 * 2) * 0x58) !== 0)) &&
...
export function FUN_00435d15(param_1) {
  ...
  DAT_0063ef6c = param_1;
  FUN_0042acb0();
  // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb10,0x402428);
  FUN_005bb574();
  FUN_004085f0();
  if (2 < DAT_00655b02) {
    // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb58,0x402789);
...
export function FUN_00435dc4() {
  ...
  for (local_64 = 0; local_64 <= local_74; local_64 = local_64 + 1) {
    ...
    if (local_64 < local_74) {
      ...
      // DEVIATION: MFC — _Timevec::~_Timevec(DAT_0063e4e0);
...
export function FUN_004361cc(param_1) {
  ...
  DAT_0063ef6c = param_1;
  FUN_0042acb0();
  // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb10,0x402432);
  FUN_005bb574();
  FUN_0046e571(3,0);
  FUN_004085f0();
  if (2 < DAT_00655b02) {
...
export function FUN_004362e2() {
  ...
  // DEVIATION: MFC — _Timevec::~_Timevec(DAT_0063f030);
...
export function FUN_00436bb7(param_1) {
  ...
  // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb10,0x402f4a);
  FUN_005bb574();
  FUN_004085f0();
  if (2 < DAT_00655b02) {
    // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb58,0x402789);
...
export function FUN_0043742f(param_1) {
  ...
  // DEVIATION: MFC — _Timevec::~_Timevec(DAT_0063ea20);
...
export function FUN_00437a4a(param_1) {
  ...
  if (iVar1 === 0) {
    ...
    FUN_0042acb0();
    // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063eb10,0x401c6c);
    FUN_0046e571(3,0);
    FUN_005bb574();
    FUN_004085f0();
    FUN_00484d52();
...
export function FUN_0043856b(param_1) {
  ...
  if (DAT_0063e948 < 0) {
    ...
    FUN_0040f7d0();
    FUN_0040f840();
    // DEVIATION: MFC — CPropertySheet::EnableStackedTabs(DAT_0063e4f8,0x4022cf);
    FUN_005bb574();
    FUN_004085f0();
  }
  else {
...
export function FUN_0043f493(param_1) {
  ...
  true // DEVIATION: C pointer — if (s16(DAT_00655504, s16(DAT_0064c6a6, iVar1 * 0x594) * 0x30) < 1) {
    true // DEVIATION: C pointer — local_2c = ~s16(DAT_00655504, s16(DAT_0064c6a6, iVar1 * 0x594) * 0x30) +
               // DEVIATION(cont): 1;
  }
  else {
    true // DEVIATION: C pointer — local_2c = s16(DAT_00655504, s16(DAT_0064c6a6, iVar1 * 0x594) * 0x30);
...
export function create_city_0043F8B0(param_1, param_2, param_3) {
  ...
  if ((DAT_00655b02 < 3) || (cVar1 = FUN_00421f40(), cVar1 !== 0)) {
    ...
    for (local_24 = 2; local_24 < 0x3e; local_24 = local_24 + 1) {
      if ((DAT_0064b1ca[local_24 * 0x14] === 0x01) &&
      ...
      if ((1 << (u8(param_3) & 0x1f) & ((DAT_00655b0b) >>> 0)) === 0) {
        ...
        for (local_14 = 0; local_14 < 0x14; local_14 = local_14 + 1) {
          ...
          if ((((iVar5 !== 0) &&
             ...
             // DEVIATION(C-syntax): true)) // DEVIATION: C pointer — ((iVar5 = FUN_005b8931(uVar6,iVar4), (DAT_00655b0b & *(byte *)(iVar5 + 4)) === 0
        ...
        if ((0x28 < DAT_00655af8) &&
           // DEVIATION(C-syntax): true // DEVIATION: C pointer — (iVar4 = FUN_005b8931(param_1,param_2), (DAT_00655b0b & *(byte *)(iVar4 + 4)) === 0)
           // DEVIATION(cont): ) {
    ...
    for (local_14 = 0; local_14 < 9; local_14 = local_14 + 1) {
      ...
      if (iVar5 !== 0) {
        ...
        if (iVar5 !== 0) {
          ...
          if ((1 < s16(DAT_00666134, iVar5 * 0x10)) &&
             ((iVar5 < 0x3f || ((DAT_0064f344[local_28 * 0x58] & 0x80) !== 0)))) {
            w32(DAT_0064f344, local_28 * 0x58, 
                 u32(DAT_0064f344, local_28 * 0x58) | 0x200000);
          }
          w32(DAT_0064f344, local_28 * 0x58, 
               u32(DAT_0064f344, local_28 * 0x58) | 0x80);
        }
        pbVar7 = FUN_005b8931(uVar6,iVar4);
        if (((s32(pbVar7, 0) & 0x80) !== 0) || (cVar1 = FUN_005b89bb(uVar6,iVar4), cVar1 === 0x05)) {
          w32(DAT_0064f344, local_28 * 0x58, 
               u32(DAT_0064f344, local_28 * 0x58) | 0x800);
        }
      }
    }
