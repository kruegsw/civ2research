...
export function FUN_0043028a(param_1, param_2) {
  ...
  uVar1 = DAT_0063efac;
  if ((((-1 < param_2 - _DAT_0063ef78) && (iVar2 = (param_2 - _DAT_0063ef78) / DAT_0063ef80, iVar2 < DAT_0063ef74)) && (-1 < param_1 + -2)) && (iVar3 = (param_1 + -2) / DAT_0063ef98, iVar3 < 3)) {
       /*JOINED*/
      /*JOINED*/
...
export function FUN_00430822() {
  ...
  FUN_0047e94e(1,0);
  iVar1 = FUN_00421bb0();
  if (((DAT_006ad8b8 * 0x3c <= iVar1 - _DAT_0063e4e8) || (DAT_0063f278 !== -1)) || (DAT_006c91e4 !== 0)) {
     /*JOINED*/
  ...
  if ((DAT_00627670 === 0) || (iVar1 = FUN_004fbe84(param_1,local_18), iVar1 !== 0)) {
    if ((((1 << (u8(param_1) & 0x1f) & ((DAT_00655b0b) >>> 0)) === 0) || ((1 << (u8(local_18) & 0x1f) & ((DAT_00655b0b) >>> 0)) !== 0)) && (((1 << (u8(param_1) & 0x1f) & ((DAT_00655b0b) >>> 0)) === 0 || (2 < DAT_00655b02)))) {
      ...
      if ((((1 << (u8(param_1) & 0x1f) & ((DAT_00655b0b) >>> 0)) !== 0) && ((1 << (u8(local_18) & 0x1f) & ((DAT_00655b0b) >>> 0)) !== 0)) && (2 < DAT_00655b02)) {
        ...
        DAT_00635a3c = 0 /* ADDR:LAB_0040326a */;
...
export function FUN_00431573() {
  ...
  DAT_0063ef74 = FUN_005adfa0((local_6c - local_58) / 0x28,1,99);
  local_18 = DAT_0063ef74;
  _DAT_0063ef68 = FUN_005adfa0((DAT_0063ef74 + -1 + local_34) / DAT_0063ef74,1,99);
...
export function FUN_00436f5a(param_1) {
  ...
  DAT_0063eaca = ((DAT_00655b08) & 0xFFFF);
  if ((DAT_00655af0 & 0x10) !== 0) {
  ...
  DAT_0063eada = ((DAT_0063ea18) << 16 >> 16);
  _DAT_0063eadc = ((u8(DAT_006554fc[s16(DAT_0064c6a6, param_1 * 0x594) * 0x30])) & 0xFFFF);
...
export function FUN_0043742f(param_1) {
  ...
  if (local_50 < DAT_00625ec8) {
    ...
    DAT_00625ed0 = ((DAT_0063ec3c > local_3c) >>> 0);
    if (param_1 === 0) {
...
export function FUN_00437cea() {
  ...
  DAT_0063e95c = FUN_005adfa0((iVar3 - iVar5) / 0x18,1,99);
  local_24 = 0;
  ...
  if (local_24 !== 0) {
    _DAT_0063e950 = FUN_005adfa0((DAT_0063e95c + -1 + local_24) / DAT_0063e95c,1,99);
    ...
    while (((local_30 <= s32(DAT_006af220, iVar1 * 4) && (local_30 + -1 < iVar2 + local_8)) && ((s32(DAT_006af260, iVar1 * 4) !== 0 || (local_38 < s32(DAT_006af280, iVar1 * 4)))))) {
      ...
      while (iVar9 = DAT_0063e7bc - _DAT_0063e98c, iVar8 = FUN_0040efd0(DAT_00679640), (iVar9 + -2) - (iVar6 + 0x1e2) < iVar8) {
            /*JOINED*/
        sVar10 = _strlen(DAT_00679640);
        DAT_0067963f[sVar10] = 0;
      }
...
export function FUN_0043d400(param_1) {
  ...
  if ((((DAT_0064f346[param_1 * 0x58] & 2) !== 0) || (DAT_00655b07 !== 0)) || ((DAT_00655af8 + param_1 & 0xf) === 0)) {
    ...
    DAT_0063f678 = (local_128[10] * 3 + local_128[0] * 4 + local_128[8] * 2) - local_8c / 6;
    ...
    DAT_0063f67c = (local_128[9] + local_128[1] + local_128[3] + local_128[8] + 1) * local_128[4] * 5;
                   /*JOINED*/
    iVar5 = local_b0 / 2;
    if (1 < iVar5) {
      iVar5 = 2;
    }
    DAT_0063f67c = FUN_005ae3ec(DAT_0063f67c,iVar5 + -1);
    ...
    DAT_0063f688 = local_1c + (DAT_006d1160 >> 1) - local_6c / 2 + local_8;
    if (local_94 !== 0) {
    ...
    if (((DAT_0063f68c !== 0) && (DAT_0063f68c = DAT_0063f68c + local_64 * 2, local_a4 !== 0)) && (local_a4 % 5 === 0)) {
       /*JOINED*/
    ...
    DAT_0063f694 = (local_128[9] * 3 + local_128[8] * 2 + local_128[0] * 2) * ((local_128[10] + local_b4) / 2);
                   /*JOINED*/
    if (DAT_0063f694 !== 0) {
      if (local_14 < 10) {
    ...
    DAT_0063f6a4 = (local_128[6] + local_128[0] + 1) * (local_128[4] + local_b4 + 1) * (local_128[5] + 1);
                   /*JOINED*/
    ...
    DAT_0063f540 = (local_128[6] + local_128[7]) * 5 + local_14 * 3 / 2 + local_128[5] * 2 + local_128[3];
                   /*JOINED*/
    ...
    DAT_0063f564 = (((DAT_006d1162 >> 1) - local_14) * 2 - local_6c) + (DAT_006d1160 >> 1)
                   + local_128[9] * 4 + local_128[1] / 2 + local_128[8] * 2 + local_128[0] * 4;
    uVar8 = FUN_005adfa0(local_b0 + -1,0xffffffff,1);
    DAT_0063f564 = FUN_005ae3ec(DAT_0063f564,uVar8);
    ...
    DAT_0063f56c = s16(DAT_00666130, local_a4 * 0x10) / 10 - iVar5;
    if (s8(DAT_0064f349[param_1 * 0x58]) < 0x04) {
    ...
    if (iVar5 === 0) {
      ...
      DAT_0063f578 = (local_8c / 3) * (local_b0 + 2);
    ...
    if (iVar5 === 0) {
      ...
      DAT_0063f57c = FUN_005ae3ec(DAT_0063f57c,uVar8);
