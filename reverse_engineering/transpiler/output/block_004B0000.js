...
export function FUN_004b4c09() {
  ...
  w32(local_8, 0x11c, **(undefined4 **)(local_8 + 0x150));
  ...
  if (param_2 < 0x2b5) {
    ...
    if (param_2 === 0xd0) {
      ...
      if (s32(local_8, 0x1ec) === 4) {
        ...
        FUN_0046b14d(0x68,*(undefined4 *)
                                 (&DAT_006ad30c +
                                 s32(DAT_006ad558, s32(local_8, 0x118) * 4) * 0x54),
