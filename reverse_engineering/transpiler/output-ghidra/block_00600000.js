...
const PTR_s_R6002_-_floating_point_not_loade_0063b1bc = globalThis.PTR_s_R6002_-_floating_point_not_loade_0063b1bc;
...

 {
  ...
  for (/* cond: (s32((DAT_0063b1b8 + local_c * 8), 0) !== param_1) */); (local_c = (local_c < 0x12) && (wv(DAT_0063b1b8, DAT_0063b1b8)));
      local_c = (local_c + 1)) {
  }
...

 {
  ...
  for (/* cond: (s32((DAT_0063b1b8 + local_8 * 8), 0) !== param_1) */); (local_8 = (local_8 < 0x12) && (wv(DAT_0063b1b8, DAT_0063b1b8)));
      local_8 = (local_8 + 1)) {
  }
...

 {
  ...
  if ((in_stack_00000008 !== 3)) {
    ...
    if ((local_8 !== 0)) {
      for (/* cond: (s32((local_8 + 4), 0) === param_1) */); local_8 = (local_8 + 4); local_8 = (local_8 + 0xc)) {
...

 {
  ...
  if ((local_18 !== 1)) {
    ...
    if ((_SigNum === 8)) {
      for (/* cond: (local_c < (DAT_0063af84 + DAT_0063af80)) */); local_c = (local_c < (DAT_0063af84 + DAT_0063af80)); local_c = (local_c + 1)) {
...

 {
  ...
  if ((DAT_0063b260 === 0)) {
    ...
    if ((hModule !== 0)) {
      wv(DAT_0063b260, FUN_006e7c2c(hModule, 0x61eb48));
      if ((FUN_006e7c2c(hModule, 0x61eb48) !== 0)) {
        wv(DAT_0063b264, FUN_006e7c2c(hModule, 0x61eb38));
        wv(DAT_0063b268, FUN_006e7c2c(hModule, 0x61eb24));
        goto LAB_006009b5;
      }
    }
    iVar1 = 0;
...

 {
  ...
  wv(DAT_006e55ac, FUN_006e7b7c(__CxxUnhandledExceptionFilter));
  return;
}
...

 {
  ...
  do {
    ...
    if ((s32(DAT_006e69f0, local_10) === 0)) {
      ...
      for (/* cond: (local_8 < (s32(DAT_006e69f0, local_10) + 0x100)) */); local_8 = (local_8 < (s32(DAT_006e69f0, local_10) + 0x100)); local_8 = (local_8 + 2)) {
        _MEM[(local_8 + 1)] = 0;
        w32(local_8, 0, -1);
        _MEM[(local_8 + 5)] = 0xa;
      }
    ...
    for (/* cond: (local_8 < (s32(DAT_006e69f0, local_10) + 0x100)) */);
...

 {
  ...
  local_8 = 0;
  for (/* cond: (local_c < DAT_006e69e0) */); local_c = (local_c < DAT_006e69e0); local_c = (local_c + 1)) {
...

 {
  ...
  _MEM[_Buf] = 0x30;
  pcVar1 = _Buf;
  for (/* cond: (0 < _SizeInBytes) */); local_8 = (pcVar1 + 1), 0 = (0 < _SizeInBytes); _SizeInBytes = (_SizeInBytes - 1)) {
    if ((_MEM[local_c] === 0)) {
      _MEM[pcVar1 + 1] = 0x30;
    }
    else {
      _MEM[pcVar1 + 1] = _MEM[local_c];
      local_c = (local_c + 1);
    }
    pcVar1 = local_8;
  }
  ...
  if ((0x34 < _MEM[local_c])) {
    for (/* cond: (_MEM[local_8] === 0x39) */); local_8 = _MEM[local_8]; local_8 = (local_8 + -1)) {
      _MEM[local_8] = 0x30;
    }
...

 {
  if ((DAT_0063b36c === 0)) {
    __tzset();
    wv(DAT_0063b36c, (DAT_0063b36c + 1));
  }
  return;
}
...

 {
  ...
  if ((_Str1 === 0)) {
    ...
    if ((DVar2 !== 0)) {
      wv(DAT_006e55e0, 1);
      wv(DAT_0063b2b0, DAT_006e55e8 * 0x3c);
      if ((DAT_006e562e !== 0)) {
        wv(DAT_0063b2b0, (DAT_006e55e8 * 0x3c + DAT_006e563c * 0x3c));
      }
      if ((DAT_006e5690 === 0)) {
        wv(DAT_0063b2b4, 0);
        wv(DAT_0063b2b8, 0);
        ...
        wv(DAT_0063b2b4, 1);
        wv(DAT_0063b2b8, (DAT_006e5690 - DAT_006e563c) * 0x3c);
      }
    ...
    if ((__malloc_dbg((sVar4 + 1), uVar6, pcVar7, uVar8) !== 0)) {
      ...
      for (/* cond: (_MEM[local_c] < 0x3a) */); (local_c = _MEM[local_c] || (('/' = (0x2f < _MEM[local_c]) && (local_c = _MEM[local_c])))); local_c = (local_c + 1)) {
      }
      if ((_MEM[local_c] === 0x3a)) {
        local_c = (local_c + 1);
        lVar5 = _atol(local_c);
        wv(DAT_0063b2b0, (lVar5 * 0xe10 + lVar5 * 0x3c));
        for (/* cond: (_MEM[local_c] < 0x3a) */); ('/' = (0x2f < _MEM[local_c]) && (local_c = _MEM[local_c])); local_c = (local_c + 1)) {
        }
        if ((_MEM[local_c] === 0x3a)) {
          local_c = (local_c + 1);
          lVar5 = _atol(local_c);
          wv(DAT_0063b2b0, ((lVar5 * 0xe10 + lVar5 * 0x3c) + lVar5));
          for (/* cond: (_MEM[local_c] < 0x3a) */); ('/' = (0x2f < _MEM[local_c]) && (local_c = _MEM[local_c])); local_c = (local_c + 1)) {
          }
        }
      }
      if ((cVar1 === 0x2d)) {
        wv(DAT_0063b2b0, (-DAT_0063b2b0));
      }
      wv(DAT_0063b2b4, s8(_MEM[local_c]));
...

 {
  ...
  if ((param_1 === 1)) {
    ...
    wv(DAT_0063b358, (((param_8 * 0x3c + param_9) * 0x3c + param_10) * 0x3e8 + param_11));
    wv(DAT_0063b350, param_3);
  }
  else {
    wv(DAT_0063b364, local_c);
    wv(DAT_0063b368, ((((param_8 * 0x3c + param_9) * 0x3c + param_10) * 0x3e8 + param_11) + DAT_0063b2b8 * 0x3e8));
    if ((((((param_8 * 0x3c + param_9) * 0x3c + param_10) * 0x3e8 + param_11) + DAT_0063b2b8 * 0x3e8) < 0)) {
      wv(DAT_0063b368, (((((param_8 * 0x3c + param_9) * 0x3c + param_10) * 0x3e8 + param_11) + DAT_0063b2b8 * 0x3e8) + 0x5265bff));
    }
...

 {
  ...
  if ((param_1 === 0)) {
    ...
    if ((0 < param_4)) {
      ...
      if ((local_30 < 0)) {
        for (/* cond: (0 < local_78) */); 0 = (0 < local_78); local_78 = (local_78 - 1)) {
          ___shr_12(DAT_ffffffc4);
        }
      }
      local_8 = (param_6 + 2);
      for (/* cond: (0 < local_14) */); 0 = (0 < local_14); local_14 = (local_14 + -1)) {
      ...
      local_8 = (local_8 + -1);
      if ((_MEM[pcVar1] < 0x35)) {
        for (/* cond: (((s16(local_8, 0)) & 0xFF) === 0x30) */); (param_6 = (param_6 + 2) && (local_8 = s16(local_8, 0)));
            local_8 = (local_8 + -1)) {
        }
        ...
        for (/* cond: (((s16(local_8, 0)) & 0xFF) === 0x39) */); (param_6 = (param_6 + 2) && (local_8 = s16(local_8, 0)));
            local_8 = (local_8 + -1)) {
          _MEM[local_8] = 0x30;
        }
        if ((local_8 < (param_6 + 2))) {
...

 {
  ...
  if ((_MaxCount !== 0)) {
    ...
    if ((_Dest === 0)) {
      ...
      for (/* cond: (local_8 < _MaxCount) */); local_8 = (local_8 < _MaxCount); local_8 = (local_8 + 1)) {
        if ((0xff < s16(_Source, 0))) {
          wv(DAT_00639f14, 0x2a);
          return -1;
        }
        _MEM[_Dest + local_8] = ((s16(_Source, 0)) & 0xFF);
        if ((s16(_Source, 0) === 0)) {
          return local_8;
        }
        _Source = (_Source + 1);
      ...
      if ((local_18 !== 0)) {
        if ((DVar4 === 0x7a)) {
          while ((local_8 < _MaxCount)) {
            ...
            for (/* cond: (local_c < local_14) */); local_c = (local_c < local_14); local_c = (local_c + 1)) {
              _MEM[_Dest + local_8] = _MEM[DAT_fffffff0 + local_c];
...

 {
  ...
  local_c = (param_2 + 1);
  for (/* cond: (s16(local_8, 0) !== 0) */); (local_c = (local_c + -1), local_c = (local_c !== 0) && (local_8 = s16(local_8, 0)));
      local_8 = (local_8 + 1)) {
  }
  if ((s16(local_8, 0) === 0)) {
...

 {
  ...
  if ((_VarName !== 0)) {
    ...
    for (/* cond: (s32(local_c, 0) !== 0) */); local_c = s32(local_c, 0); local_c = (local_c + 1)) {
  ...
  if ((local_38 < 0xbffe)) {
    if ((local_38 < 0x3fc0)) {
      ...
      for (/* cond: (local_24 < 5) */); local_24 = (local_24 < 5); local_24 = (local_24 + 1)) {
        local_2c = local_24 * 2;
        local_c = 8;
        for (/* cond: (0 < local_3c) */); 0 = (0 < local_3c); local_3c = (local_3c + -1)) {
      ...
      if ((local_38 < 1)) {
        for (/* cond: (local_38 < 0) */); local_38 = local_38; local_38 = (local_38 + 1)) {
          if (((UNNAMED & 1) !== 0)) {
            local_8 = (local_8 + 1);
          }
  ...
  if ((DAT_0063b6a0 === 2)) {
    ...
    if ((_LpString2 === 0)) {
      ...
      if ((0 < _LpString1)) {
        ...
        while ((_MEM[_DwCmpFlags] <= _MEM[local_30 + 1])) {
          if ((_MEM[local_30 + 1] === 0)) {
            return 3;
          }
          if ((_MEM[_DwCmpFlags] <= _MEM[local_30 + 1]));
        }
        return 2;
      }
      if ((0 < _LpString2)) {
        ...
        local_30 = DAT_00000006;
        while ((_MEM[_CchCount1] <= _MEM[local_30 + 1])) {
          if ((_MEM[local_30 + 1] === 0)) {
            return 1;
          }
          if ((_MEM[_CchCount1] <= _MEM[local_30 + 1]));
        }
        return 2;
      }
    }
    local_8 = FUN_006e7c58(_CchCount2, 9, _DwCmpFlags, _LpString1, 0, 0);
    if ((local_8 === 0)) {
      local_18 = 0;
    }
    else {
...

 {
  ...
  if ((DAT_00639f40 === DAT_00639f3c)) {
    wv(DAT_00639f3c, copy_environ(DAT_00639f3c));
  }
  if ((DAT_00639f3c === 0)) {
    if ((DAT_00639f44 === 0)) {
      if (bVar5) {
      ...
      wv(DAT_00639f3c, __malloc_dbg(4, 2, 0x61ec88, 0x87));
      if ((__malloc_dbg(4, 2, 0x61ec88, 0x87) === 0)) {
        return -1;
      }
      w32(__malloc_dbg(4, 2, 0x61ec88, 0x87), 0, 0);
      if ((DAT_00639f44 === 0)) {
        wv(DAT_00639f44, __malloc_dbg(4, 2, 0x61ec88, 0x8e));
  ...
  if ((s32(piVar3, 0) === 0)) {
    ...
    for (/* cond: (s32(piVar3, local_c) !== 0) */); piVar3 = (piVar3 + local_c); local_c = (local_c + 1)) {
...

 {
  ...
  if ((param_1 === 0)) {
    ...
    piVar1 = __malloc_dbg((local_14 * 4 + 4), 2, 0x61ec88, 0x146);
    if ((piVar1 === 0)) {
      __amsg_exit(9);
    }
    local_c = piVar1;
    for (/* cond: (s32(local_10, 0) !== 0) */); local_10 = s32(local_10, 0); local_10 = (local_10 + 1)) {
      uVar6 = 0x14f;
      pcVar5 = 0x61ec88;
      uVar4 = 2;
  ...
  if ((DAT_0063b0a4 === 0)) {
    ...
    while ((uVar3 === 0)) {
      ...
      if ((uVar3 === 0)) {
        ...
        if ((((((bVar2 << 8) | _MEM[_Str + 1])) & 0xFFFF) === _Ch)) {
          return _Str;
        }
      }
      _Str = puVar1;
