...
import { _MEM, s8, u8, s16, u16, s32, u32, w16, w32, w16r, w32r } from '../mem.js';
...

 {
  ...
  local_c8 = param_2;
  if ((local_c8 < 0));
  local_90 = u8(DAT_006560f6[local_c8 * 0x20]);
  local_94 = local_90;
  if ((local_d4 === 0)) {
    local_94 = 0x3e;
  }
...

 {
  ...
  for (/* cond: (s32((DAT_006ad354 + local_8 * 0x54), 0) !== param_1) */); (local_8 = (local_8 < 7) && (DAT_006ad354 = DAT_006ad354));
      local_8 = (local_8 + 1)) {
  }
  return local_8;
}
