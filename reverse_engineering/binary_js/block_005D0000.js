...
export function FUN_005d1f50(param_1, param_2, param_3) {
  ...
  // DEVIATION: Win32 — if (DAT_00637ef4 == 0) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — DAT_00637ef4 = local_18;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_8 = 0xffffffff;
...
export function register_wndclass_2740(param_1, param_2, param_3, param_4) {
  ...
  // DEVIATION: Win32 — if (DAT_00638314 == 0) {
  // DEVIATION: Win32 — pvVar8 = (LPVOID)0x0;
  // DEVIATION: Win32 — pHVar6 = (HMENU)0x0;
  // DEVIATION: Win32 — pHVar7 = DAT_006e4ff0;
  ...
  // DEVIATION: Win32 — local_c = CreateWindowExA(4,&DAT_0063831c,&DAT_00638318,local_8,*param_1,param_1[1],iVar2,iVar1,
  // DEVIATION: Win32 — pHVar5,pHVar6,pHVar7,pvVar8);
  // DEVIATION: Win32 — DAT_006e47dc = (WNDPROC)GetWindowLongA(local_c,-4);
  // DEVIATION: Win32 — local_34.style = 0x88;
  // DEVIATION: Win32 — local_34.cbClsExtra = 0;
  // DEVIATION: Win32 — local_34.lpfnWndProc = DAT_006e47dc;
  // DEVIATION: Win32 — DAT_006e47d8 = GetClassLongA(local_c,-0x12);
  // DEVIATION: Win32 — local_34.cbWndExtra = DAT_006e47d8 + 8;
  // DEVIATION: Win32 — local_34.hInstance = DAT_006e4ff0;
  ...
  // DEVIATION: Win32 — DAT_00638314 = 1;
  ...
  // DEVIATION: Win32 — iVar1 = thunk_FUN_00407fc0(param_1);
  // DEVIATION: Win32 — iVar2 = thunk_FUN_00407f90(param_1);
  // DEVIATION: Win32 — local_c = CreateWindowExA(4,s_MSEditBoxClass_00638338,&DAT_00638334,local_8 | 0x40800000,*param_1,
  ...
  // DEVIATION: Win32 — SetWindowLongA(local_c,DAT_006e47d8,(LONG)DAT_006e47dc);
  // DEVIATION: Win32 — SetWindowLongA(local_c,DAT_006e47d8 + 4,param_2);
...
export function register_wndclass_3130(param_1, param_2, param_3) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if (DAT_00638348 == 0) {
  // DEVIATION: Win32 — pvVar6 = (LPVOID)0x0;
  // DEVIATION: Win32 — pHVar4 = (HMENU)0x0;
  // DEVIATION: Win32 — pHVar5 = DAT_006e4ff0;
  // DEVIATION: Win32 — thunk_FUN_0040f810();
  // DEVIATION: Win32 — iVar1 = thunk_FUN_00414d10();
  // DEVIATION: Win32 — pHVar3 = *(HWND *)(iVar1 + 4);
  // DEVIATION: Win32 — iVar1 = thunk_FUN_00407fc0(param_1);
  // DEVIATION: Win32 — iVar2 = thunk_FUN_00407f90(param_1);
  // DEVIATION: Win32 — local_8 = CreateWindowExA(4,s_COMBOBOX_00638350,&DAT_0063834c,local_34,*param_1,param_1[1],iVar2
  // DEVIATION: Win32 — ,iVar1,pHVar3,pHVar4,pHVar5,pvVar6);
  // DEVIATION: Win32 — DAT_006e47ec = (WNDPROC)GetWindowLongA(local_8,-4);
  // DEVIATION: Win32 — local_30.style = 0x88;
  // DEVIATION: Win32 — local_30.cbClsExtra = 0;
  // DEVIATION: Win32 — local_30.lpfnWndProc = DAT_006e47ec;
  // DEVIATION: Win32 — DAT_006e47e4 = GetClassLongA(local_8,-0x12);
  // DEVIATION: Win32 — local_30.cbWndExtra = DAT_006e47e4 + 8;
  // DEVIATION: Win32 — local_30.hInstance = DAT_006e4ff0;
  ...
  // DEVIATION: Win32 — DAT_00638348 = 1;
  ...
  // DEVIATION: Win32 — iVar1 = thunk_FUN_00407fc0(param_1);
  // DEVIATION: Win32 — iVar2 = thunk_FUN_00407f90(param_1);
  // DEVIATION: Win32 — local_8 = CreateWindowExA(4,s_MSComboBoxClass_00638370,&DAT_0063836c,local_34,*param_1,param_1[1],
  // DEVIATION: Win32 — iVar2,iVar1,pHVar3,pHVar4,pHVar5,pvVar6);
  // DEVIATION: Win32 — SetWindowLongA(local_8,-4,0x5d3310);
  // DEVIATION: Win32 — SetWindowLongA(local_8,DAT_006e47e4,(LONG)DAT_006e47ec);
  // DEVIATION: Win32 — SetWindowLongA(local_8,DAT_006e47e4 + 4,param_2);
  // DEVIATION: Win32 — return local_8;
}
...
export function send_msg_3654(param_1, param_2) {
  ...
  // DEVIATION: Win32 — FUN_005f22d0(param_2,&DAT_00638380);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
...
export function register_wndclass_37A0(param_1, param_2, param_3, param_4) {
  ...
  // DEVIATION: Win32 — if (DAT_00638384 == 0) {
  // DEVIATION: Win32 — pvVar9 = (LPVOID)0x0;
  // DEVIATION: Win32 — pHVar7 = (HMENU)0x0;
  // DEVIATION: Win32 — pHVar8 = DAT_006e4ff0;
  // DEVIATION: Win32 — thunk_FUN_0040f810();
  ...
  // DEVIATION: Win32 — local_8 = CreateWindowExA(4,s_LISTBOX_0063838c,&DAT_00638388,local_38,*param_1,param_1[1],iVar3,
  // DEVIATION: Win32 — iVar2,pHVar6,pHVar7,pHVar8,pvVar9);
  // DEVIATION: Win32 — DAT_006e47f0 = (WNDPROC)GetWindowLongA(local_8,-4);
  // DEVIATION: Win32 — local_30.style = 0x88;
  // DEVIATION: Win32 — local_30.cbClsExtra = 0;
  // DEVIATION: Win32 — local_30.lpfnWndProc = DAT_006e47f0;
  // DEVIATION: Win32 — DAT_006e47f4 = GetClassLongA(local_8,-0x12);
  // DEVIATION: Win32 — local_30.cbWndExtra = DAT_006e47f4 + 8;
  // DEVIATION: Win32 — local_30.hInstance = DAT_006e4ff0;
  // DEVIATION: Win32 — local_30.hIcon = (HICON)0x0;
  // DEVIATION: Win32 — local_30.hCursor = LoadCursorA((HINSTANCE)0x0,(LPCSTR)0x7f00);
  // DEVIATION: Win32 — local_30.hbrBackground = (HBRUSH)0x0;
  ...
  // DEVIATION: Win32 — RegisterClassA(&local_30);
  // DEVIATION: Win32 — DAT_00638384 = 1;
  // DEVIATION: Win32 — DestroyWindow(local_8);
  // DEVIATION: Win32 — }
  ...
  // DEVIATION: Win32 — iVar2 = thunk_FUN_00407fc0(param_1);
  // DEVIATION: Win32 — iVar3 = thunk_FUN_00407f90(param_1);
  // DEVIATION: Win32 — local_8 = CreateWindowExA(4,s_MSListBoxClass_006383a8,&DAT_006383a4,local_38,*param_1,param_1[1],
  ...
  // DEVIATION: Win32 — SetWindowLongA(local_8,DAT_006e47f4,(LONG)DAT_006e47f0);
  // DEVIATION: Win32 — SetWindowLongA(local_8,DAT_006e47f4 + 4,param_2);
  // DEVIATION: Win32 — return local_8;
}
...
export function send_msg_3D62(param_1, param_2) {
  ...
  // DEVIATION: Win32 — if (LVar1 == -1) {
  // DEVIATION: Win32 — FUN_005f22d0(param_2,&DAT_006383b8);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
...
export function create_window_423C(param_1) {
  ...
  // DEVIATION: Win32 — DAT_006e4804 = LoadLibraryA(s_timerdll_dll_006383c0);
  // DEVIATION: Win32 — if (DAT_006e4804 == (HMODULE)0x0) {
  // DEVIATION: Win32 — local_8 = CreateWindowExA(0,s_MSMrTimerClass_006384a4,s_MrTimer_0063849c,0xcf0000,-0x80000000,
  // DEVIATION: Win32 — -0x80000000,-0x80000000,-0x80000000,(HWND)0x0,(HMENU)0x0,DAT_006e4ff0,
  // DEVIATION: Win32 — (LPVOID)0x0);
  // DEVIATION: Win32 — if (local_8 != (HWND)0x0) {
  // DEVIATION: Win32 — SetWindowLongA(local_8,0,param_1);
  // DEVIATION: Win32 — DAT_006383bc = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — DAT_006e4808 = GetProcAddress(DAT_006e4804,s_TimerCallBack_006383d0);
  // DEVIATION: Win32 — DAT_006e4810 = GetProcAddress(DAT_006e4804,s_SetTimerID_006383e0);
  // DEVIATION: Win32 — DAT_006e47fc = GetProcAddress(DAT_006e4804,s_GetTimerID_006383ec);
  // DEVIATION: Win32 — DAT_006e4800 = GetProcAddress(DAT_006e4804,s_GetTimerIndex_006383f8);
  // DEVIATION: Win32 — DAT_006e480c = GetProcAddress(DAT_006e4804,s_ResetTimerNotified_00638408);
  // DEVIATION: Win32 — if ((((DAT_006e4808 == (FARPROC)0x0) || (DAT_006e4810 == (FARPROC)0x0)) ||
  // DEVIATION: Win32 — (DAT_006e47fc == (FARPROC)0x0)) ||
  // DEVIATION: Win32 — ((DAT_006e4800 == (FARPROC)0x0 || (DAT_006e480c == (FARPROC)0x0)))) {
  // DEVIATION: Win32 — FUN_005dae6b(9,s_ERR_DYNAMICLINKFAILED_00638438,s_D__Ss_Smeds32_Pctimer_cpp_0063841c,0x55);
  // DEVIATION: Win32 — FreeLibrary(DAT_006e4804);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  ...
  // DEVIATION: Win32 — DAT_006e4ff0,(LPVOID)0x0);
  // DEVIATION: Win32 — if (local_8 == (HWND)0x0) {
  ...
  // DEVIATION: Win32 — SetWindowLongA(local_8,0,param_1);
  // DEVIATION: Win32 — uTimerID = timeSetEvent(100,5,DAT_006e4808,(DWORD_PTR)local_8,1);
...
export function manage_window_447C(param_1) {
  ...
  // DEVIATION: Win32 — DAT_006e4808 = 0;
  // DEVIATION: Win32 — FreeLibrary(DAT_006e4804);
  // DEVIATION: Win32 — }
}
...
export function FUN_005d4664(param_1, param_2) {
  ...
  // DEVIATION: Win32 — if (DAT_006383bc == 0) {
  // DEVIATION: Win32 — if (DAT_00637ef8 == 0) {
  // DEVIATION: Win32 — KillTimer(param_1,param_2);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — UVar1 = (*DAT_006e47fc)(param_2);
  // DEVIATION: Win32 — timeKillEvent(UVar1);
  // DEVIATION: Win32 — (*DAT_006e4810)(param_2,0);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if (DAT_00637ef8 == 0) {
  // DEVIATION: Win32 — UVar1 = (*DAT_006e47fc)(param_2);
  // DEVIATION: Win32 — timeKillEvent(UVar1);
  // DEVIATION: Win32 — (*DAT_006e4810)(param_2,0);
  // DEVIATION: Win32 — }
...
export function FUN_005d4700(param_1, param_2, param_3, param_4) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — FUN_005d47d0(param_3);
  // DEVIATION: Win32 — (*DAT_006e480c)(param_3);
  // DEVIATION: Win32 — }
...
export function FUN_005d48f0(param_1, param_2, param_3) {
  // DEVIATION: Win32 — DAT_0063857c = param_1;
  // DEVIATION: Win32 — DAT_00638580 = param_2;
  // DEVIATION: Win32 — DAT_00638584 = param_3;
  // DEVIATION: Win32 — DAT_00638588 = param_3;
  // DEVIATION: Win32 — iVar1 = FUN_005d4a11(param_1,0,&DAT_00638578);
  // DEVIATION: Win32 — if (iVar1 == 0) {
  // DEVIATION: Win32 — FUN_005d645e(param_2,DAT_00638578,param_3);
...
export function FUN_005d4a11(param_1, param_2, param_3) {
  ...
  // DEVIATION: Win32 — if (DAT_006385b0 == 0) {
  // DEVIATION: Win32 — if (param_2 != (undefined4 *)0x0) {
  // DEVIATION: Win32 — DAT_006385a0 = *param_2;
  // DEVIATION: Win32 — DAT_006385a4 = param_2[1];
  // DEVIATION: Win32 — DAT_006385a8 = param_2[2];
  // DEVIATION: Win32 — DAT_006385ac = param_2[3];
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — UVar2 = waveOutGetNumDevs();
  // DEVIATION: Win32 — for (local_10 = 0; (int)local_10 < (int)UVar2; local_10 = local_10 + 1) {
  // DEVIATION: Win32 — waveOutGetDevCapsA(local_10,(LPWAVEOUTCAPSA)&DAT_006e4818,0x34);
  // DEVIATION: Win32 — if ((DAT_006e4840 & 0x20) != 0) {
  // DEVIATION: Win32 — bVar1 = false;
  // DEVIATION: Win32 — local_14 = local_10;
  // DEVIATION: Win32 — break;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if ((DAT_006e4840 & 0x10) != 0) {
  // DEVIATION: Win32 — local_14 = local_10;
  ...
  // DEVIATION: Win32 — DAT_006385a0 = CONCAT22(1,(undefined2)DAT_006385a0);
  // DEVIATION: Win32 — DAT_006385a8 = 0x5622;
  // DEVIATION: Win32 — DAT_006385ac = CONCAT22(DAT_006385ac._2_2_,1);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_8 = waveOutOpen((LPHWAVEOUT)&DAT_00638578,local_14,(LPCWAVEFORMATEX)&DAT_006385a0,
  ...
  // DEVIATION: Win32 — if ((local_8 == 0) && (DAT_006385b0 = 1, param_3 != (undefined4 *)0x0)) {
  // DEVIATION: Win32 — *param_3 = DAT_00638578;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
...
export function FUN_005d4bcb(param_1) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — DAT_006385b0 = 0;
  // DEVIATION: Win32 — return local_8;
}
...
export function FUN_005d4c5f(param_1, param_2, param_3, param_4) {
  ...
  // DEVIATION: Win32 — local_84.cchBuffer = DAT_006385cc;
  ...
  // DEVIATION: Win32 — if (DAT_006385d0 == (FOURCC *)0x0) {
  // DEVIATION: Win32 — DAT_006385d0 = local_34;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — for (local_3c = DAT_006385d0; local_3c[0x2e] != 0;
...
export function FUN_005d4f6a(param_1, param_2, param_3) {
  ...
  // DEVIATION: Win32 — local_88.cchBuffer = DAT_006385cc;
  ...
  // DEVIATION: Win32 — if (DAT_006385d0 == (FOURCC *)0x0) {
  // DEVIATION: Win32 — DAT_006385d0 = local_38;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — for (local_40 = DAT_006385d0; local_40[0x2e] != 0;
...
export function FUN_005d52a2(param_1) {
  ...
  // DEVIATION: Win32 — if (DAT_00638578 == 0) {
  // DEVIATION: Win32 — uVar1 = 3;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if (param_1 == 0) {
  // DEVIATION: Win32 — uVar1 = 0xc;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if ((DAT_006385d0 == (undefined4 *)0x0) || (*(short *)(DAT_006385d0 + 0x22) != 4)) {
  ...
  // DEVIATION: Win32 — if (DAT_006385a0._2_2_ == 1) {
  ...
  // DEVIATION: Win32 — local_10c.cchBuffer = DAT_006385cc * 2;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if ((local_8 & 0xffff) == 3) {
  // DEVIATION: Win32 — local_10c.cchBuffer = DAT_006385cc >> 1;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — local_10c.cchBuffer = DAT_006385cc;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_a8 = (uint)local_10c.cchBuffer / DAT_00638584;
  ...
  // DEVIATION: Win32 — local_b4[0x2a] = local_b4[0x2a] + 1;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_b4[0x2e] = DAT_006385d0;
  // DEVIATION: Win32 — DAT_006385d0 = local_b4;
  // DEVIATION: Win32 — DAT_0063858c = DAT_0063858c + 1;
  // DEVIATION: Win32 — uVar1 = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
...
export function FUN_005d5643() {
  ...
  // DEVIATION: Win32 — if (DAT_006385b0 != 0) {
  // DEVIATION: Win32 — waveOutGetPosition(DAT_00638578,&local_10,0xc);
  // DEVIATION: Win32 — }
...
export function FUN_005d5706() {
  ...
  // DEVIATION: Win32 — local_10.u.ms = local_10.u.ms / (ushort)DAT_006385ac;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — local_10.u.ms = 0;
  // DEVIATION: Win32 — }
...
export function FUN_005d57b1(param_1) {
  // DEVIATION: Win32 — iVar1 = DAT_006385d0;
  // DEVIATION: Win32 — if (DAT_00638578 == 0) {
  // DEVIATION: Win32 — uVar2 = 3;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if (DAT_006385bc == 0) {
  // DEVIATION: Win32 — uVar2 = 0xe;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if ((DAT_006385d0 == 0) || (*(short *)(DAT_006385d0 + 0x88) != 4)) {
  // DEVIATION: Win32 — uVar2 = 5;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if ((*(byte *)(DAT_006385d0 + 0x70) & 1) == 0) {
  // DEVIATION: Win32 — if ((*(uint *)(*(int *)(DAT_006385d0 + 0x98) + 0xc) >> 3 & 1) == 0) {
  // DEVIATION: Win32 — if (((*(uint *)(*(int *)(DAT_006385d0 + 0x98) + 0xc) >> 7) -
  // DEVIATION: Win32 — (*(uint *)(DAT_006385c8 + 0xc) >> 7) & 7) == 0) {
  // DEVIATION: Win32 — param_1 = (uint)(*(int *)(DAT_006385d0 + 0x9c) - *(int *)(DAT_006385d0 + 0x68)) /
  // DEVIATION: Win32 — (uint)*(ushort *)(DAT_006385d0 + 0x80);
  // DEVIATION: Win32 — _DAT_00638594 = _DAT_00638594 + 1;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_c = *(int *)(DAT_006385d0 + 0x98);
  // DEVIATION: Win32 — uVar3 = (*(int *)(DAT_006385d0 + 0x3c) - *(int *)(DAT_006385d0 + 0x34)) /
  // DEVIATION: Win32 — (int)(uint)*(ushort *)(DAT_006385d0 + 0x80);
  // DEVIATION: Win32 — if (uVar3 < param_1) {
  // DEVIATION: Win32 — param_1 = uVar3;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_24 = *(ushort *)(DAT_006385d0 + 0x80) * param_1;
  // DEVIATION: Win32 — uVar3 = *(int *)(DAT_006385d0 + 0x9c) - *(int *)(DAT_006385d0 + 0x68);
  // DEVIATION: Win32 — _DAT_00638598 = param_1;
  // DEVIATION: Win32 — if (uVar3 < local_24) {
  // DEVIATION: Win32 — local_24 = uVar3;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — uVar3 = *(int *)(DAT_006385d0 + 8) -
  // DEVIATION: Win32 — (*(int *)(DAT_006385d0 + 0x90) - *(int *)(DAT_006385d0 + 0x94));
  // DEVIATION: Win32 — if (uVar3 < local_24) {
  // DEVIATION: Win32 — local_24 = uVar3;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_8 = 0;
  // DEVIATION: Win32 — AVIStreamRead(*(undefined4 *)(DAT_006385d0 + 0x84),
  // DEVIATION: Win32 — *(uint *)(DAT_006385d0 + 0x90) / (uint)*(ushort *)(DAT_006385d0 + 0x80),
  // DEVIATION: Win32 — local_24 / *(ushort *)(DAT_006385d0 + 0x80),*(undefined4 *)(DAT_006385d0 + 0x34)
  // DEVIATION: Win32 — ,local_24,&local_8,0);
  // DEVIATION: Win32 — *(int *)(DAT_006385d0 + 0x90) = *(int *)(DAT_006385d0 + 0x90) + local_8;
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — *(int *)(DAT_006385d0 + 0x68) = *(int *)(DAT_006385d0 + 0x68) + local_8;
  // DEVIATION: Win32 — if (*(uint *)(DAT_006385d0 + 0x9c) <= *(uint *)(DAT_006385d0 + 0x68)) {
  // DEVIATION: Win32 — *(uint *)(local_c + 0xc) = *(uint *)(local_c + 0xc) | 8;
  // DEVIATION: Win32 — *(undefined4 *)(DAT_006385d0 + 0x98) = *(undefined4 *)(local_c + 0x1c);
  // DEVIATION: Win32 — local_c = *(int *)(DAT_006385d0 + 0x98);
  // DEVIATION: Win32 — *(undefined4 *)(DAT_006385d0 + 0x68) = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if (*(uint *)(DAT_006385d0 + 8) <=
  // DEVIATION: Win32 — (uint)(*(int *)(DAT_006385d0 + 0x90) - *(int *)(DAT_006385d0 + 0x94))) {
  // DEVIATION: Win32 — for (local_20 = 0;
  // DEVIATION: Win32 — local_20 < (uint)(*(int *)(DAT_006385d0 + 0x9c) - *(int *)(DAT_006385d0 + 0x68));
  ...
  // DEVIATION: Win32 — *(undefined4 *)(DAT_006385d0 + 0x98) = *(undefined4 *)(local_c + 0x1c);
  // DEVIATION: Win32 — *(undefined4 *)(DAT_006385d0 + 0x68) = 0;
  // DEVIATION: Win32 — *(uint *)(DAT_006385d0 + 0x70) = *(uint *)(DAT_006385d0 + 0x70) | 1;
  // DEVIATION: Win32 — }
...
export function FUN_005d5b88() {
  // DEVIATION: Win32 — DAT_006385bc = 0;
  // DEVIATION: Win32 — if ((DAT_006385d0 == 0) || (*(short *)(DAT_006385d0 + 0x88) != 4)) {
  // DEVIATION: Win32 — uVar1 = 5;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — DAT_006385d0 = FUN_005d7494(0,DAT_006385d0);
  // DEVIATION: Win32 — uVar1 = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — return uVar1;
}
...
export function FUN_005d5bec(param_1) {
  ...
  // DEVIATION: Win32 — uVar1 = *(int *)(DAT_006385d0 + 8) -
  // DEVIATION: Win32 — (*(int *)(DAT_006385d0 + 0x90) - *(int *)(DAT_006385d0 + 0x94));
...
export function FUN_005d5d11(param_1, param_2, param_3) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — if (DAT_00638588 != DAT_00638584) {
  // DEVIATION: Win32 — FUN_005d687b(DAT_00638584);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — iVar2 = AVIStreamTimeToSample(*(undefined4 *)(DAT_006385d0 + 0x84),param_1);
  // DEVIATION: Win32 — local_10 = AVIStreamTimeToSample(*(undefined4 *)(DAT_006385d0 + 0x84),param_2);
  // DEVIATION: Win32 — local_10 = (uint)*(ushort *)(DAT_006385d0 + 0x80) * local_10;
  // DEVIATION: Win32 — iVar2 = (uint)*(ushort *)(DAT_006385d0 + 0x80) * iVar2;
  // DEVIATION: Win32 — if (local_10 == 0) {
  // DEVIATION: Win32 — local_10 = *(int *)(DAT_006385d0 + 8) - iVar2;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  ...
  // DEVIATION: Win32 — *(int *)(DAT_006385d0 + 8) = local_10;
  // DEVIATION: Win32 — *(int *)(DAT_006385d0 + 0x90) = iVar2;
  // DEVIATION: Win32 — *(int *)(DAT_006385d0 + 0x94) = iVar2;
  // DEVIATION: Win32 — *(undefined4 *)(DAT_006385d0 + 100) = 0;
  // DEVIATION: Win32 — *(undefined4 *)(DAT_006385d0 + 0x68) = 0;
  // DEVIATION: Win32 — *(undefined4 *)(DAT_006385d0 + 0x34) = *(undefined4 *)(DAT_006385d0 + 0x3c);
  // DEVIATION: Win32 — FUN_005d5bec(DAT_006385d0);
  // DEVIATION: Win32 — *(uint *)(DAT_006385d0 + 0x70) = *(uint *)(DAT_006385d0 + 0x70) & 0xfffffffd;
  // DEVIATION: Win32 — *(uint *)(DAT_006385d0 + 0x70) = *(uint *)(DAT_006385d0 + 0x70) & 0xfffffffe;
  // DEVIATION: Win32 — *(undefined4 *)(DAT_006385d0 + 0x8c) = param_3;
  // DEVIATION: Win32 — DAT_006385bc = 0;
  // DEVIATION: Win32 — local_8 = DAT_006385c0;
  // DEVIATION: Win32 — for (local_c = 0; local_c < DAT_00638584; local_c = local_c + 1) {
  ...
  // DEVIATION: Win32 — local_8 = (undefined4 *)local_8[7];
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — DAT_006385c8 = DAT_006385c0;
  // DEVIATION: Win32 — uVar1 = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — return uVar1;
...
export function FUN_005d5f91() {
  // DEVIATION: Win32 — if ((DAT_006385d0 != 0) && (*(short *)(DAT_006385d0 + 0x88) == 4)) {
  // DEVIATION: Win32 — FUN_005d6947(DAT_006385c0);
  // DEVIATION: Win32 — *(uint *)(DAT_006385d0 + 0x70) = *(uint *)(DAT_006385d0 + 0x70) | 0x10;
  // DEVIATION: Win32 — if (*(int *)(DAT_006385d0 + 0x8c) != 0) {
  // DEVIATION: Win32 — **(ushort **)(DAT_006385d0 + 0x8c) = **(ushort **)(DAT_006385d0 + 0x8c) | 4;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — DAT_006385bc = 1;
  // DEVIATION: Win32 — *(undefined4 *)(DAT_006385d0 + 0x98) = DAT_006385c0;
}
...
export function FUN_005d6038(param_1, param_2, param_3, param_4) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if ((DAT_006385b0 == 0) &&
  // DEVIATION: Win32 — (iVar2 = FUN_005d48f0(DAT_0063857c,DAT_00638580,DAT_00638584), iVar2 != 0)) {
  // DEVIATION: Win32 — sVar1 = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if (DAT_0063858c < 5) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if ((sVar1 == 0) && (DAT_0063858c = DAT_0063858c + 1, ((uint)DAT_006385c8[3] >> 5 & 1) == 0)) {
  // DEVIATION: Win32 — local_10 = 0;
  // DEVIATION: Win32 — local_8 = DAT_006385c8;
  // DEVIATION: Win32 — while ((local_10 < DAT_00638588 && (iVar2 = FUN_005d717f(*local_8), iVar2 != 1))) {
  // DEVIATION: Win32 — local_8 = (undefined4 *)local_8[7];
  // DEVIATION: Win32 — local_10 = local_10 + 1;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — FUN_005d6947(DAT_006385c8);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — sVar1 = 0;
...
export function FUN_005d61ab(param_1) {
  // DEVIATION: Win32 — local_8 = 0;
  // DEVIATION: Win32 — local_c = DAT_006385d0;
...
export function FUN_005d645e(param_1, param_2, param_3) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if (local_14 == 0) {
  // DEVIATION: Win32 — DAT_006385c0 = local_8;
  // DEVIATION: Win32 — DAT_006385c8 = local_8;
  // DEVIATION: Win32 — }
  ...
  // DEVIATION: Win32 — local_10 = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_8[7] = (int)DAT_006385c0;
  // DEVIATION: Win32 — _DAT_006385b4 = 1;
  // DEVIATION: Win32 — DAT_006385cc = param_1;
  // DEVIATION: Win32 — }
...
export function FUN_005d6685(param_1) {
  // DEVIATION: Win32 — local_8 = DAT_006385c4;
  // DEVIATION: Win32 — *(uint *)(DAT_006385c4 + 0xc) = *(uint *)(DAT_006385c4 + 0xc) & 0xfffffffe;
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_c = DAT_006385c0;
  // DEVIATION: Win32 — for (local_10 = 0; local_10 < DAT_00638588 - 1U; local_10 = local_10 + 1) {
  // DEVIATION: Win32 — local_c = *(int *)(local_c + 0x1c);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — uVar1 = *(undefined4 *)(local_8 + 0x1c);
  // DEVIATION: Win32 — *(int *)(local_c + 0x1c) = DAT_006385c4;
  // DEVIATION: Win32 — DAT_006385c4 = uVar1;
  // DEVIATION: Win32 — *(int *)(local_8 + 0x1c) = DAT_006385c0;
  // DEVIATION: Win32 — DAT_00638588 = DAT_00638588 + param_1;
}
...
export function FUN_005d673a(param_1) {
  // DEVIATION: Win32 — local_8 = DAT_006385c0;
  // DEVIATION: Win32 — if ((uint)(DAT_00638588 - param_1) <= (*(uint *)(DAT_006385c8 + 0xc) >> 7 & 0xff)) {
  // DEVIATION: Win32 — DAT_006385c8 = DAT_006385c0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — for (local_14 = 0; local_14 < (int)((DAT_00638588 - param_1) - 1U); local_14 = local_14 + 1) {
  // DEVIATION: Win32 — local_8 = *(int *)(local_8 + 0x1c);
  // DEVIATION: Win32 — }
  ...
  // DEVIATION: Win32 — local_8 = *(int *)(local_8 + 0x1c);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — *(int *)(local_8 + 0x1c) = DAT_006385c4;
  // DEVIATION: Win32 — DAT_006385c4 = iVar1;
  // DEVIATION: Win32 — DAT_00638588 = DAT_00638588 - param_1;
}
...
export function FUN_005d687b(param_1) {
  // DEVIATION: Win32 — if ((DAT_00638578 != 0) &&
  // DEVIATION: Win32 — (((DAT_006385d0 == 0 || (*(short *)(DAT_006385d0 + 0x88) != 4)) ||
  // DEVIATION: Win32 — ((*(uint *)(DAT_006385d0 + 0x70) >> 1 & 1) != 0)))) {
  // DEVIATION: Win32 — if (DAT_00638584 < param_1) {
  // DEVIATION: Win32 — param_1 = DAT_00638584;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if ((int)param_1 < 2) {
  // DEVIATION: Win32 — param_1 = 2;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if (DAT_00638588 < param_1) {
  // DEVIATION: Win32 — FUN_005d6685(param_1 - DAT_00638588);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if (param_1 < DAT_00638588) {
  // DEVIATION: Win32 — FUN_005d673a(DAT_00638588 - param_1);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
}
...
export function FUN_005d6947(param_1) {
  ...
  // DEVIATION: Win32 — local_c = local_c + 1;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — MVar1 = waveOutWrite(DAT_00638578,(LPWAVEHDR)*param_1,0x20);
...
export function FUN_005d6a2c() {
  ...
  // DEVIATION: Win32 — local_14 = DAT_006385d0;
  // DEVIATION: Win32 — if (DAT_00638578 != (HWAVEOUT)0x0) {
  // DEVIATION: Win32 — waveOutReset(DAT_00638578);
  // DEVIATION: Win32 — while (BVar1 = PeekMessageA(&local_30,DAT_0063857c,0x3bd,0x3bd,1), BVar1 != 0) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_8 = DAT_006385c0;
  // DEVIATION: Win32 — if (DAT_006385c0 != 0) {
  // DEVIATION: Win32 — for (local_10 = 0; local_10 < DAT_00638588; local_10 = local_10 + 1) {
  // DEVIATION: Win32 — *(uint *)(local_8 + 0xc) = *(uint *)(local_8 + 0xc) & 0xffffffdf;
  // DEVIATION: Win32 — *(uint *)(local_8 + 0xc) = *(uint *)(local_8 + 0xc) & 0xffffffbf;
  // DEVIATION: Win32 — local_8 = *(int *)(local_8 + 0x1c);
  // DEVIATION: Win32 — }
...
export function FUN_005d6b89(param_1) {
  // DEVIATION: Win32 — piVar1 = DAT_006385c0;
  // DEVIATION: Win32 — local_8 = DAT_006385c0;
  // DEVIATION: Win32 — _DAT_006385b8 = 0;
  // DEVIATION: Win32 — if (DAT_006385b0 != 0) {
  ...
  // DEVIATION: Win32 — for (local_14 = 0; local_14 < DAT_00638584; local_14 = local_14 + 1) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — DAT_006385c0 = (int *)0x0;
  // DEVIATION: Win32 — do {
  // DEVIATION: Win32 — DAT_006385d0 = FUN_005d7494(0,DAT_006385d0);
  // DEVIATION: Win32 — } while (DAT_006385d0 != 0);
  // DEVIATION: Win32 — DAT_006385d0 = 0;
  // DEVIATION: Win32 — return local_c;
}
...
export function FUN_005d6c99(param_1, param_2) {
  ...
  // DEVIATION: Win32 — puVar2 = DAT_006385d0;
  // DEVIATION: Win32 — local_8 = (code *)0x0;
  // DEVIATION: Win32 — uVar1 = 0;
  // DEVIATION: Win32 — if (DAT_006385b0 != 0) {
  // DEVIATION: Win32 — local_20 = *(int **)(param_2 + 0xc);
  // DEVIATION: Win32 — local_2c = 0;
  // DEVIATION: Win32 — while ((local_2c < DAT_00638588 &&
  // DEVIATION: Win32 — (DAT_006385c8 = *(int *)(DAT_006385c8 + 0x1c),
  // DEVIATION: Win32 — (*(uint *)(DAT_006385c8 + 0xc) >> 5 & 1) == 0))) {
  // DEVIATION: Win32 — local_2c = local_2c + 1;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if ((*(byte *)(local_20 + 3) & 1) == 0) {
  // DEVIATION: Win32 — local_30 = DAT_006385d0;
  // DEVIATION: Win32 — if ((((DAT_006385d0 != (undefined4 *)0x0) && (*(short *)(DAT_006385d0 + 0x22) == 4)) &&
  // DEVIATION: Win32 — (((uint)local_20[3] >> 1 & 1) != 0)) && (((uint)local_20[3] >> 4 & 1) != 0)) {
  // DEVIATION: Win32 — *(ushort *)DAT_006385d0[0x23] = *(ushort *)DAT_006385d0[0x23] & 0xfffb;
  ...
  // DEVIATION: Win32 — FUN_005edc6c(local_20[4],iVar3,local_20[6] / (int)(uint)(ushort)DAT_006385ac,
  // DEVIATION: Win32 — *(undefined2 *)(local_30 + 0x20),
  // DEVIATION: Win32 — CONCAT22((short)((uint)iVar3 >> 0x10),(ushort)DAT_006385ac));
...
export function FUN_005d717f(param_1) {
  ...
  // DEVIATION: Win32 — local_20 = DAT_006385d0;
  ...
  // DEVIATION: Win32 — *(int *)(iVar1 + 0x18) / (int)(uint)(ushort)DAT_006385ac,
  // DEVIATION: Win32 — CONCAT22((short)((uint)local_20 >> 0x10),*(undefined2 *)(local_20 + 0x20)),
  // DEVIATION: Win32 — CONCAT22((short)((uint)iVar4 >> 0x10),(ushort)DAT_006385ac));
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if ((DAT_006385d0 == (undefined4 *)0x0) || (bVar2)) {
...
export function FUN_005d7494(param_1, param_2) {
  ...
  // DEVIATION: Win32 — uVar1 = DAT_006385d0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — DAT_006385d0 = uVar1;
...
export function FUN_005d753e(param_1, param_2, param_3) {
  ...
  // DEVIATION: Win32 — param_3 = param_3 / (ushort)DAT_006385ac;
  ...
  // DEVIATION: Win32 — CONCAT22((short)(param_3 >> 0x10),(ushort)DAT_006385ac));
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — _memset((void *)(param_2 + (ushort)DAT_006385ac * local_14),0,(ushort)DAT_006385ac * param_3);
...
export function FUN_005d778c(param_1, param_2, param_3) {
  ...
  // DEVIATION: Win32 — *(undefined2 *)(param_1 + 0x80),(ushort)DAT_006385ac);
...
export function FUN_005d791b(param_1, param_2) {
  ...
  // DEVIATION: Win32 — local_14 = *(int *)(DAT_006385d0 + 0x9c) - *(int *)(DAT_006385d0 + 0x68);
  // DEVIATION: Win32 — local_8 = 0;
  // DEVIATION: Win32 — uVar3 = *(int *)(DAT_006385d0 + 8) -
  // DEVIATION: Win32 — (*(int *)(DAT_006385d0 + 0x90) - *(int *)(DAT_006385d0 + 0x94));
  ...
  // DEVIATION: Win32 — AVIStreamRead(*(undefined4 *)(DAT_006385d0 + 0x84),
  // DEVIATION: Win32 — *(uint *)(DAT_006385d0 + 0x90) / (uint)*(ushort *)(DAT_006385d0 + 0x80),
  // DEVIATION: Win32 — local_14 / *(ushort *)(DAT_006385d0 + 0x80),*(undefined4 *)(DAT_006385d0 + 0x34),
  ...
  // DEVIATION: Win32 — *(undefined4 *)(DAT_006385d0 + 0x98) = *(undefined4 *)(param_1 + 0x1c);
  // DEVIATION: Win32 — param_1 = *(int *)(DAT_006385d0 + 0x98);
  // DEVIATION: Win32 — *(undefined4 *)(DAT_006385d0 + 0x68) = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if (*(uint *)(DAT_006385d0 + 8) <=
  // DEVIATION: Win32 — (uint)(*(int *)(DAT_006385d0 + 0x90) - *(int *)(DAT_006385d0 + 0x94))) {
  // DEVIATION: Win32 — local_10 = 0;
  // DEVIATION: Win32 — while ((local_10 < (uint)(*(int *)(DAT_006385d0 + 0x9c) - *(int *)(DAT_006385d0 + 0x68)) &&
...
export function FUN_005d7cb0(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8) {
  ...
  // DEVIATION: Win32 — FUN_005c041f(DAT_00638b40);
...
export function FUN_005d8270(param_1, param_2) {
  ...
  // DEVIATION: Win32 — FUN_005f22e0(local_108,&DAT_0063863c);
...
export function FUN_005d879c(param_1, param_2) {
  ...
  // DEVIATION: Win32 — uVar3 = FUN_005d8721(param_1,&DAT_00638698,2);
...
export function create_window_8E3F(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8) {
  ...
  // DEVIATION: Win32 — int local_8;
  // DEVIATION: Win32 — pHVar2 = LoadBitmapA(DAT_006e4ff0,(LPCSTR)0x12d);
  // DEVIATION: Win32 — pHVar3 = LoadBitmapA(DAT_006e4ff0,(LPCSTR)0x12f);
  // DEVIATION: Win32 — pHVar4 = LoadBitmapA(DAT_006e4ff0,(LPCSTR)0x12e);
  ...
  // DEVIATION: Win32 — hInstance = DAT_006e4ff0;
  // DEVIATION: Win32 — thunk_FUN_0040f810();
  // DEVIATION: Win32 — iVar9 = thunk_FUN_00414d10();
  // DEVIATION: Win32 — iVar10 = iVar8 >> 1;
  // DEVIATION: Win32 — iVar13 = nHeight >> 1;
  // DEVIATION: Win32 — pHVar11 = CreateWindowExA(4,s_MSControlClass_00638708,&DAT_00638704,local_40,local_44,
...
export function create_window_931B(param_1, param_2, param_3, param_4, param_5, param_6, param_7) {
  ...
  // DEVIATION: Win32 — pHVar12 = CreateWindowExA(4,s_MSControlClass_0063871c,&DAT_00638718,local_448,local_44c,
...
export function invalidate_9A9A(param_1) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — DAT_00637ea4 = thunk_FUN_0040f810();
  // DEVIATION: MFC — uVar2 = CCheckListBox::GetCheckStyle(this);
...
export function draw_text_9B86(param_1, param_2, param_3, param_4) {
  ...
  // DEVIATION: Win32 — if (DAT_006386fc != 0) {
  ...
  // DEVIATION: Win32 — if ((DAT_00637e84 != 0) || (DAT_00637e88 != 0)) {
  // DEVIATION: Win32 — OffsetRect(&local_138,(uint)DAT_00637e84,(uint)DAT_00637e88);
  // DEVIATION: Win32 — puVar12 = local_a0;
  // DEVIATION: Win32 — puVar9 = local_c4;
  // DEVIATION: Win32 — puVar8 = local_a4;
  // DEVIATION: Win32 — uVar3 = (uint)DAT_00637e80;
  ...
  // DEVIATION: Win32 — if (DAT_00637e7c == '\0') {
  // DEVIATION: Win32 — SetTextColor(local_d0,0);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — thunk_FUN_0040f810(DAT_00637e7c,local_a4,local_c4,local_a0);
  // DEVIATION: Win32 — thunk_FUN_00511320();
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if (DAT_006386f7 == '\0') {
  // DEVIATION: Win32 — SetTextColor(local_d0,0);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — SetTextColor(local_d0,(uint)CONCAT12(DAT_006386f6,CONCAT11(DAT_006386f5,DAT_006386f4)));
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  ...
  // DEVIATION: Win32 — iVar4 = thunk_FUN_00414d10();
  // DEVIATION: Win32 — if (*(int *)(iVar4 + 0x40) == 8) {
  // DEVIATION: Win32 — if (DAT_00637e8c == '\0') {
  // DEVIATION: Win32 — SetTextColor(local_d0,0x404040);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — thunk_FUN_0040f810(DAT_00637e8c,local_a4,local_c4,local_a0);
  // DEVIATION: Win32 — thunk_FUN_00511320();
  // DEVIATION: Win32 — uVar7 = thunk_FUN_0046f440();
  // DEVIATION: Win32 — FUN_005dea9e(uVar7);
  // DEVIATION: Win32 — SetTextColor(local_d0,(uint)CONCAT12(local_a0[0],CONCAT11(local_c4[0],local_a4[0])));
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if (DAT_006386fb == '\0') {
  // DEVIATION: Win32 — SetTextColor(local_d0,0x404040);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — SetTextColor(local_d0,(uint)CONCAT12(DAT_006386fa,CONCAT11(DAT_006386f9,DAT_006386f8)));
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — UVar13 = 0x24;
  // DEVIATION: Win32 — ptVar10 = &local_138;
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — DAT_006386fc = 1;
  ...
  // DEVIATION: Win32 — DAT_006386fc = 0;
  // DEVIATION: Win32 — break;
  ...
  // DEVIATION: Win32 — if (DAT_00638700 == 0) {
  // DEVIATION: Win32 — DAT_00638700 = 1;
  // DEVIATION: Win32 — SetCapture(param_1);
  // DEVIATION: Win32 — uVar7 = thunk_FUN_0040f810();
  // DEVIATION: Win32 — FUN_005c6303(uVar7);
  // DEVIATION: Win32 — uVar7 = *(undefined4 *)(local_bc + 0x14);
  ...
  // DEVIATION: Win32 — ReleaseCapture();
  // DEVIATION: Win32 — DAT_00638700 = 0;
  // DEVIATION: Win32 — break;
...
export function FUN_005db140(param_1) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — *(HMODULE *)(&DAT_006e4f60 + DAT_006387cc * 4) = pHVar1;
  // DEVIATION: Win32 — DAT_006387cc = DAT_006387cc + 1;
  // DEVIATION: Win32 — }
...
export function FUN_005db1fa(param_1, param_2) {
  ...
  // DEVIATION: Win32 — local_10 = FindResourceA(DAT_006e4ff0,param_2,&local_c);
  // DEVIATION: Win32 — if (local_10 == (HRSRC)0x0) {
  // DEVIATION: Win32 — local_14 = 0;
  // DEVIATION: Win32 — while ((local_14 < DAT_006387cc &&
  // DEVIATION: Win32 — (local_10 = FindResourceA(*(HMODULE *)(&DAT_006e4f60 + local_14 * 4),param_2,&local_c),
  ...
  // DEVIATION: Win32 — local_1c = DAT_006e4ff0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — local_1c = *(HMODULE *)(&DAT_006e4f60 + local_14 * 4);
  // DEVIATION: Win32 — }
...
export function FUN_005db2f8(param_1) {
  ...
  // DEVIATION: Win32 — local_8 = FindResourceA(DAT_006e4ff0,param_1,(LPCSTR)0x2);
  // DEVIATION: Win32 — if (local_8 == (HRSRC)0x0) {
  // DEVIATION: Win32 — local_c = 0;
  // DEVIATION: Win32 — while ((local_c < DAT_006387cc &&
  // DEVIATION: Win32 — (local_8 = FindResourceA(*(HMODULE *)(&DAT_006e4f60 + local_c * 4),param_1,(LPCSTR)0x2),
  ...
  // DEVIATION: Win32 — local_14 = DAT_006e4ff0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — local_14 = *(HMODULE *)(&DAT_006e4f60 + local_c * 4);
  // DEVIATION: Win32 — }
...
export function FUN_005db3ca(param_1, param_2) {
  ...
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — if (local_14 == 0xffffffff) {
  // DEVIATION: Win32 — local_18 = DAT_006e4ff0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — local_18 = *(HMODULE *)(&DAT_006e4f60 + local_14 * 4);
  // DEVIATION: Win32 — }
...
export function FUN_005db55b(param_1) {
  ...
  // DEVIATION: Win32 — (*(HMODULE *)(&DAT_006e4f60 + local_8 * 4) != param_1 && (local_8 < DAT_006387cc));
  // DEVIATION: Win32 — local_8 = local_8 + 1) {
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if (local_8 < DAT_006387cc) {
  // DEVIATION: Win32 — for (; local_8 < DAT_006387cc; local_8 = local_8 + 1) {
  // DEVIATION: Win32 — *(undefined4 *)(&DAT_006e4f60 + local_8 * 4) = *(undefined4 *)(&DAT_006e4f64 + local_8 * 4);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — DAT_006387cc = DAT_006387cc - 1;
...
export function register_wndclass_BC5A() {
  ...
  // DEVIATION: Win32 — local_2c.hInstance = DAT_006e4ff0;
...
export function FUN_005dbdba() {
  // DEVIATION: Win32 — BVar1 = UnregisterClassA(s_MSAppWindow_00638850,DAT_006e4ff0);
  // DEVIATION: Win32 — if (BVar1 == 0) {
  // DEVIATION: Win32 — debug_log(s_Error__Cannot_unregister_AppWind_0063885c);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — BVar1 = UnregisterClassA(s_MSWindowClass_00638888,DAT_006e4ff0);
  // DEVIATION: Win32 — if (BVar1 == 0) {
  // DEVIATION: Win32 — debug_log(s_Error__Cannot_unregister_window_c_00638898);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — BVar1 = UnregisterClassA(s_MSMovieClass_006388c0,DAT_006e4ff0);
  // DEVIATION: Win32 — if (BVar1 == 0) {
  // DEVIATION: Win32 — debug_log(s_Error__Cannot_unregister_window_c_006388d0);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — BVar1 = UnregisterClassA(s_MSControlClass_006388f8,DAT_006e4ff0);
  // DEVIATION: Win32 — if (BVar1 == 0) {
  // DEVIATION: Win32 — debug_log(s_Error__Cannot_unregister_control_00638908);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — BVar1 = UnregisterClassA(s_MSMrTimerClass_00638930,DAT_006e4ff0);
  // DEVIATION: Win32 — if (BVar1 == 0) {
...
export function fill_rect_BE88(param_1, param_2, param_3, param_4) {
  ...
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — iVar6 = thunk_FUN_00414d10();
  // DEVIATION: Win32 — if ((*(int *)(iVar6 + 0x18) != 0) && (DAT_00638b48 == 1)) {
  // DEVIATION: Win32 — iVar6 = thunk_FUN_00414d10();
...
export function register_wndclass_D8A0() {
  ...
  // DEVIATION: Win32 — RegisterClassA(&local_2c);
  // DEVIATION: Win32 — DAT_006e4ff8 = CreateWindowExA(0,s_MSMMWindow_006389f0,(LPCSTR)0x0,0,-0x80000000,-0x80000000,
  // DEVIATION: Win32 — -0x80000000,-0x80000000,(HWND)0x0,(HMENU)0x0,DAT_006e4ff0,
  // DEVIATION: Win32 — (LPVOID)0x0);
...
export function FUN_005dd93f(param_1, param_2, param_3, param_4) {
  ...
  // DEVIATION: Win32 — if (param_3 == 1) {
  // DEVIATION: Win32 — if ((param_4 & 0xffff) == DAT_006389d4) {
  // DEVIATION: Win32 — FUN_005de6bd();
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if ((param_4 & 0xffff) == DAT_006389d8) {
...
export function show_messagebox_DA53(param_1) {
  // DEVIATION: Win32 — if (DAT_006389d4 != 0) {
  ...
  // DEVIATION: Win32 — DAT_006389d4 = local_28;
  ...
  // DEVIATION: Win32 — (iVar2 = MessageBoxA((HWND)0x0,s_The_MIDI_Mapper_is_not_available_00638a48,&DAT_00638a44,4)
  // DEVIATION: Win32 — , iVar2 == 7)) {
  // DEVIATION: Win32 — mciSendCommandA(local_18,0x804,0,0);
  // DEVIATION: Win32 — return 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_38[0] = DAT_006e4ff8;
...
export function FUN_005ddbc7(param_1) {
  ...
  // DEVIATION: Win32 — if (DAT_006389d8 == 0) {
  // DEVIATION: Win32 — FUN_005ddd4e();
  // DEVIATION: Win32 — if (DAT_006389d8 == 0) {
  // DEVIATION: Win32 — return 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_8 = DAT_006389d8;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — local_8 = DAT_006389d8;
  // DEVIATION: Win32 — mciSendCommandA(DAT_006389d8,0x808,0,0);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_10 = 0;
  // DEVIATION: Win32 — local_c = (uint)param_1;
  // DEVIATION: Win32 — MVar1 = mciSendCommandA(local_8,0x807,8,(DWORD_PTR)&local_10);
  // DEVIATION: Win32 — if (MVar1 == 0) {
  // DEVIATION: Win32 — if (param_1 == DAT_006389e0) {
  ...
  // DEVIATION: Win32 — local_20 = DAT_006e4ff8;
...
export function FUN_005ddd4e() {
  ...
  // DEVIATION: Win32 — if (MVar1 == 0) {
  // DEVIATION: Win32 — DAT_006389d8 = local_30;
  ...
  // DEVIATION: Win32 — mciSendCommandA(DAT_006389d8,0x814,0x100,(DWORD_PTR)&local_14);
  // DEVIATION: Win32 — DAT_006389e0 = local_10;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — mciSendCommandA(DAT_006389d8,0x804,0,0);
  // DEVIATION: Win32 — DAT_006389d8 = 0;
...
export function FUN_005ddeff() {
  ...
  // DEVIATION: Win32 — DAT_006389d8 = local_38;
  // DEVIATION: Win32 — local_1c = 10;
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — local_24 = DAT_006389d8;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_c = 3;
...
export function FUN_005de00d() {
  ...
  // DEVIATION: Win32 — local_20 = 0x100;
  // DEVIATION: Win32 — mciSendCommandA(DAT_006389d8,0x80d,0x100,(DWORD_PTR)local_2c);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — DAT_006389dc = local_8;
}

// Source: decompiled/block_005D0000.c FUN_005de0b5 (232 bytes)
// cdaudio_close_door — close CD tray
export function FUN_005de0b5() {
  // DEVIATION: Win32 — if ((DAT_006389d8 == 0) && (DAT_006389dc == 0)) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if (DAT_006389dc != 0) {
  // DEVIATION: Win32 — local_8 = DAT_006389dc;
  // DEVIATION: Win32 — DAT_006389dc = 0;
  // DEVIATION: Win32 — FUN_005dde9d();
...
export function FUN_005de19d() {
  ...
  // DEVIATION: Win32 — local_1c = mciSendCommandA(DAT_006389d8,0x814,0x100,(DWORD_PTR)local_14);
  // DEVIATION: Win32 — if (local_1c == 0) {
  // DEVIATION: Win32 — if (local_10 == 0x20d) {
  // DEVIATION: Win32 — mciSendCommandA(DAT_006389d8,0x806,0,(DWORD_PTR)local_28);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — mciSendCommandA(DAT_006389d8,0x809,0,(DWORD_PTR)local_18);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
}
...
export function FUN_005de250() {
  ...
  // DEVIATION: Win32 — mciSendCommandA(DAT_006389d8,0x855,0,(DWORD_PTR)local_18);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
}
...
export function FUN_005de310() {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — local_18 = DAT_006389d8;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_c = 8;
  // DEVIATION: Win32 — DAT_006389d8 = local_18;
...
export function FUN_005de529(param_1, param_2, param_3) {
  ...
  // DEVIATION: Win32 — local_1c = mciSendCommandA(DAT_006389d8,0x80d,0x400,(DWORD_PTR)local_2c);
  // DEVIATION: Win32 — if (local_1c == 0) {
  // DEVIATION: Win32 — local_20 = 0x100;
...
export function gdi_E780(param_1) {
  ...
  // DEVIATION: Win32 — DAT_006e500c = 0;
  // DEVIATION: Win32 — DAT_00638b48 = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — iVar2 = GetDeviceCaps(hdc,0x18);
  // DEVIATION: Win32 — DAT_006e500c = iVar2 / 2;
  // DEVIATION: Win32 — GetSystemPaletteEntries(hdc,0,0x100,(LPPALETTEENTRY)(param_1 + 2));
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — for (local_c = 0; local_c < DAT_006e500c; local_c = local_c + 1) {
  // DEVIATION: Win32 — *(undefined1 *)((int)param_1 + local_c * 4 + 7) = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — for (; local_c < 0x100 - DAT_006e500c; local_c = local_c + 1) {
  ...
  // DEVIATION: Win32 — *(undefined1 *)((int)param_1 + local_c * 4 + 7) = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if (DAT_00638b48 == 0) {
  // DEVIATION: Win32 — local_10 = &DAT_00638b50;
...
export function FUN_005deb12(param_1, param_2, param_3, param_4, param_5) {
  ...
  // DEVIATION: Win32 — for (local_8 = 0; local_8 < DAT_006e500c; local_8 = local_8 + 1) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — for (local_8 = 0x100 - DAT_006e500c; local_8 < 0x100; local_8 = local_8 + 1) {
  // DEVIATION: Win32 — if (((*(char *)(param_1 + 4 + local_8 * 4) == param_3) &&
  // DEVIATION: Win32 — (*(char *)(param_1 + 5 + local_8 * 4) == param_4)) &&
  // DEVIATION: Win32 — (*(char *)(param_1 + 6 + local_8 * 4) == param_5)) {
  // DEVIATION: Win32 — *(undefined1 *)(param_1 + 7 + param_2 * 4) = 1;
...
export function FUN_005dec4e(param_1) {
  // DEVIATION: Win32 — if (DAT_00638b48 == 1) {
...
export function FUN_005ded90() {
  ...
  // DEVIATION: Win32 — if (DAT_006e501c != 0) {
  // DEVIATION: Win32 — thunk_FUN_004bb3b0(1);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — if (DAT_006e5014 != 0) {
  // DEVIATION: Win32 — thunk_FUN_005a95b0(1);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — iVar1 = thunk_FUN_00421bb0();
  // DEVIATION: Win32 — DAT_00638bac = iVar1 + 0xe10;
  // DEVIATION: Win32 — DAT_00638ba4 = 0;
}
...
export function FUN_005dee28(param_1, param_2, param_3) {
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_8 = 0xffffffff;
  // DEVIATION: Win32 — DAT_006e5014 = local_6c;
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — local_8 = 0xffffffff;
  // DEVIATION: Win32 — DAT_006e501c = local_74;
  // DEVIATION: Win32 — uVar1 = FUN_005bb8c0(param_2);
  // DEVIATION: Win32 — FUN_005bb4ae(&DAT_00638bb0,0xc01,0,0,local_14,local_44,uVar1,param_2);
  ...
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else {
  // DEVIATION: Win32 — local_88 = DAT_006e5014 + 0x48;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — thunk_FUN_0040f680(local_88,0x65,&local_54,&DAT_00638bb4);
  // DEVIATION: Win32 — thunk_FUN_0040f880(FUN_005ded90);
  // DEVIATION: Win32 — SetRect(&local_40,0,0,local_14,local_44);
  // DEVIATION: Win32 — FUN_005dfa4d(DAT_006e5014,&local_40,3,0xff,0xf8);
  // DEVIATION: Win32 — InflateRect(&local_40,-6,-6);
  // DEVIATION: Win32 — FUN_005dfa4d(DAT_006e5014,&local_40,0xffffffff,0xff,0xf8);
  // DEVIATION: Win32 — FUN_005dfa4d(DAT_006e5014,&local_40,1,0xff,0xf8);
  // DEVIATION: Win32 — FUN_005c19ad(0);
  // DEVIATION: Win32 — FUN_005c1167(&DAT_006d1ec8,local_30,&local_24,0);
...
export function FUN_005df166() {
  // DEVIATION: Win32 — iVar1 = FUN_005dcfca(DAT_00638b94);
  // DEVIATION: Win32 — if (iVar1 == 0) {
  // DEVIATION: Win32 — DAT_00638ba8 = 0;
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — else if ((DAT_00638ba4 == 0) &&
  // DEVIATION: Win32 — ((DAT_00638ba8 == 0 ||
  // DEVIATION: Win32 — ((DAT_00638ba8 < 3 && (iVar1 = thunk_FUN_00421bb0(), DAT_00638bac < iVar1)))))) {
  // DEVIATION: Win32 — DAT_00638ba4 = 1;
  // DEVIATION: Win32 — DAT_00638ba8 = DAT_00638ba8 + 1;
  // DEVIATION: Win32 — FUN_005dee28(DAT_00638b98,DAT_00638b90,DAT_00638b9c);
  // DEVIATION: Win32 — }
}
...
export function FUN_005df1fd(param_1, param_2, param_3, param_4, param_5) {
  // DEVIATION: Win32 — if (DAT_00638ba0 != 0) {
  // DEVIATION: Win32 — FUN_005d2004(DAT_00638ba0);
  // DEVIATION: Win32 — }
  // DEVIATION: Win32 — DAT_00638b94 = param_1;
  // DEVIATION: Win32 — DAT_00638b98 = param_3;
  // DEVIATION: Win32 — DAT_00638b90 = param_4;
  // DEVIATION: Win32 — DAT_00638b9c = param_5;
  // DEVIATION: Win32 — DAT_00638ba8 = 0;
  // DEVIATION: Win32 — DAT_00638ba4 = 0;
  // DEVIATION: Win32 — DAT_00638ba0 = FUN_005d1f50(FUN_005df166,param_2 * 1000,0xffffffff);
}
...
export function FUN_005df2b5(param_1, param_2) {
  ...
  // DEVIATION: Win32 — iVar2 = _strncmp(local_24,&DAT_00638be0,3);
  // DEVIATION: Win32 — if (iVar2 != 0) {
