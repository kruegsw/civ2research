  ...
  if ((DAT_00655af0 & 0x20) === 0) {
    if (((DAT_00655af0 & 0x80) === 0) || ((DAT_0064bc60 & 2) === 0)) {
      ...
      for (let local_54 = 0; local_54 < DAT_00655b18; local_54 = local_54 + 1) {
        if ((DAT_0064f394[local_54 * 0x58] !== 0) &&
      ...
      for (let local_3c = 0; local_3c < 4; local_3c = local_3c + 1) {
        ...
        FUN_0040fe40();
        FUN_0040ff30(s16(DAT_0064bcbc[local_3c]));
        FUN_0043c910(DAT_00679640, DAT_0063ec34, local_6c, DAT_0063ec3c);
        local_6c = local_6c + local_10;
      }
      local_6c = local_6c + 6;
...
export function FUN_00435dc4() {
  ...
  let local_60 = '';
  if (DAT_006554fc[s16(DAT_0064c6a6[iVar1 * 0x594]) * 0x30] === 0) {
...
export function FUN_00437cea() {
  ...
  if (local_24 !== 0) {
    ...
    while ((local_30 <= DAT_006af220[iVar1] && (local_30 - 1 < iVar2 + local_8)) &&
      ...
      uVar4 = FUN_00472d20(s16(DAT_006af2a0[iVar1 * 0x27d8 + local_38 * 0x22]),
                           iVar1);
      ...
      FUN_0040bbb0();
      uVar4 = FUN_00428b0c(
                  DAT_0064b1b8[s16(DAT_006af2a0[iVar1 * 0x27d8 + local_38 * 0x22]) * 0x14]);
      FUN_0040bbe0(uVar4);
      ...
      iVar8 = FUN_0043d07a(s16(DAT_006af2a2[iVar1 * 0x27d8 + local_38 * 0x22]),
                           s16(DAT_006af2a4[iVar1 * 0x27d8 + local_38 * 0x22]),
                           -1, -1, -1);
      if (-1 < iVar8) {
      ...
      FUN_005baee0(s16(DAT_006af2a8[iVar1 * 0x27d8 + local_38 * 0x22]), 0x12,
                   -1, -1);
      FUN_0040bbb0();
...
export function FUN_0043d400(param_1) {
  ...
  if (DAT_0064c6a6[iVar4 * 0x594] === 0xb) {
  ...
  if (DAT_0064c6a6[iVar4 * 0x594] === 10) {
    DAT_0063f668[9] = DAT_0063f668[9] << 1;
  }
  ...
  let local_13c;
  if (DAT_0064f340[param_1 * 0x58] - DAT_0064f342[param_1 * 0x58] <= 0) {
    local_13c = ~(DAT_0064f340[param_1 * 0x58] - DAT_0064f342[param_1 * 0x58]) + 1;
  } else {
    local_13c = DAT_0064f340[param_1 * 0x58] - DAT_0064f342[param_1 * 0x58];
  }
  ...
  _DAT_0063f570 = 0;
  let local_84 = 10;
  iVar5 = ((DAT_0064f342[param_1 * 0x58] + DAT_0064f340[param_1 * 0x58]) % 3);
  if (iVar5 === 1) {
    local_84 = 0xc;
  ...
  if (DAT_0064c6a6[iVar4 * 0x594] === 0x11) {
    DAT_0063f540[local_84] = DAT_0063f540[local_84] << 1;
  }
  iVar5 = local_8c - 0xc;
  if (iVar5 < 1) {
  ...
  if (400 < DAT_00666130[local_a4 * 0x10]) {
    ...
    if (((-DAT_0064f340[param_1 * 0x58] - DAT_0064f342[param_1 * 0x58]) & 3) === 0) {
      DAT_0063f540[11] = 0;
    }
  }
  ...
  if (local_8c < 0x20) {
    let local_60 = (DAT_0064f342[param_1 * 0x58] * 5 +
                   DAT_0064f340[param_1 * 0x58] * 3) % 0xe;
    let local_c = (DAT_0064f342[param_1 * 0x58] * 7 +
                  DAT_0064f340[param_1 * 0x58] * 0xd) % 0xe;
  } else {
    let local_60 = (DAT_0064f342[param_1 * 0x58] * 5 +
                   DAT_0064f340[param_1 * 0x58] * 3) % 9 + 5;
    let local_c = (DAT_0064f342[param_1 * 0x58] * 7 +
                  DAT_0064f340[param_1 * 0x58] * 0xd) % 9 + 5;
  }
  ...
  if (local_8c < 0x20) {
    local_60_2 = (DAT_0064f342[param_1 * 0x58] * 5 +
                 DAT_0064f340[param_1 * 0x58] * 3) % 0xe;
    local_c_2 = (DAT_0064f342[param_1 * 0x58] * 7 +
                DAT_0064f340[param_1 * 0x58] * 0xd) % 0xe;
  } else {
    local_60_2 = (DAT_0064f342[param_1 * 0x58] * 5 +
                 DAT_0064f340[param_1 * 0x58] * 3) % 9 + 5;
  ...
  for (let local_130 = 0; local_130 < DAT_00655b16; local_130 = local_130 + 1) {
    if ((((DAT_0065610a[local_130 * 0x20] !== 0) &&
