...
export function FUN_004abfe5(param_1, param_2, param_3) {
  ...
  DAT_00673fc0 = 0;
  let local_40 = param_1 - DAT_00673fb0;
  if ((DAT_00655ae8 & 0x8000) === 0) {
    if (local_40 < 0) local_40 += DAT_006d1160;
    if (DAT_006d1160 >> 1 <= local_40) local_40 -= DAT_006d1160;
  }
