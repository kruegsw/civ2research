...
export function FUN_004a2055(param_1, param_2) {
  ...
  if (param_1 === 0) {
    ...
    DAT_0062cd20 = FUN_0041508c_stub(local_210, DAT_0062cd28);
    if (DAT_0062cd20 !== null && _strlen(local_210) !== 0) {
      local_8 = FUN_004db481_stub(local_210, local_264);
    }
    if (DAT_0062cd20 === null) {
      DAT_0062cd20 = FUN_0041508c_stub(local_210, DAT_0062cd2c);
      if (DAT_0062cd20 !== null && _strlen(local_210) !== 0) {
        local_8 = FUN_004db481_stub(local_210, local_264);
      }
    }
  ...
  if (param_2 === 0) {
    ...
    while (!bVar1) {
      ...
      if (pcVar4 !== null) {
        FUN_0056b810_stub(DAT_00679640);
        FUN_004d007e_stub(DAT_00679640);
...
export function FUN_004a24b1() {
  ...
  FUN_004d007e_stub(DAT_00673e10);
  return DAT_00673e10;
}
...
export function FUN_004a257a() {
  FUN_004a23fc(1);
  let uVar1 = FUN_00428a95_stub(DAT_00679640);
  return uVar1;
}
...
export function FUN_004a25aa() {
  FUN_004a24b1();
  let uVar1 = FUN_00428a95_stub(DAT_00673e10);
  return uVar1;
}
...
export function FUN_004a26bf(param_1) {
  FUN_004a24b1();
  let uVar1 = FUN_00428b68_stub(DAT_00673e10, param_1);
  return uVar1;
}
...
export function FUN_004a28b0(param_1) {
  ...
  DAT_00673f8c = 0;
  if (199 < DAT_00655af8) {
    DAT_00673f8c = FUN_005adfa0_stub(DAT_00655b14 * 3, 0, 100);
  }
...
export function FUN_004a3060() {
  ...
  for (local_8 = 0; local_8 < 7; local_8++) {
    pcVar1 = FUN_00428b0c_stub(DAT_0064b9a0[local_8 * 4]);
    // _strncpy — no-op (government names)
    pcVar1 = FUN_00428b0c_stub(DAT_00654fe0[local_8 * 8]);
    // _strncpy — no-op
    pcVar1 = FUN_00428b0c_stub(DAT_00654fe4[local_8 * 8]);
    // _strncpy — no-op
  }
  for (local_8 = 0; local_8 < 0x10; local_8++) {
    pcVar1 = FUN_00428b0c_stub(DAT_0064b168[local_8 * 4]);
...
export function FUN_004a3640() {
  ...
  for (local_c = 1; local_c < 5; local_c++) {
    if (DAT_0062cd68[local_c * 8] === 9) {
      FUN_00418a30_stub(DAT_006a1d88[(DAT_006a4f88 + 0x2ec) * 5 + 0x13b]);
    } else if (DAT_0062cd68[local_c * 8] === 0xc) {
      iVar1 = FUN_00418740_stub();
      FUN_00418d90_stub(DAT_006a2a00[iVar1 * 4 + (DAT_006a4f88 + 0x2ec) * 0x58]);
    }
  }
}
...
export function FUN_004a38a4(param_1) {
  ...
  for (let local_8 = 0; local_8 < 7; local_8++) {
    FUN_0040bbb0_stub();
    FUN_0040ff00_stub(DAT_0064b9a0[local_8 * 4]);
    FUN_005f22e0(DAT_00679640, DAT_0062cd90);
    // string length operations and padding — no-op
    FUN_0040ff00_stub(DAT_00654fe0[local_8 * 8]);
    FUN_005f22e0(DAT_00679640, DAT_0062cd94);
    // more padding — no-op
    FUN_0040ff00_stub(DAT_00654fe4[local_8 * 8]);
...
export function FUN_004a41d8(param_1) {
  for (let local_8 = 0; local_8 < 0x10; local_8++) {
    FUN_0040bbb0_stub();
    FUN_0040ff00_stub(DAT_0064b168[local_8 * 4]);
...
export function FUN_004a6c85(param_1, param_2, param_3, param_4, param_5, param_6) {
  FUN_0056d289_stub(param_2, param_3, 0, param_5 + 2, param_6, (DAT_00633584 === 0) ? 0 : 8);
}
...
export function FUN_004a6df7(param_1, param_2, param_3, param_4, param_5, param_6) {
  FUN_0056baff_stub(param_2, param_3, 4, param_5 + 2, param_6, (DAT_00633584 === 0) ? 0 : 8, 0);
}
  ...
  for (local_18c = 1; local_18c < 8; local_18c++) {
    ...
    if (-1 < iVar2) {
      if (3 < local_38 - aiStack_28[local_18c] ||
        ...
        FUN_005b3d06_stub(0, local_18c, s16(DAT_006560f0, iVar2 * 0x20),
    ...
    if (DAT_00655b02 < 3 || DAT_006ad2f7 !== 0) {
      ...
      for (let local_24 = 1; local_24 < 8; local_24++) {
        if (param_1 === 0) {
          ...
          iVar4 = _rand();
          let val = FUN_005adfa0_stub(DAT_00655b08 * 5 + iVar4 % 0x50 + 10, 10, 0x4b);
...
export function FUN_004a93b3(param_1, param_2) {
  ...
  for (let local_18 = 0; local_18 < param_2; local_18++) {
    ...
    FUN_005b8b1a_stub(uVar6, iVar7, s8(DAT_0064f348[param_1 * 0x58]));
  }
  ...
  for (let local_10 = 0; local_10 < 0x2d; local_10++) {
    ...
    if (iVar8 !== 0) {
      ...
      if (iVar8 === 0) {
        let iVar8b = FUN_005b8a81_stub(s16(DAT_0064f340, param_1 * 0x58),
    ...
    if (DAT_00655b02 < 3 || DAT_006ad2f7 !== 0) {
      ...
      if (param_2 === -1) {
        ...
        if (DAT_00654fa8 === 0) {
          ...
          FUN_00410030_stub("DESTROYED", DAT_00643798[param_1 * 0x3c], 0);
        }
        if (DAT_00655128 < 0xc) {
          iVar1 = DAT_00655128;
      ...
      if (DAT_00655b02 !== 1 || (1 << (DAT_006d1da0 & 0x1f) & DAT_00655b0a) !== 0) {
        FUN_0047cf9e_stub(DAT_006d1da0, 1);
      }
      DAT_006ad8f4 = 0;
      iVar1 = 1;
    } else {
...
export function FUN_004aa9c0() {
  ...
  iVar1 = FUN_005ae006_stub(DAT_00655b0b);
  if (iVar1 === 1) {
        ...
        for (local_1c = 0; iVar14 = DAT_00673fc0, local_1c < 8; local_1c++) {
          ...
          if (((local_84 + local_7c) & 0xfffffffe) < 0x30 &&
            ...
            let continentOk = !bVar3 ||
                (iVar10 = FUN_005b8a81_stub(iVar9, iVar17), iVar10 !== 0x3f &&
                 s16(DAT_00666134, iVar10 * 0x10) !== 1);
            if (domainMatch && continentOk) {
              local_30 = iVar16;
              let skipTile = false;
              if (-1 < DAT_0062d044) {
                local_80 = FUN_005b8da4_stub(iVar9, iVar17);
                ...
                if (!skipTile && DAT_0062d044 === local_80 &&
                  ...
                  if ((bVar6b & 0x43) === 1) {
                    iVar10 = FUN_005b4b66_stub(iVar9, iVar17, local_80);
                    if (iVar10 !== 0) {
                      uVar18 = FUN_005b2e69_stub(iVar9, iVar17);
                      iVar10 = FUN_005b53b6_stub(uVar18, s8(DAT_0064b1ca[DAT_0062d03c * 0x14]));
                      local_30 = iVar16 + iVar10 * 0x10;
                    }
                  }
                }
                if (!skipTile) {
                  iVar10 = FUN_005b8dec_stub(iVar9, iVar17, DAT_0062d044);
                ...
                if (DAT_0062d040 !== 0 ||
                  ...
                  if (!skipTile) {
                    ...
                    if ((bVar2b & 0x80) !== 0) {
                      ...
                      if ((tile0b & 0x80) !== 0) {
                        iVar10 = FUN_005ae10e_stub(iVar15, iVar9);
                        if (iVar10 === 1) {
    ...
    for (local_1c = 0; local_1c < 8; local_1c++) {
      ...
      if (((local_84 + local_7c) & 0xfffffffe) < 0x30 &&
        ...
        if (domainMatch2) {
          ...
          let skipDir = false;
          if (DAT_0062d044 >= 0) {
            local_80 = FUN_005b8da4_stub(iVar15, iVar14);
          ...
          if (!skipDir && iVar16 !== 0 && iVar16 < iVar8) {
            if (DAT_0062d040 !== 0) {
              ...
              if (!skipDir) {
                ...
                if ((bVar2 & 0x80) !== 0) {
                  ...
                  if ((t0r & 0x80) !== 0 && (iVar17 = FUN_005ae10e_stub(param_1, iVar15), iVar17 === 1)) {
            ...
            if (!skipDir) {
              ...
              if (DAT_0062d044 === local_80 &&
                ...
                if ((bVar7 & 0x43) === 1) {
                  iVar17 = FUN_005b4b66_stub(iVar15, iVar14, local_80);
                  if (iVar17 !== 0) {
                    uVar18 = FUN_005b2e69_stub(iVar15, iVar14);
                    iVar17 = FUN_005b53b6_stub(uVar18, s8(DAT_0064b1ca[DAT_0062d03c * 0x14]));
                    local_58 = local_58 + iVar17 * 8;
                  }
                }
              }
              iVar15 = FUN_005b8dec_stub(iVar15, iVar14, DAT_0062d044);
              if (-1 < iVar15 && s8(DAT_0064b1ca[DAT_0062d03c * 0x14]) < 5) {
                local_58 = local_58 + DAT_0064bcc8 * 4;
              }
              iVar16 = iVar16 + local_58;
              if (iVar16 <= local_10) {
                iVar13 = FUN_005ae31d_stub(DAT_00673fa0, DAT_00673fa4, iVar13, iVar14);
                if (iVar16 < local_10) {
                  local_50 = local_1c;
                  local_20 = iVar13;
                  local_10 = iVar16;
...
export function FUN_004ad822(param_1, param_2, param_3) {
  ...
  if (local_24 < 0) {
    let local_8 = 99;
    for (let local_10 = 0; local_10 < 8; local_10++) {
      let iVar4 = FUN_005ae0b0_stub(s8(DAT_00628350[local_10]) + iVar1);
  ...
  DAT_00673fa0 = FUN_005ae0b0_stub(s8(DAT_00628350[local_10]) + iVar1);
