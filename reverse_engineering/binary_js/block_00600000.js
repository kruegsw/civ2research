...
let DAT_00639fd0 = 0;
let DAT_006e69f0 = 0;
let DAT_0063b3a4 = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365];
let DAT_0063b2b0 = 0;
let DAT_0063b2b4 = 0;
let DAT_0063b2b8 = 0;
let DAT_0063b25c = 0;
...
let DAT_0063b270 = 0;
let DAT_0063a29c = 0;
let DAT_0063a2a0 = 0x2e; // '.' decimal point
...
let DAT_0063b348 = null;
let DAT_0063b36c = 0;
let DAT_0063b370 = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366]; // leap year
let DAT_0063b354 = 0;
let DAT_0063b358 = 0;
let DAT_0063b350 = -1;
let DAT_0063b364 = 0;
...
let DAT_006e55d4 = 0;
let DAT_006e55dc = 0;
let DAT_0063b280 = []; // double format params
let DAT_0063b298 = []; // float format params
let DAT_0063b380 = 0; // tenpow12 positive table
let DAT_0063b4e0 = 0; // tenpow12 negative table
let DAT_0063b69c = 0;
let DAT_0063b6a0 = 0;
let DAT_00639f3c = null;
let DAT_00639f40 = null;
let DAT_00639f44 = null;
let DAT_0063b0a8 = 0;
let DAT_0063b0a4 = 0;
let DAT_0063afa1 = [];
let DAT_0063aed8 = 0;
let DAT_0061e2fc = '';
let DAT_006e55ac_func = null;
...
export function ___loctotime_t(param_1, param_2, param_3, param_4, param_5, param_6, param_7) {
  ...
  if ((uVar1 | 0) < 0x46 || 0x8a < (uVar1 | 0)) {
    ...
    let local_30 = DAT_0063b3a4[param_2] + param_3;
...
export function FID_conflict___ld12tod_1(param_1, param_2) {
  let IVar1 = __ld12cvt(param_1, param_2, DAT_0063b280);
  return IVar1;
}
...
export function FID_conflict___ld12tod_2(param_1, param_2) {
  let IVar1 = __ld12cvt(param_1, param_2, DAT_0063b298);
  return IVar1;
}
...
export function __isindst(_Time) {
  ...
  if (_Time.tm_year !== DAT_0063b350 || _Time.tm_year !== DAT_0063b360) {
    if (DAT_006e55e0 === 0) {
      ...
      if (DAT_006e5680 === 0) {
        cvtdate(1, 1, _Time.tm_year, DAT_006e5682, DAT_006e5686, DAT_006e5684, 0,
                DAT_006e5688, DAT_006e568a, DAT_006e568c, DAT_006e568e);
      } else {
        cvtdate(1, 0, _Time.tm_year, DAT_006e5682, 0, 0, DAT_006e5686,
                DAT_006e5688, DAT_006e568a, DAT_006e568c, DAT_006e568e);
      }
      if (DAT_006e562c === 0) {
        cvtdate(0, 1, _Time.tm_year, DAT_006e562e, DAT_006e5632, DAT_006e5630, 0,
                DAT_006e5634, DAT_006e5636, DAT_006e5638, DAT_006e563a);
      } else {
        cvtdate(0, 0, _Time.tm_year, DAT_006e562e, 0, 0, DAT_006e5632,
                DAT_006e5634, DAT_006e5636, DAT_006e5638, DAT_006e563a);
      }
    }
  }
...
export function cvtdate(param_1, param_2, param_3, param_4, param_5, param_6, param_7,
  ...
  if (param_2 === 1) {
    if ((param_3 & 3) === 0) {
      local_10 = DAT_0063b370[param_4]; // leap year day-of-year table
    } else {
      local_10 = DAT_0063b3a4[param_4]; // normal year day-of-year table
    }
    ...
    if (param_5 === 5) {
      if ((param_3 & 3) === 0) {
        local_14 = DAT_0063b370[param_4];
      } else {
        local_14 = DAT_0063b3a4[param_4 + 1]; // next month start
      }
      if (local_14 < local_c) {
        local_c = local_c + -7;
      }
    ...
    if ((param_3 & 3) === 0) {
      local_c = DAT_0063b370[param_4];
    } else {
      local_c = DAT_0063b3a4[param_4];
    }
