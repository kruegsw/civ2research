...
const FUN_005b8d15 = stub('FUN_005b8d15'); // tile_fortified_check (dup check)
const FUN_00442885 = stub('FUN_00442885'); // continent_route_check (dup)
const FUN_00598d45 = stub('FUN_00598d45'); // ai_threat_level (dup)
