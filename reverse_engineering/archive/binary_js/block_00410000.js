    ...
    if (iVar1 === 0) {
      ...
      if (((((DAT_00655aea & 0x80) !== 0) && (DAT_006d1da8 === 1)) &&
         ...
         ((local_14 = FUN_004106fd(param_1, param_2,
                                    DAT_006560f0[(local_1c * 0x20) / 2] | 0,
                                    DAT_006560f2[(local_1c * 0x20) / 2] | 0),
      ...
      iVar1 = FUN_005ae1b0(local_20, local_18, DAT_006560f0[(local_1c * 0x20) / 2] | 0,
                           DAT_006560f2[(local_1c * 0x20) / 2] | 0);
...
export function FUN_00411bf5(param_1, param_2) {
  ...
  if (((DAT_00655b02 < 3) || (s8(DAT_006560f7[iVar1 * 0x20]) === DAT_006d1da0)) ||
    ...
    case 0x43:
      FUN_00410402(DAT_006560f0[(iVar1 * 0x20) / 2], DAT_006560f2[(iVar1 * 0x20) / 2]);
      break;
...
export function map_key(param_1) {
  ...
  if ((((-1 < DAT_00655afe) && (DAT_00655afe < DAT_00655b16)) &&
      (DAT_0065610a[(DAT_00655afe * 0x20) / 4] !== 0)) && (-1 < local_8)) {
    if (DAT_006d1da8 === 1) {
...
export function FUN_00413476() {
  ...
  if (0 === 0) { // *(in_ECX + 0x2d8) === 0
    ...
    for (let local_c = 1; local_c < 8; local_c = local_c + 1) {
      if (DAT_0066ca84[(local_c * 0x3f0) / 2] !== 0) {
        bVar1 = true;
        break;
      }
    }
  ...
  for (let local_8 = 0; local_8 < 8; local_8 = local_8 + 1) {
    ...
    if (DAT_00628048 === 0) {
      if (local_8 === 0) {
        ...
        DAT_0066ca84[(local_8 * 0x3f0) / 2] = 0;
      }
    }
    if ((local_8 === 0) || (DAT_0066ca84[(local_8 * 0x3f0) / 2] !== 0)) {
      FUN_00413717();
...
export function FUN_0041b4c0() {
  ...
  for (let local_c = 0; local_c < 8; local_c = local_c + 1) {
    DAT_0066ca84[(local_c * 0x3f0) / 2] = 0;
    DAT_0066c988 = 0;
  }
  timeBeginPeriod(4);
