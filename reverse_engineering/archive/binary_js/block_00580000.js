...
export function FUN_00580341(param_1, param_2, param_3) {
  ...
  if (bVar3) {
    ...
    if (local_b8 !== 0) {
      FUN_004271e8(1, u32(DAT_0064c488, local_b8 * 8));
...
export function FUN_0058b47e(param_1, param_2) {
  ...
  // uVar1 = FUN_00428b0c(DAT_00628420 + 0x3f8); // DEVIATION: MFC — OK string
  ...
  // FUN_004086c0(local_5c, local_64, iVar2, local_60, local_68); // DEVIATION: MFC
  // uVar1 = FUN_00428b0c(DAT_00628420 + 0x3fc); // DEVIATION: MFC — Cancel string
...
export function FUN_0058d442() {
  ...
  uVar2 = FUN_00428b0c(DAT_00628420 + 0xf8, 1); // DEVIATION: resource string
...
export function FUN_0058fedb(param_1, param_2) {
  ...
  if (((1 << (bVar1 & 0x1f)) & DAT_00655b0b) !== 0 && DAT_006d1da0 === iVar3 &&
    ...
    if (s8(DAT_006560f0[param_1 * 0x20 + 0x0D]) < 0) {
      FUN_004271e8(0, DAT_00628420 + 0x100); // DEVIATION: Win32 resource
    } else {
    ...
    uVar7 = 0;
    uVar6 = 0;
    uVar4 = FUN_00428b0c(DAT_00628420 + 0x284, 0, 0); // DEVIATION: resource string
    FUN_0059edf0(uVar4, uVar6, uVar7); // DEVIATION: UI button
    cVar5 = (DAT_006560f0[param_1 * 0x20 + 0x10] !== param_2) ? 1 : 0;
    if (cVar5) {
      uVar7 = 0;
      uVar6 = 1;
      uVar4 = FUN_00428b0c(DAT_00628420 + 0x288, 1, 0); // DEVIATION: resource string
      FUN_0059edf0(uVar4, uVar6, uVar7); // DEVIATION: UI button
    }
    ...
    if (s8(DAT_0064f340[param_2 * 0x58 + 0x39]) < -0x26) {
      uVar7 = 0;
      uVar6 = 2;
      uVar4 = FUN_00428b0c(DAT_00628420 + 0x28c, 2, 0); // DEVIATION: resource string
      FUN_0059edf0(uVar4, uVar6, uVar7); // DEVIATION: UI button
      cVar5 = cVar5 + 1;
    }
    local_31c = 0;
